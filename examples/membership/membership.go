...
func main() {
	...
	createAccountPayload := membership.UpdateMembersPayload{
	...
	_, err = client.UpdateMembers(context.Background(), projectId).UpdateMembersPayload(createAccountPayload).Execute()
	if err != nil {
