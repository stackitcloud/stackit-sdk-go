...
func (a *DefaultAPIService) CreateVolumeAutomationExecute(r ApiCreateVolumeAutomationRequest) (*VolumeAutomation, error) {
	...
	localVarPath := localBasePath + "/v1/projects/{projectId}/regions/{region}/services/volumes/automations"
...
func (a *DefaultAPIService) CreateVolumeExecutionExecute(r ApiCreateVolumeExecutionRequest) (*VolumeExecutionResponse, error) {
	...
	localVarPath := localBasePath + "/v1/projects/{projectId}/regions/{region}/services/volumes/automations/{automationId}/executions"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(parameterValueToString(r.projectId, "projectId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"region"+"}", url.PathEscape(parameterValueToString(r.region, "region")), -1)
...
func (a *DefaultAPIService) DeleteVolumeAutomationExecute(r ApiDeleteVolumeAutomationRequest) error {
	...
	localVarPath := localBasePath + "/v1/projects/{projectId}/regions/{region}/services/volumes/automations/{automationId}"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(parameterValueToString(r.projectId, "projectId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"region"+"}", url.PathEscape(parameterValueToString(r.region, "region")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"automationId"+"}", url.PathEscape(parameterValueToString(r.automationId, "automationId")), -1)
...
func (a *DefaultAPIService) GetVolumeExecutionExecute(r ApiGetVolumeExecutionRequest) (*VolumeExecutionResponse, error) {
	...
	localVarPath := localBasePath + "/v1/projects/{projectId}/regions/{region}/services/volumes/automations/{automationId}/executions/{executionId}"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(parameterValueToString(r.projectId, "projectId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"region"+"}", url.PathEscape(parameterValueToString(r.region, "region")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"automationId"+"}", url.PathEscape(parameterValueToString(r.automationId, "automationId")), -1)
...
func (a *DefaultAPIService) GetVolumeTemplateExecute(r ApiGetVolumeTemplateRequest) (*GetVolumeTemplateResponse, error) {
	...
	localVarPath := localBasePath + "/v1/projects/{projectId}/regions/{region}/services/volumes/automations/templates/{templateId}"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(parameterValueToString(r.projectId, "projectId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"region"+"}", url.PathEscape(parameterValueToString(r.region, "region")), -1)
...
func (a *DefaultAPIService) ListVolumeTemplatesExecute(r ApiListVolumeTemplatesRequest) (*ListTemplatesResponse, error) {
	...
	localVarPath := localBasePath + "/v1/projects/{projectId}/regions/{region}/services/volumes/automations/templates"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(parameterValueToString(r.projectId, "projectId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"region"+"}", url.PathEscape(parameterValueToString(r.region, "region")), -1)
