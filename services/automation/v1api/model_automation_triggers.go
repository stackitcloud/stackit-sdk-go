...
type AutomationTriggers struct {
	Schedule             NullableAutomationScheduleTrigger `json:"schedule,omitempty"`
...
// SetSchedule gets a reference to the given NullableAutomationScheduleTrigger and assigns it to the Schedule field.
func (o *AutomationTriggers) SetSchedule(v AutomationScheduleTrigger) {
	o.Schedule.Set(&v)
}

// SetScheduleNil sets the value for Schedule to be an explicit nil
func (o *AutomationTriggers) SetScheduleNil() {
	o.Schedule.Set(nil)
}

// UnsetSchedule ensures that no value is present for Schedule, not even an explicit nil
func (o *AutomationTriggers) UnsetSchedule() {
	o.Schedule.Unset()
}
