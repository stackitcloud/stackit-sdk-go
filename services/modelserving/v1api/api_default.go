...
//
//	@return CreateTokenResponse
func (a *DefaultAPIService) CreateTokenExecute(r ApiCreateTokenRequest) (*CreateTokenResponse, error) {
	var (
...
//
//	@return GetChatModelResponse
func (a *DefaultAPIService) GetChatModelExecute(r ApiGetChatModelRequest) (*GetChatModelResponse, error) {
	var (
...
//
//	@return GetEmbeddingsModelResp
func (a *DefaultAPIService) GetEmbeddingModelExecute(r ApiGetEmbeddingModelRequest) (*GetEmbeddingsModelResp, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
