...
func NewModel(category ModelCategory, description string, displayedName string, id string, name string, region string, skus []SKU, types ModelType, url string) *Model {
	this := Model{}
...
func (o *Model) GetCategory() ModelCategory {
	if o == nil {
		var ret ModelCategory
		return ret
	}
...
func (o *Model) GetCategoryOk() (*ModelCategory, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Model) SetCategory(v ModelCategory) {
	o.Category = v
}
...
func (o *Model) GetType() ModelType {
	if o == nil {
		var ret ModelType
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Model) GetTypeOk() (*ModelType, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *Model) SetType(v ModelType) {
	o.Type = v
}
