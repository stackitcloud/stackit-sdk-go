...
func NewTokenCreated(content string, id string, name string, region string, state TokenCreatedState, validUntil time.Time) *TokenCreated {
	this := TokenCreated{}
...
func (o *TokenCreated) GetState() TokenCreatedState {
	if o == nil {
		var ret TokenCreatedState
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TokenCreated) GetStateOk() (*TokenCreatedState, bool) {
	if o == nil {
		return nil, false
	}
	return &o.State, true
...
func (o *TokenCreated) SetState(v TokenCreatedState) {
	o.State = v
}
