...
func NewUpdateInstanceRequestPayload(backupSchedule string, flavorId string, name string, network UpdateInstanceRequestPayloadNetwork, retentionDays int32, storage StorageUpdate, version InstanceVersion) *UpdateInstanceRequestPayload {
...
func (o *UpdateInstanceRequestPayload) GetLabels() map[string]string {
...
// and a boolean to check if the value has been set.
func (o *UpdateInstanceRequestPayload) GetLabelsOk() (*map[string]string, bool) {
	if o == nil || IsNil(o.Labels) {
		return nil, false
	}
...
func (o *UpdateInstanceRequestPayload) HasLabels() bool {
	if o != nil && !IsNil(o.Labels) {
		return true
	}
...
func (o *UpdateInstanceRequestPayload) SetLabels(v map[string]string) {
	o.Labels = &v
}
