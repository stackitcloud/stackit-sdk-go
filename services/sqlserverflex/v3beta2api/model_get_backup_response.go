...
type GetBackupResponse struct {
	...
	CompletionTime string `json:"completionTime" validate:"required,time"`
	// The ID of the backup.
	Id int64 `json:"id" validate:"required,backupId"`
	// The name of the backup.
	Name string `json:"name" validate:"required,backupName"`
	// The time until the backup will be retained.
	RetainedUntil string `json:"retainedUntil" validate:"required,time"`
	// The size of the backup in bytes.
	Size int64 `json:"size" validate:"required,min=1,max=1073741824000"`
	// The type of the backup, which can be automated or manual triggered.
	Type                 string `json:"type" validate:"required,backupType"`
