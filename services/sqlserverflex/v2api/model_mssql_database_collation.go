...
type _MssqlDatabaseCollation MssqlDatabaseCollation
...
func (o *MssqlDatabaseCollation) UnmarshalJSON(data []byte) (err error) {
	varMssqlDatabaseCollation := _MssqlDatabaseCollation{}

	err = json.Unmarshal(data, &varMssqlDatabaseCollation)

	if err != nil {
		return err
	}

	*o = MssqlDatabaseCollation(varMssqlDatabaseCollation)
