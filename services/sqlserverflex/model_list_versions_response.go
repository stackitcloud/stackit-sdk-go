...
// isArray
// Deprecated: Will be removed after 2026-09-30. Move to the packages generated for each available API version instead
type ListVersionsResponseGetVersionsAttributeType = *[]Version

// Deprecated: Will be removed after 2026-09-30. Move to the packages generated for each available API version instead
type ListVersionsResponseGetVersionsArgType = []Version

// Deprecated: Will be removed after 2026-09-30. Move to the packages generated for each available API version instead
type ListVersionsResponseGetVersionsRetType = []Version
...
type ListVersionsResponse struct {
	...
	// REQUIRED
	Versions ListVersionsResponseGetVersionsAttributeType `json:"versions" required:"true"`
}
...
// Deprecated: Will be removed after 2026-09-30. Move to the packages generated for each available API version instead
func NewListVersionsResponse(versions ListVersionsResponseGetVersionsArgType) *ListVersionsResponse {
	this := ListVersionsResponse{}
	setListVersionsResponseGetVersionsAttributeType(&this.Versions, versions)
	return &this
}
...
// Deprecated: Will be removed after 2026-09-30. Move to the packages generated for each available API version instead
func (o *ListVersionsResponse) GetVersions() (ret ListVersionsResponseGetVersionsRetType) {
