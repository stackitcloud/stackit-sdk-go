...
type DefaultAPI interface {
	...
	*/
	...
	GetStoragesRequestExecute(r ApiGetStoragesRequestRequest) (*GetStoragesResponse, *http.Response, error)
	...
	*/
	...
	ListCompatibilitiesRequestExecute(r ApiListCompatibilitiesRequestRequest) (*ListCompatibilityResponse, *http.Response, error)
	...
	*/
	...
	ListCurrentRunningRestoreJobsExecute(r ApiListCurrentRunningRestoreJobsRequest) (*ListCurrentRunningRestoreJobs, *http.Response, error)
	...
	*/
	...
	RestoreDatabaseFromBackupExecute(r ApiRestoreDatabaseFromBackupRequest) (*http.Response, error)
	...
	*/
	...
	TriggerBackupRequestExecute(r ApiTriggerBackupRequestRequest) (*http.Response, error)
	...
	*/
	...
	TriggerRestoreRequestExecute(r ApiTriggerRestoreRequestRequest) (*http.Response, error)
...
func (r ApiGetStoragesRequestRequest) Execute() (*GetStoragesResponse, *http.Response, error) {
...
//
//	@return GetStoragesResponse
func (a *DefaultAPIService) GetStoragesRequestExecute(r ApiGetStoragesRequestRequest) (*GetStoragesResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiListCompatibilitiesRequestRequest) Execute() (*ListCompatibilityResponse, *http.Response, error) {
...
//
//	@return ListCompatibilityResponse
func (a *DefaultAPIService) ListCompatibilitiesRequestExecute(r ApiListCompatibilitiesRequestRequest) (*ListCompatibilityResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiListCurrentRunningRestoreJobsRequest) Execute() (*ListCurrentRunningRestoreJobs, *http.Response, error) {
...
//
//	@return ListCurrentRunningRestoreJobs
func (a *DefaultAPIService) ListCurrentRunningRestoreJobsExecute(r ApiListCurrentRunningRestoreJobsRequest) (*ListCurrentRunningRestoreJobs, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiRestoreDatabaseFromBackupRequest) Execute() (*http.Response, error) {
...
// Execute executes the request
func (a *DefaultAPIService) RestoreDatabaseFromBackupExecute(r ApiRestoreDatabaseFromBackupRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodPost
		localVarPostBody   interface{}
		formFiles          []formFile
	...
	if r.restoreDatabaseFromBackupPayload == nil {
		return nil, reportError("restoreDatabaseFromBackupPayload is required and must be specified")
	}
...
func (r ApiTriggerBackupRequestRequest) Execute() (*http.Response, error) {
...
// Execute executes the request
func (a *DefaultAPIService) TriggerBackupRequestExecute(r ApiTriggerBackupRequestRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodPost
		localVarPostBody   interface{}
		formFiles          []formFile
...
func (r ApiTriggerRestoreRequestRequest) Execute() (*http.Response, error) {
...
// Execute executes the request
func (a *DefaultAPIService) TriggerRestoreRequestExecute(r ApiTriggerRestoreRequestRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodPost
		localVarPostBody   interface{}
		formFiles          []formFile
