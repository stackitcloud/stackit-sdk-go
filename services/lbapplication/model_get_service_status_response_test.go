...
func TestGetServiceStatusResponseStatus_UnmarshalJSON(t *testing.T) {
	type args struct {
		src []byte
	}
	tests := []struct {
		...
		},
		{
			...
			args: args{
				src: []byte(`"STATUS_PROJECT_UNKNOWN"`),
			},
			wantErr: false,
		},
		{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			v := GetServiceStatusResponseStatus("")
