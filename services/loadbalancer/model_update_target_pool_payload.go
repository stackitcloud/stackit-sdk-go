...
func getUpdateTargetPoolPayloadGetSessionPersistenceAttributeTypeOk(arg UpdateTargetPoolPayloadGetSessionPersistenceAttributeType) (ret UpdateTargetPoolPayloadGetSessionPersistenceRetType, ok bool) {
	if arg == nil {
		return ret, false
	}
	return *arg, true
...
func setUpdateTargetPoolPayloadGetSessionPersistenceAttributeType(arg *UpdateTargetPoolPayloadGetSessionPersistenceAttributeType, val UpdateTargetPoolPayloadGetSessionPersistenceRetType) {
	*arg = &val
}
...
type UpdateTargetPoolPayload struct {
	...
	// Target pool name
	Name               UpdateTargetPoolPayloadGetNameAttributeType               `json:"name,omitempty" validate:"regexp=^[0-9a-z](?:(?:[0-9a-z]|-){0,18}[0-9a-z])?$"`
...
func (o *UpdateTargetPoolPayload) GetSessionPersistenceOk() (ret UpdateTargetPoolPayloadGetSessionPersistenceRetType, ok bool) {
	return getUpdateTargetPoolPayloadGetSessionPersistenceAttributeTypeOk(o.SessionPersistence)
}
...
func (o *UpdateTargetPoolPayload) SetSessionPersistence(v UpdateTargetPoolPayloadGetSessionPersistenceRetType) {
	setUpdateTargetPoolPayloadGetSessionPersistenceAttributeType(&o.SessionPersistence, v)
}
...
func (o UpdateTargetPoolPayload) ToMap() (map[string]interface{}, error) {
	...
	if val, ok := getUpdateTargetPoolPayloadGetSessionPersistenceAttributeTypeOk(o.SessionPersistence); ok {
