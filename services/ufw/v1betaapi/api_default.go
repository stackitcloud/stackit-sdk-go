...
type DefaultAPI interface {
	...
	*/
	...
	/*
		V1betaExportFolderRules Export rules for folder as CSV
		...
		@param regionId The STACKIT region name the resource is located in.
		@return ApiV1betaExportFolderRulesRequest
	*/
	V1betaExportFolderRules(ctx context.Context, folderId string, regionId string) ApiV1betaExportFolderRulesRequest

	// V1betaExportFolderRulesExecute executes the request
	//  @return *os.File
	V1betaExportFolderRulesExecute(r ApiV1betaExportFolderRulesRequest) (*os.File, error)
...
type ApiV1betaExportFolderRulesRequest struct {
	ctx        context.Context
	ApiService DefaultAPI
	folderId   string
	regionId   string
	filters    *V1betaExportFolderRulesFiltersParameter
}

// Filtering criteria for the export
func (r ApiV1betaExportFolderRulesRequest) Filters(filters V1betaExportFolderRulesFiltersParameter) ApiV1betaExportFolderRulesRequest {
	r.filters = &filters
	return r
}

func (r ApiV1betaExportFolderRulesRequest) Execute() (*os.File, error) {
	return r.ApiService.V1betaExportFolderRulesExecute(r)
}
...
Returns a CSV file containing the rules for a specific folder
	...
	@return ApiV1betaExportFolderRulesRequest
*/
func (a *DefaultAPIService) V1betaExportFolderRules(ctx context.Context, folderId string, regionId string) ApiV1betaExportFolderRulesRequest {
	return ApiV1betaExportFolderRulesRequest{
		ApiService: a,
		ctx:        ctx,
		folderId:   folderId,
...
//
//	@return *os.File
func (a *DefaultAPIService) V1betaExportFolderRulesExecute(r ApiV1betaExportFolderRulesRequest) (*os.File, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultAPIService.V1betaExportFolderRules")
	if err != nil {
		return localVarReturnValue, &oapierror.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/v1beta/folder/{folderId}/regions/{regionId}/rules/export"
...
// Filtering criteria for the export
func (r ApiV1betaExportRulesRequest) Filters(filters V1betaExportFolderRulesFiltersParameter) ApiV1betaExportRulesRequest {
	r.filters = &filters
	return r
}
