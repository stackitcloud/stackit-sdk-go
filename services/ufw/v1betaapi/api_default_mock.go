...
type DefaultAPIServiceMock struct {
	...
	// V1betaExportFolderRulesExecuteMock can be populated to implement the behavior of the V1betaExportFolderRulesExecute function of this mock
	V1betaExportFolderRulesExecuteMock *func(r ApiV1betaExportFolderRulesRequest) (*os.File, error)
	// V1betaExportRulesExecuteMock can be populated to implement the behavior of the V1betaExportRulesExecute function of this mock
	V1betaExportRulesExecuteMock *func(r ApiV1betaExportRulesRequest) (*os.File, error)
	// V1betaGetFolderResourcesExecuteMock can be populated to implement the behavior of the V1betaGetFolderResourcesExecute function of this mock
	V1betaGetFolderResourcesExecuteMock *func(r ApiV1betaGetFolderResourcesRequest) (*ListContainersResponse, error)
	// V1betaGetOrganizationResourcesExecuteMock can be populated to implement the behavior of the V1betaGetOrganizationResourcesExecute function of this mock
	V1betaGetOrganizationResourcesExecuteMock *func(r ApiV1betaGetOrganizationResourcesRequest) (*ListContainersResponse, error)
}
...
func (a DefaultAPIServiceMock) V1betaExportFolderRules(ctx context.Context, folderId string, regionId string) ApiV1betaExportFolderRulesRequest {
...
// V1betaExportFolderRulesExecute is a no-op by default and will return only return nil values. Behavior can be controlled by populating the V1betaExportFolderRulesExecuteMock field in the DefaultAPIServiceMock struct.
func (a DefaultAPIServiceMock) V1betaExportFolderRulesExecute(r ApiV1betaExportFolderRulesRequest) (*os.File, error) {
	if a.V1betaExportFolderRulesExecuteMock == nil {
		var localVarReturnValue *os.File
		return localVarReturnValue, nil
	}

	return (*a.V1betaExportFolderRulesExecuteMock)(r)
}

func (a DefaultAPIServiceMock) V1betaExportRules(ctx context.Context, projectId string, regionId string) ApiV1betaExportRulesRequest {
...
// V1betaExportRulesExecute is a no-op by default and will return only return nil values. Behavior can be controlled by populating the V1betaExportRulesExecuteMock field in the DefaultAPIServiceMock struct.
func (a DefaultAPIServiceMock) V1betaExportRulesExecute(r ApiV1betaExportRulesRequest) (*os.File, error) {
	if a.V1betaExportRulesExecuteMock == nil {
		var localVarReturnValue *os.File
		return localVarReturnValue, nil
	}

	return (*a.V1betaExportRulesExecuteMock)(r)
}

func (a DefaultAPIServiceMock) V1betaGetFolderResources(ctx context.Context, folderId string) ApiV1betaGetFolderResourcesRequest {
...
// V1betaGetFolderResourcesExecute is a no-op by default and will return only return nil values. Behavior can be controlled by populating the V1betaGetFolderResourcesExecuteMock field in the DefaultAPIServiceMock struct.
func (a DefaultAPIServiceMock) V1betaGetFolderResourcesExecute(r ApiV1betaGetFolderResourcesRequest) (*ListContainersResponse, error) {
	if a.V1betaGetFolderResourcesExecuteMock == nil {
		var localVarReturnValue *ListContainersResponse
		return localVarReturnValue, nil
	}

	return (*a.V1betaGetFolderResourcesExecuteMock)(r)
}

func (a DefaultAPIServiceMock) V1betaGetOrganizationResources(ctx context.Context, organizationId string) ApiV1betaGetOrganizationResourcesRequest {
...
// V1betaGetOrganizationResourcesExecute is a no-op by default and will return only return nil values. Behavior can be controlled by populating the V1betaGetOrganizationResourcesExecuteMock field in the DefaultAPIServiceMock struct.
func (a DefaultAPIServiceMock) V1betaGetOrganizationResourcesExecute(r ApiV1betaGetOrganizationResourcesRequest) (*ListContainersResponse, error) {
	if a.V1betaGetOrganizationResourcesExecuteMock == nil {
		var localVarReturnValue *ListContainersResponse
		return localVarReturnValue, nil
	}

	return (*a.V1betaGetOrganizationResourcesExecuteMock)(r)
}
