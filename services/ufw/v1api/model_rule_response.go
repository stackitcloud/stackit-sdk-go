...
func (o *RuleResponse) GetStateful() bool {
...
// and a boolean to check if the value has been set.
func (o *RuleResponse) GetStatefulOk() (*bool, bool) {
	if o == nil || IsNil(o.Stateful) {
		return nil, false
	}
...
func (o *RuleResponse) HasStateful() bool {
	if o != nil && !IsNil(o.Stateful) {
		return true
	}
...
func (o *RuleResponse) SetStateful(v bool) {
	o.Stateful = &v
}
