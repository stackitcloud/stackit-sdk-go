...
type RuleResponse struct {
	...
	Status                *RuleResponseStatus `json:"status,omitempty"`
...
func NewRuleResponse(destination string, instanceId string, product string, sourceIP string, types string) *RuleResponse {
	this := RuleResponse{}
...
// SetStatus gets a reference to the given RuleResponseStatus and assigns it to the Status field.
