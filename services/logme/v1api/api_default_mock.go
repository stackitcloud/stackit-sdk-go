...
type DefaultAPIServiceMock struct {
	...
	CreateBackupExecuteMock *func(r ApiCreateBackupRequest) ([]CreateBackupResponseItem, *http.Response, error)
	...
	CreateCredentialsExecuteMock *func(r ApiCreateCredentialsRequest) (*CredentialsResponse, *http.Response, error)
	...
	DeleteCredentialsExecuteMock *func(r ApiDeleteCredentialsRequest) (*http.Response, error)
	...
	DownloadBackupExecuteMock *func(r ApiDownloadBackupRequest) (*os.File, *http.Response, error)
	// GetCredentialsExecuteMock can be populated to implement the behavior of the GetCredentialsExecute function of this mock
	GetCredentialsExecuteMock *func(r ApiGetCredentialsRequest) (*CredentialsResponse, *http.Response, error)
	...
	GetMetricsExecuteMock *func(r ApiGetMetricsRequest) (*GetMetricsResponse, *http.Response, error)
	...
	ListOfferingsExecuteMock *func(r ApiListOfferingsRequest) (*ListOfferingsResponse, *http.Response, error)
	// ListRestoresExecuteMock can be populated to implement the behavior of the ListRestoresExecute function of this mock
	ListRestoresExecuteMock *func(r ApiListRestoresRequest) (*ListRestoresResponse, *http.Response, error)
	...
	PartialUpdateInstanceExecuteMock *func(r ApiPartialUpdateInstanceRequest) (*http.Response, error)
	...
	TriggerRecreateExecuteMock *func(r ApiTriggerRecreateRequest) (*CreateInstanceResponse, *http.Response, error)
	// TriggerRestartExecuteMock can be populated to implement the behavior of the TriggerRestartExecute function of this mock
	TriggerRestartExecuteMock *func(r ApiTriggerRestartRequest) (*CreateInstanceResponse, *http.Response, error)
	// TriggerRestoreExecuteMock can be populated to implement the behavior of the TriggerRestoreExecute function of this mock
	TriggerRestoreExecuteMock *func(r ApiTriggerRestoreRequest) (*TriggerRestoreResponse, *http.Response, error)
	...
	UpdateBackupsConfigExecuteMock *func(r ApiUpdateBackupsConfigRequest) (*UpdateBackupsConfigResponse, *http.Response, error)
}
...
func (a DefaultAPIServiceMock) CreateBackupExecute(r ApiCreateBackupRequest) ([]CreateBackupResponseItem, *http.Response, error) {
...
func (a DefaultAPIServiceMock) CreateCredentialsExecute(r ApiCreateCredentialsRequest) (*CredentialsResponse, *http.Response, error) {
...
func (a DefaultAPIServiceMock) DeleteCredentialsExecute(r ApiDeleteCredentialsRequest) (*http.Response, error) {
...
func (a DefaultAPIServiceMock) DownloadBackupExecute(r ApiDownloadBackupRequest) (*os.File, *http.Response, error) {
...
func (a DefaultAPIServiceMock) GetCredentialsExecute(r ApiGetCredentialsRequest) (*CredentialsResponse, *http.Response, error) {
...
func (a DefaultAPIServiceMock) GetMetricsExecute(r ApiGetMetricsRequest) (*GetMetricsResponse, *http.Response, error) {
...
func (a DefaultAPIServiceMock) ListOfferingsExecute(r ApiListOfferingsRequest) (*ListOfferingsResponse, *http.Response, error) {
...
func (a DefaultAPIServiceMock) ListRestoresExecute(r ApiListRestoresRequest) (*ListRestoresResponse, *http.Response, error) {
...
func (a DefaultAPIServiceMock) PartialUpdateInstanceExecute(r ApiPartialUpdateInstanceRequest) (*http.Response, error) {
...
func (a DefaultAPIServiceMock) TriggerRecreateExecute(r ApiTriggerRecreateRequest) (*CreateInstanceResponse, *http.Response, error) {
...
func (a DefaultAPIServiceMock) TriggerRestartExecute(r ApiTriggerRestartRequest) (*CreateInstanceResponse, *http.Response, error) {
...
func (a DefaultAPIServiceMock) TriggerRestoreExecute(r ApiTriggerRestoreRequest) (*TriggerRestoreResponse, *http.Response, error) {
...
func (a DefaultAPIServiceMock) UpdateBackupsConfigExecute(r ApiUpdateBackupsConfigRequest) (*UpdateBackupsConfigResponse, *http.Response, error) {
