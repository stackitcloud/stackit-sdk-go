...
func (o ContactSales) MarshalJSON() ([]byte, error) {
...
func (o *ContactSales) UnmarshalJSON(data []byte) (err error) {
	...
	varContactSales := _ContactSales{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varContactSales)

	if err != nil {
		return err
	}

	*o = ContactSales(varContactSales)
