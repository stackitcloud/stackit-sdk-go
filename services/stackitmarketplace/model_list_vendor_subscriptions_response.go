...
func (o ListVendorSubscriptionsResponse) MarshalJSON() ([]byte, error) {
...
func (o *ListVendorSubscriptionsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varListVendorSubscriptionsResponse := _ListVendorSubscriptionsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListVendorSubscriptionsResponse)

	if err != nil {
		return err
	}

	*o = ListVendorSubscriptionsResponse(varListVendorSubscriptionsResponse)
