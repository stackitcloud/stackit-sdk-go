...
type CatalogProductVendorTerms struct {
	...
	// REQUIRED
	Url CatalogProductVendorTermsGetUrlAttributeType `json:"url" validate:"regexp=^(https?:\\/\\/)?([\\\\da-z\\\\.-]+)\\\\.([a-z\\\\.]{2,6})([\\/\\\\w \\\\.-]*)*_\\/?$"`
}
...
func (o CatalogProductVendorTerms) MarshalJSON() ([]byte, error) {
...
func (o *CatalogProductVendorTerms) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogProductVendorTerms := _CatalogProductVendorTerms{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogProductVendorTerms)

	if err != nil {
		return err
	}

	*o = CatalogProductVendorTerms(varCatalogProductVendorTerms)
