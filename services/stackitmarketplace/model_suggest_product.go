...
func (o SuggestProduct) MarshalJSON() ([]byte, error) {
...
func (o *SuggestProduct) UnmarshalJSON(data []byte) (err error) {
	...
	varSuggestProduct := _SuggestProduct{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSuggestProduct)

	if err != nil {
		return err
	}

	*o = SuggestProduct(varSuggestProduct)
