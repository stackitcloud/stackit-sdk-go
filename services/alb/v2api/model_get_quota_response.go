...
func (o *GetQuotaResponse) GetMaxCredentials() int32 {
	if o == nil || IsNil(o.MaxCredentials) {
		var ret int32
		return ret
	}
	return *o.MaxCredentials
}
...
func (o *GetQuotaResponse) GetUsedCredentials() int32 {
	if o == nil || IsNil(o.UsedCredentials) {
		var ret int32
		return ret
	}
	return *o.UsedCredentials
}
...
func (o *GetQuotaResponse) GetUsedLoadBalancers() int32 {
	if o == nil || IsNil(o.UsedLoadBalancers) {
		var ret int32
		return ret
	}
	return *o.UsedLoadBalancers
}
...
func (o *GetQuotaResponse) GetUsedLoadBalancersOk() (*int32, bool) {
	...
	return o.UsedLoadBalancers, true
}
...
func (o GetQuotaResponse) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.MaxCredentials) {
		toSerialize["maxCredentials"] = o.MaxCredentials
	}
	...
	if !IsNil(o.UsedCredentials) {
		toSerialize["usedCredentials"] = o.UsedCredentials
	}
