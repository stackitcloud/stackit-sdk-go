...
func (o *UpdateTargetPoolPayload) GetTlsConfig() TlsConfig {
...
// and a boolean to check if the value has been set.
func (o *UpdateTargetPoolPayload) GetTlsConfigOk() (*TlsConfig, bool) {
	if o == nil || IsNil(o.TlsConfig) {
		return nil, false
	}
...
func (o *UpdateTargetPoolPayload) SetTlsConfig(v TlsConfig) {
	o.TlsConfig = &v
}
