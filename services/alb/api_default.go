...
func (r ApiCreateCredentialsRequest) Execute() (*CreateCredentialsResponse, error) {
	...
	localVarPath := localBasePath + "/v2beta/projects/{projectId}/regions/{region}/credentials"
...
func (r ApiCreateLoadBalancerRequest) Execute() (*LoadBalancer, error) {
	...
	localVarPath := localBasePath + "/v2beta/projects/{projectId}/regions/{region}/load-balancers"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(ParameterValueToString(r.projectId, "projectId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"region"+"}", url.PathEscape(ParameterValueToString(r.region, "region")), -1)
...
func (r ApiDeleteCredentialsRequest) Execute() (map[string]interface{}, error) {
	...
	localVarPath := localBasePath + "/v2beta/projects/{projectId}/regions/{region}/credentials/{credentialsRef}"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(ParameterValueToString(r.projectId, "projectId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"region"+"}", url.PathEscape(ParameterValueToString(r.region, "region")), -1)
...
func (r ApiDeleteLoadBalancerRequest) Execute() (map[string]interface{}, error) {
	...
	localVarPath := localBasePath + "/v2beta/projects/{projectId}/regions/{region}/load-balancers/{name}"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(ParameterValueToString(r.projectId, "projectId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"region"+"}", url.PathEscape(ParameterValueToString(r.region, "region")), -1)
...
func (r ApiGetQuotaRequest) Execute() (*GetQuotaResponse, error) {
	...
	localVarPath := localBasePath + "/v2beta/projects/{projectId}/regions/{region}/quota"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(ParameterValueToString(r.projectId, "projectId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"region"+"}", url.PathEscape(ParameterValueToString(r.region, "region")), -1)
...
func (r ApiListPlansRequest) Execute() (*ListPlansResponse, error) {
	...
	localVarPath := localBasePath + "/v2beta/regions/{region}/plans"
	localVarPath = strings.Replace(localVarPath, "{"+"region"+"}", url.PathEscape(ParameterValueToString(r.region, "region")), -1)
...
func (r ApiUpdateTargetPoolRequest) Execute() (*TargetPool, error) {
	...
	localVarPath := localBasePath + "/v2beta/projects/{projectId}/regions/{region}/load-balancers/{name}/target-pools/{targetPoolName}"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(ParameterValueToString(r.projectId, "projectId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"region"+"}", url.PathEscape(ParameterValueToString(r.region, "region")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"name"+"}", url.PathEscape(ParameterValueToString(r.name, "name")), -1)
