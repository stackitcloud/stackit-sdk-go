...
type _NewCommandResponse NewCommandResponse
...
func (o *NewCommandResponse) UnmarshalJSON(data []byte) (err error) {
	varNewCommandResponse := _NewCommandResponse{}

	err = json.Unmarshal(data, &varNewCommandResponse)

	if err != nil {
		return err
	}

	*o = NewCommandResponse(varNewCommandResponse)
