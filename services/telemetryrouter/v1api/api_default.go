...
type DefaultAPI interface {
	...
	*/
	...
	/*
		...
		@param regionId The STACKIT region name the resource is located in.
		@param telemetryRouterId The Telemetry Router UUID.
		@param accessIdId The Access Token UUID.
		@return ApiDeleteAccessTokenRequest
	*/
	DeleteAccessToken(ctx context.Context, projectId string, regionId string, telemetryRouterId string, accessIdId string) ApiDeleteAccessTokenRequest
	...
	*/
	GetAccessToken(ctx context.Context, projectId string, regionId string, telemetryRouterId string, accessIdId string) ApiGetAccessTokenRequest
	...
	*/
	UpdateAccessToken(ctx context.Context, projectId string, regionId string, telemetryRouterId string, accessIdId string) ApiUpdateAccessTokenRequest
...
func (a *DefaultAPIService) CreateAccessTokenExecute(r ApiCreateAccessTokenRequest) (*CreateAccessTokenResponse, error) {
	...
	localVarPath := localBasePath + "/v1/projects/{projectId}/regions/{regionId}/telemetry-routers/{telemetryRouterId}/access-tokens"
...
func (a *DefaultAPIService) CreateDestinationExecute(r ApiCreateDestinationRequest) (*DestinationResponse, error) {
	...
	localVarPath := localBasePath + "/v1/projects/{projectId}/regions/{regionId}/telemetry-routers/{telemetryRouterId}/destinations"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(parameterValueToString(r.projectId, "projectId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"regionId"+"}", url.PathEscape(parameterValueToString(r.regionId, "regionId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"telemetryRouterId"+"}", url.PathEscape(parameterValueToString(r.telemetryRouterId, "telemetryRouterId")), -1)
...
func (a *DefaultAPIService) CreateTelemetryRouterExecute(r ApiCreateTelemetryRouterRequest) (*TelemetryRouterResponse, error) {
	...
	localVarPath := localBasePath + "/v1/projects/{projectId}/regions/{regionId}/telemetry-routers"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(parameterValueToString(r.projectId, "projectId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"regionId"+"}", url.PathEscape(parameterValueToString(r.regionId, "regionId")), -1)
...
Delete an access token for the given Telemetry Router by its ID.
	...
	@return ApiDeleteAccessTokenRequest
*/
func (a *DefaultAPIService) DeleteAccessToken(ctx context.Context, projectId string, regionId string, telemetryRouterId string, accessIdId string) ApiDeleteAccessTokenRequest {
	return ApiDeleteAccessTokenRequest{
		ApiService:        a,
		ctx:               ctx,
		projectId:         projectId,
...
func (a *DefaultAPIService) DeleteAccessTokenExecute(r ApiDeleteAccessTokenRequest) error {
	...
	localVarPath := localBasePath + "/v1/projects/{projectId}/regions/{regionId}/telemetry-routers/{telemetryRouterId}/access-tokens/{accessIdId}"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(parameterValueToString(r.projectId, "projectId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"regionId"+"}", url.PathEscape(parameterValueToString(r.regionId, "regionId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"telemetryRouterId"+"}", url.PathEscape(parameterValueToString(r.telemetryRouterId, "telemetryRouterId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"accessIdId"+"}", url.PathEscape(parameterValueToString(r.accessIdId, "accessIdId")), -1)
...
func (a *DefaultAPIService) DeleteDestinationExecute(r ApiDeleteDestinationRequest) error {
	...
	localVarPath := localBasePath + "/v1/projects/{projectId}/regions/{regionId}/telemetry-routers/{telemetryRouterId}/destinations/{destinationId}"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(parameterValueToString(r.projectId, "projectId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"regionId"+"}", url.PathEscape(parameterValueToString(r.regionId, "regionId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"telemetryRouterId"+"}", url.PathEscape(parameterValueToString(r.telemetryRouterId, "telemetryRouterId")), -1)
...
func (a *DefaultAPIService) DeleteTelemetryRouterExecute(r ApiDeleteTelemetryRouterRequest) error {
	...
	localVarPath := localBasePath + "/v1/projects/{projectId}/regions/{regionId}/telemetry-routers/{telemetryRouterId}"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(parameterValueToString(r.projectId, "projectId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"regionId"+"}", url.PathEscape(parameterValueToString(r.regionId, "regionId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"telemetryRouterId"+"}", url.PathEscape(parameterValueToString(r.telemetryRouterId, "telemetryRouterId")), -1)
...
Get an access token for the given Telemetry Router by its ID.
	...
	@return ApiGetAccessTokenRequest
*/
func (a *DefaultAPIService) GetAccessToken(ctx context.Context, projectId string, regionId string, telemetryRouterId string, accessIdId string) ApiGetAccessTokenRequest {
	return ApiGetAccessTokenRequest{
		ApiService:        a,
		ctx:               ctx,
		projectId:         projectId,
...
func (r ApiListAccessTokensRequest) PageId(pageId string) ApiListAccessTokensRequest {
	r.pageId = &pageId
	return r
}
...
// A token to retrieve the next page of results.
func (r ApiListDestinationsRequest) PageId(pageId string) ApiListDestinationsRequest {
	r.pageId = &pageId
	return r
}
...
// A token to retrieve the next page of results.
func (r ApiListTelemetryRoutersRequest) PageId(pageId string) ApiListTelemetryRoutersRequest {
	r.pageId = &pageId
	return r
}
...
Update an existing access token for the given Telemetry Router by its ID.
	...
	@return ApiUpdateAccessTokenRequest
*/
func (a *DefaultAPIService) UpdateAccessToken(ctx context.Context, projectId string, regionId string, telemetryRouterId string, accessIdId string) ApiUpdateAccessTokenRequest {
	return ApiUpdateAccessTokenRequest{
		ApiService:        a,
		ctx:               ctx,
		projectId:         projectId,
