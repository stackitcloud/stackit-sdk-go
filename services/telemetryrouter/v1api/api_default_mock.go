...
func (a DefaultAPIServiceMock) DeleteAccessToken(ctx context.Context, projectId string, regionId string, telemetryRouterId string, accessIdId string) ApiDeleteAccessTokenRequest {
...
func (a DefaultAPIServiceMock) GetAccessToken(ctx context.Context, projectId string, regionId string, telemetryRouterId string, accessIdId string) ApiGetAccessTokenRequest {
...
func (a DefaultAPIServiceMock) UpdateAccessToken(ctx context.Context, projectId string, regionId string, telemetryRouterId string, accessIdId string) ApiUpdateAccessTokenRequest {
