...
func (a DefaultAPIServiceMock) AddMembersExecute(r ApiAddMembersRequest) (*MembersResponse, error) {
...
func (a DefaultAPIServiceMock) AddRoleExecute(r ApiAddRoleRequest) (*AddCustomRoleResponse, error) {
...
func (a DefaultAPIServiceMock) DeleteRoleExecute(r ApiDeleteRoleRequest) (*DeleteRoleResponse, error) {
...
func (a DefaultAPIServiceMock) GetRoleExecute(r ApiGetRoleRequest) (*GetRoleResponse, error) {
...
func (a DefaultAPIServiceMock) ListMembersExecute(r ApiListMembersRequest) (*ListMembersResponse, error) {
...
func (a DefaultAPIServiceMock) ListPermissionsExecute(r ApiListPermissionsRequest) (*ListPermissionsResponse, error) {
...
func (a DefaultAPIServiceMock) ListRolesExecute(r ApiListRolesRequest) (*RolesResponse, error) {
...
func (a DefaultAPIServiceMock) ListUserMembershipsExecute(r ApiListUserMembershipsRequest) (*ListUserMembershipsResponse, error) {
...
func (a DefaultAPIServiceMock) ListUserPermissionsExecute(r ApiListUserPermissionsRequest) (*ListUserPermissionsResponse, error) {
...
func (a DefaultAPIServiceMock) RemoveMembersExecute(r ApiRemoveMembersRequest) (*MembersResponse, error) {
...
func (a DefaultAPIServiceMock) UpdateRoleExecute(r ApiUpdateRoleRequest) (*UpdateRoleResponse, error) {
