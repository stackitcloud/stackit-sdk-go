...
type DefaultAPI interface {
	...
	*/
	...
	AddMembersExecute(r ApiAddMembersRequest) (*MembersResponse, *http.Response, error)
	...
	*/
	...
	AddRoleExecute(r ApiAddRoleRequest) (*AddCustomRoleResponse, *http.Response, error)
	...
	*/
	...
	DeleteRoleExecute(r ApiDeleteRoleRequest) (*DeleteRoleResponse, *http.Response, error)
	...
	*/
	...
	GetRoleExecute(r ApiGetRoleRequest) (*GetRoleResponse, *http.Response, error)
	...
	*/
	...
	ListMembersExecute(r ApiListMembersRequest) (*ListMembersResponse, *http.Response, error)
	...
	*/
	...
	ListRolesExecute(r ApiListRolesRequest) (*RolesResponse, *http.Response, error)
	...
	*/
	...
	ListUserMembershipsExecute(r ApiListUserMembershipsRequest) (*ListUserMembershipsResponse, *http.Response, error)
	...
	*/
	...
	ListUserPermissionsExecute(r ApiListUserPermissionsRequest) (*ListUserPermissionsResponse, *http.Response, error)
	...
	*/
	...
	//  @return MembersResponse
	RemoveMembersExecute(r ApiRemoveMembersRequest) (*MembersResponse, *http.Response, error)
	...
	*/
	...
	UpdateRoleExecute(r ApiUpdateRoleRequest) (*UpdateRoleResponse, *http.Response, error)
}
...
func (r ApiAddMembersRequest) Execute() (*MembersResponse, *http.Response, error) {
...
//
//	@return MembersResponse
func (a *DefaultAPIService) AddMembersExecute(r ApiAddMembersRequest) (*MembersResponse, *http.Response, error) {
	var (
	...
	if r.addMembersPayload == nil {
		return localVarReturnValue, nil, reportError("addMembersPayload is required and must be specified")
	}
...
func (r ApiAddRoleRequest) Execute() (*AddCustomRoleResponse, *http.Response, error) {
...
//
//	@return AddCustomRoleResponse
func (a *DefaultAPIService) AddRoleExecute(r ApiAddRoleRequest) (*AddCustomRoleResponse, *http.Response, error) {
	var (
	...
	if r.addRolePayload == nil {
		return localVarReturnValue, nil, reportError("addRolePayload is required and must be specified")
	}
...
func (r ApiDeleteRoleRequest) Execute() (*DeleteRoleResponse, *http.Response, error) {
...
//
//	@return DeleteRoleResponse
func (a *DefaultAPIService) DeleteRoleExecute(r ApiDeleteRoleRequest) (*DeleteRoleResponse, *http.Response, error) {
	var (
...
func (r ApiListMembersRequest) Execute() (*ListMembersResponse, *http.Response, error) {
...
//
//	@return ListMembersResponse
func (a *DefaultAPIService) ListMembersExecute(r ApiListMembersRequest) (*ListMembersResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
//
//	@return ListPermissionsResponse
func (a *DefaultAPIService) ListPermissionsExecute(r ApiListPermissionsRequest) (*ListPermissionsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiListRolesRequest) Execute() (*RolesResponse, *http.Response, error) {
...
//
//	@return RolesResponse
func (a *DefaultAPIService) ListRolesExecute(r ApiListRolesRequest) (*RolesResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiListUserMembershipsRequest) Execute() (*ListUserMembershipsResponse, *http.Response, error) {
...
//
//	@return ListUserMembershipsResponse
func (a *DefaultAPIService) ListUserMembershipsExecute(r ApiListUserMembershipsRequest) (*ListUserMembershipsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiListUserPermissionsRequest) Execute() (*ListUserPermissionsResponse, *http.Response, error) {
...
//
//	@return ListUserPermissionsResponse
func (a *DefaultAPIService) ListUserPermissionsExecute(r ApiListUserPermissionsRequest) (*ListUserPermissionsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiRemoveMembersRequest) Execute() (*MembersResponse, *http.Response, error) {
...
//
//	@return MembersResponse
func (a *DefaultAPIService) RemoveMembersExecute(r ApiRemoveMembersRequest) (*MembersResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	if r.removeMembersPayload == nil {
		return localVarReturnValue, nil, reportError("removeMembersPayload is required and must be specified")
	}
...
//
//	@return UpdateRoleResponse
func (a *DefaultAPIService) UpdateRoleExecute(r ApiUpdateRoleRequest) (*UpdateRoleResponse, *http.Response, error) {
	var (
	...
	if r.updateRolePayload == nil {
		return localVarReturnValue, nil, reportError("updateRolePayload is required and must be specified")
	}
