...
func (o *TopicSettings) GetServiceLogs() bool {
	if o == nil || IsNil(o.ServiceLogs) {
		var ret bool
		return ret
	}
	return *o.ServiceLogs
}

// GetServiceLogsOk returns a tuple with the ServiceLogs field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TopicSettings) GetServiceLogsOk() (*bool, bool) {
	if o == nil || IsNil(o.ServiceLogs) {
		return nil, false
	}
	return o.ServiceLogs, true
}
...
func (o TopicSettings) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ServiceLogs) {
		toSerialize["serviceLogs"] = o.ServiceLogs
	}
...
func (o *TopicSettings) UnmarshalJSON(data []byte) (err error) {
	...
	*o = TopicSettings(varTopicSettings)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "serviceLogs")
