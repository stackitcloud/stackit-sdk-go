...
type ApiGrantSubscriptionSubscriberAccessRequest struct {
	...
	topicId                                  string
	subscriptionId                           string
	grantSubscriptionSubscriberAccessPayload *GrantSubscriptionSubscriberAccessPayload
}
...
func (r ApiGrantSubscriptionSubscriberAccessRequest) GrantSubscriptionSubscriberAccessPayload(grantSubscriptionSubscriberAccessPayload GrantSubscriptionSubscriberAccessPayload) ApiGrantSubscriptionSubscriberAccessRequest {
	r.grantSubscriptionSubscriberAccessPayload = &grantSubscriptionSubscriberAccessPayload
	return r
}
...
func (a *DefaultAPIService) GrantSubscriptionSubscriberAccessExecute(r ApiGrantSubscriptionSubscriberAccessRequest) error {
	...
	if r.grantSubscriptionSubscriberAccessPayload == nil {
		return reportError("grantSubscriptionSubscriberAccessPayload is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.grantSubscriptionSubscriberAccessPayload
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return err
	}
...
type ApiGrantTopicPublisherAccessRequest struct {
	...
	regionId                         string
	topicId                          string
	grantTopicPublisherAccessPayload *GrantTopicPublisherAccessPayload
}
...
func (r ApiGrantTopicPublisherAccessRequest) GrantTopicPublisherAccessPayload(grantTopicPublisherAccessPayload GrantTopicPublisherAccessPayload) ApiGrantTopicPublisherAccessRequest {
	r.grantTopicPublisherAccessPayload = &grantTopicPublisherAccessPayload
	return r
}
...
func (a *DefaultAPIService) GrantTopicPublisherAccessExecute(r ApiGrantTopicPublisherAccessRequest) error {
	...
	if r.grantTopicPublisherAccessPayload == nil {
		return reportError("grantTopicPublisherAccessPayload is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.grantTopicPublisherAccessPayload
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return err
	}
...
func (r ApiListSubscriptionSubscribersRequest) Execute() (*ListEmailAddressesResponse, error) {
...
func (a *DefaultAPIService) ListSubscriptionSubscribersExecute(r ApiListSubscriptionSubscribersRequest) (*ListEmailAddressesResponse, error) {
	var (
		...
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ListEmailAddressesResponse
	)
...
func (r ApiListTopicPublishersRequest) Execute() (*ListEmailAddressesResponse, error) {
...
//
//	@return ListEmailAddressesResponse
func (a *DefaultAPIService) ListTopicPublishersExecute(r ApiListTopicPublishersRequest) (*ListEmailAddressesResponse, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
type ApiUpdatePublisherAccessRequest struct {
	...
	regionId                     string
	topicId                      string
	updatePublisherAccessPayload *UpdatePublisherAccessPayload
}
...
func (r ApiUpdatePublisherAccessRequest) UpdatePublisherAccessPayload(updatePublisherAccessPayload UpdatePublisherAccessPayload) ApiUpdatePublisherAccessRequest {
	r.updatePublisherAccessPayload = &updatePublisherAccessPayload
	return r
}

func (r ApiUpdatePublisherAccessRequest) Execute() error {
	return r.ApiService.UpdatePublisherAccessExecute(r)
}
...
func (a *DefaultAPIService) UpdatePublisherAccessExecute(r ApiUpdatePublisherAccessRequest) error {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultAPIService.UpdatePublisherAccess")
	if err != nil {
		return &oapierror.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
	...
	if r.updatePublisherAccessPayload == nil {
		return reportError("updatePublisherAccessPayload is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.updatePublisherAccessPayload
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return err
	}
...
type ApiUpdateSubscriptionSubscriberAccessRequest struct {
	...
	topicId                                   string
	subscriptionId                            string
	updateSubscriptionSubscriberAccessPayload *UpdateSubscriptionSubscriberAccessPayload
}
...
func (r ApiUpdateSubscriptionSubscriberAccessRequest) UpdateSubscriptionSubscriberAccessPayload(updateSubscriptionSubscriberAccessPayload UpdateSubscriptionSubscriberAccessPayload) ApiUpdateSubscriptionSubscriberAccessRequest {
	r.updateSubscriptionSubscriberAccessPayload = &updateSubscriptionSubscriberAccessPayload
	return r
}

func (r ApiUpdateSubscriptionSubscriberAccessRequest) Execute() error {
	return r.ApiService.UpdateSubscriptionSubscriberAccessExecute(r)
}
...
func (a *DefaultAPIService) UpdateSubscriptionSubscriberAccessExecute(r ApiUpdateSubscriptionSubscriberAccessRequest) error {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultAPIService.UpdateSubscriptionSubscriberAccess")
	if err != nil {
		return &oapierror.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
	...
	if r.updateSubscriptionSubscriberAccessPayload == nil {
		return reportError("updateSubscriptionSubscriberAccessPayload is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.updateSubscriptionSubscriberAccessPayload
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return err
	}
