...
// isModel
// Deprecated: Will be removed after 2026-09-30. Move to the packages generated for each available API version instead
type ClusterStatusGetExpirationAttributeType = *ExpirationStatus

// Deprecated: Will be removed after 2026-09-30. Move to the packages generated for each available API version instead
type ClusterStatusGetExpirationArgType = ExpirationStatus

// Deprecated: Will be removed after 2026-09-30. Move to the packages generated for each available API version instead
type ClusterStatusGetExpirationRetType = ExpirationStatus
