...
func (o *ClusterStatus) GetExpiration() ExpirationStatus {
...
// and a boolean to check if the value has been set.
func (o *ClusterStatus) GetExpirationOk() (*ExpirationStatus, bool) {
	if o == nil || IsNil(o.Expiration) {
		return nil, false
	}
...
// SetExpiration gets a reference to the given ExpirationStatus and assigns it to the Expiration field.
func (o *ClusterStatus) SetExpiration(v ExpirationStatus) {
	o.Expiration = &v
}
...
func (o *ClusterStatus) GetIdentity() string {
...
// and a boolean to check if the value has been set.
func (o *ClusterStatus) GetIdentityOk() (*string, bool) {
	if o == nil || IsNil(o.Identity) {
		return nil, false
	}
...
func (o *ClusterStatus) SetIdentity(v string) {
	o.Identity = &v
}
