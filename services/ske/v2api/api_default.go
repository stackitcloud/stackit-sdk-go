...
type DefaultAPI interface {
	...
	*/
	...
	GetIDPKubeconfigExecute(r ApiGetIDPKubeconfigRequest) (*IDPKubeconfig, error)
...
type ApiGetIDPKubeconfigRequest struct {
	ctx         context.Context
	ApiService  DefaultAPI
	projectId   string
	region      string
...
func (r ApiGetIDPKubeconfigRequest) Execute() (*IDPKubeconfig, error) {
	return r.ApiService.GetIDPKubeconfigExecute(r)
}
...
A kubeconfig retrieved using this endpoint does not contain any credentials and instead obtains valid credentials via the STACKIT CLI. Permissions must be granted to the user beforehand using an admin kubeconfig.
	...
	@return ApiGetIDPKubeconfigRequest
*/
func (a *DefaultAPIService) GetIDPKubeconfig(ctx context.Context, projectId string, region string, clusterName string) ApiGetIDPKubeconfigRequest {
	return ApiGetIDPKubeconfigRequest{
		ApiService:  a,
		ctx:         ctx,
		projectId:   projectId,
...
//
//	@return IDPKubeconfig
func (a *DefaultAPIService) GetIDPKubeconfigExecute(r ApiGetIDPKubeconfigRequest) (*IDPKubeconfig, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultAPIService.GetIDPKubeconfig")
	if err != nil {
		return localVarReturnValue, &oapierror.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
