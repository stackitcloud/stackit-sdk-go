...
type DefaultAPI interface {
	...
	*/
	...
	CompleteCredentialsRotationExecute(r ApiCompleteCredentialsRotationRequest) (map[string]interface{}, *http.Response, error)
	...
	*/
	...
	//  @return Kubeconfig
	CreateKubeconfigExecute(r ApiCreateKubeconfigRequest) (*Kubeconfig, *http.Response, error)
	...
	*/
	...
	//  @return Cluster
	CreateOrUpdateClusterExecute(r ApiCreateOrUpdateClusterRequest) (*Cluster, *http.Response, error)
	...
	*/
	...
	//  @return map[string]interface{}
	DeleteClusterExecute(r ApiDeleteClusterRequest) (map[string]interface{}, *http.Response, error)
	...
	*/
	...
	GetLoginKubeconfigExecute(r ApiGetLoginKubeconfigRequest) (*LoginKubeconfig, *http.Response, error)
	...
	*/
	...
	ListProviderOptionsExecute(r ApiListProviderOptionsRequest) (*ProviderOptions, *http.Response, error)
	...
	*/
	...
	//  @return map[string]interface{}
	StartCredentialsRotationExecute(r ApiStartCredentialsRotationRequest) (map[string]interface{}, *http.Response, error)
	...
	*/
	...
	//  @return map[string]interface{}
	TriggerHibernateExecute(r ApiTriggerHibernateRequest) (map[string]interface{}, *http.Response, error)
	...
	*/
	...
	//  @return map[string]interface{}
	TriggerMaintenanceExecute(r ApiTriggerMaintenanceRequest) (map[string]interface{}, *http.Response, error)
	...
	*/
	...
	//  @return map[string]interface{}
	TriggerReconcileExecute(r ApiTriggerReconcileRequest) (map[string]interface{}, *http.Response, error)
	...
	*/
	...
	//  @return map[string]interface{}
	TriggerWakeupExecute(r ApiTriggerWakeupRequest) (map[string]interface{}, *http.Response, error)
}
...
func (r ApiCompleteCredentialsRotationRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
Complete cluster credentials rotation. This is step 2 of a two-step process. Start the rotation using [start-credentials-rotation](#tag/Credentials/operation/SkeService_StartClusterCredentialsRotation).
	...
	@return ApiCompleteCredentialsRotationRequest
*/
func (a *DefaultAPIService) CompleteCredentialsRotation(ctx context.Context, projectId string, region string, clusterName string) ApiCompleteCredentialsRotationRequest {
	return ApiCompleteCredentialsRotationRequest{
		ApiService:  a,
		ctx:         ctx,
		projectId:   projectId,
...
//
//	@return map[string]interface{}
func (a *DefaultAPIService) CompleteCredentialsRotationExecute(r ApiCompleteCredentialsRotationRequest) (map[string]interface{}, *http.Response, error) {
	var (
...
func (r ApiCreateKubeconfigRequest) Execute() (*Kubeconfig, *http.Response, error) {
...
Create a new admin kubeconfig for the cluster. You can specify the expiration (in seconds) in the request body. Its value must be in the range from 600 (10 min) to 15552000 (6 months). Defaults to 3600.
	...
	@return ApiCreateKubeconfigRequest
*/
func (a *DefaultAPIService) CreateKubeconfig(ctx context.Context, projectId string, region string, clusterName string) ApiCreateKubeconfigRequest {
	return ApiCreateKubeconfigRequest{
		ApiService:  a,
		ctx:         ctx,
		projectId:   projectId,
...
//
//	@return Kubeconfig
func (a *DefaultAPIService) CreateKubeconfigExecute(r ApiCreateKubeconfigRequest) (*Kubeconfig, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	if r.createKubeconfigPayload == nil {
		return localVarReturnValue, nil, reportError("createKubeconfigPayload is required and must be specified")
	}
...
func (r ApiCreateOrUpdateClusterRequest) Execute() (*Cluster, *http.Response, error) {
...
Create a new cluster in your project or modify an existing one. To get valid values for certain properties please check the [provider-options](#tag/ProviderOptions/operation/SkeService_GetProviderOptions) endpoint.
	...
	@return ApiCreateOrUpdateClusterRequest
*/
func (a *DefaultAPIService) CreateOrUpdateCluster(ctx context.Context, projectId string, region string, clusterName string) ApiCreateOrUpdateClusterRequest {
	return ApiCreateOrUpdateClusterRequest{
		ApiService:  a,
		ctx:         ctx,
		projectId:   projectId,
...
//
//	@return Cluster
func (a *DefaultAPIService) CreateOrUpdateClusterExecute(r ApiCreateOrUpdateClusterRequest) (*Cluster, *http.Response, error) {
	var (
	...
	if r.createOrUpdateClusterPayload == nil {
		return localVarReturnValue, nil, reportError("createOrUpdateClusterPayload is required and must be specified")
	}
...
func (r ApiDeleteClusterRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
Delete Kubernetes cluster specified by the identifier, belonging to the project specified by `projectId`.
	...
	@return ApiDeleteClusterRequest
*/
func (a *DefaultAPIService) DeleteCluster(ctx context.Context, projectId string, region string, clusterName string) ApiDeleteClusterRequest {
	return ApiDeleteClusterRequest{
		ApiService:  a,
		ctx:         ctx,
		projectId:   projectId,
...
//
//	@return map[string]interface{}
func (a *DefaultAPIService) DeleteClusterExecute(r ApiDeleteClusterRequest) (map[string]interface{}, *http.Response, error) {
	var (
...
Get Kubernetes cluster for the specified identifier, belonging to the project specified by `projectId`.
	...
	@return ApiGetClusterRequest
*/
func (a *DefaultAPIService) GetCluster(ctx context.Context, projectId string, region string, clusterName string) ApiGetClusterRequest {
	return ApiGetClusterRequest{
		ApiService:  a,
		ctx:         ctx,
		projectId:   projectId,
...
func (r ApiGetLoginKubeconfigRequest) Execute() (*LoginKubeconfig, *http.Response, error) {
...
A admin kubeconfig retrieved using this endpoint does not contain any credentials and instead obtains valid credentials via the STACKIT CLI.
	...
	@return ApiGetLoginKubeconfigRequest
*/
func (a *DefaultAPIService) GetLoginKubeconfig(ctx context.Context, projectId string, region string, clusterName string) ApiGetLoginKubeconfigRequest {
	return ApiGetLoginKubeconfigRequest{
		ApiService:  a,
		ctx:         ctx,
		projectId:   projectId,
...
//
//	@return LoginKubeconfig
func (a *DefaultAPIService) GetLoginKubeconfigExecute(r ApiGetLoginKubeconfigRequest) (*LoginKubeconfig, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
Return a list of Kubernetes clusters in the project specified by `projectId`.
	...
	@return ApiListClustersRequest
*/
func (a *DefaultAPIService) ListClusters(ctx context.Context, projectId string, region string) ApiListClustersRequest {
	return ApiListClustersRequest{
		ApiService: a,
		ctx:        ctx,
		projectId:  projectId,
...
//
//	@return ListClustersResponse
func (a *DefaultAPIService) ListClustersExecute(r ApiListClustersRequest) (*ListClustersResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiListProviderOptionsRequest) Execute() (*ProviderOptions, *http.Response, error) {
...
Returns available Kubernetes versions, availability zones, machine types, OS versions and volume types for the cluster nodes.
	...
	@return ApiListProviderOptionsRequest
*/
func (a *DefaultAPIService) ListProviderOptions(ctx context.Context, region string) ApiListProviderOptionsRequest {
	return ApiListProviderOptionsRequest{
		ApiService: a,
		ctx:        ctx,
		region:     region,
...
//
//	@return ProviderOptions
func (a *DefaultAPIService) ListProviderOptionsExecute(r ApiListProviderOptionsRequest) (*ProviderOptions, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	if r.versionState != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "versionState", r.versionState, "form", "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
func (r ApiStartCredentialsRotationRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
Start cluster credentials rotation. This is step 1 of a two-step process. Complete the rotation using [complete-credentials-rotation](#tag/Credentials/operation/SkeService_CompleteClusterCredentialsRotation).
	...
	@return ApiStartCredentialsRotationRequest
*/
func (a *DefaultAPIService) StartCredentialsRotation(ctx context.Context, projectId string, region string, clusterName string) ApiStartCredentialsRotationRequest {
	return ApiStartCredentialsRotationRequest{
		ApiService:  a,
		ctx:         ctx,
		projectId:   projectId,
...
//
//	@return map[string]interface{}
func (a *DefaultAPIService) StartCredentialsRotationExecute(r ApiStartCredentialsRotationRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiTriggerHibernateRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
Trigger immediate hibernation of the cluster. If the cluster is already in hibernation state, this endpoint does nothing.
	...
	@return ApiTriggerHibernateRequest
*/
func (a *DefaultAPIService) TriggerHibernate(ctx context.Context, projectId string, region string, clusterName string) ApiTriggerHibernateRequest {
	return ApiTriggerHibernateRequest{
		ApiService:  a,
		ctx:         ctx,
		projectId:   projectId,
...
//
//	@return map[string]interface{}
func (a *DefaultAPIService) TriggerHibernateExecute(r ApiTriggerHibernateRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiTriggerMaintenanceRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
Trigger immediate maintenance of the cluster. The autoUpdate configuration specified in the Maintenance object of the cluster spec defines what is updated during the immediate maintenance operation.
	...
	@return ApiTriggerMaintenanceRequest
*/
func (a *DefaultAPIService) TriggerMaintenance(ctx context.Context, projectId string, region string, clusterName string) ApiTriggerMaintenanceRequest {
	return ApiTriggerMaintenanceRequest{
		ApiService:  a,
		ctx:         ctx,
		projectId:   projectId,
...
//
//	@return map[string]interface{}
func (a *DefaultAPIService) TriggerMaintenanceExecute(r ApiTriggerMaintenanceRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiTriggerReconcileRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
Trigger immediate reconciliation of the complete cluster without changing the cluster specification.
	...
	@return ApiTriggerReconcileRequest
*/
func (a *DefaultAPIService) TriggerReconcile(ctx context.Context, projectId string, region string, clusterName string) ApiTriggerReconcileRequest {
	return ApiTriggerReconcileRequest{
		ApiService:  a,
		ctx:         ctx,
		projectId:   projectId,
...
//
//	@return map[string]interface{}
func (a *DefaultAPIService) TriggerReconcileExecute(r ApiTriggerReconcileRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiTriggerWakeupRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
Trigger immediate wake up of the cluster. If the cluster is already in running state, this endpoint does nothing.
	...
	@return ApiTriggerWakeupRequest
*/
func (a *DefaultAPIService) TriggerWakeup(ctx context.Context, projectId string, region string, clusterName string) ApiTriggerWakeupRequest {
	return ApiTriggerWakeupRequest{
		ApiService:  a,
		ctx:         ctx,
		projectId:   projectId,
...
//
//	@return map[string]interface{}
func (a *DefaultAPIService) TriggerWakeupExecute(r ApiTriggerWakeupRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
