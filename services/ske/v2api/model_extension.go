...
func (o *Extension) GetObservability() Observability {
...
// and a boolean to check if the value has been set.
func (o *Extension) GetObservabilityOk() (*Observability, bool) {
	if o == nil || IsNil(o.Observability) {
		return nil, false
	}
...
func (o *Extension) SetObservability(v Observability) {
	o.Observability = &v
}
