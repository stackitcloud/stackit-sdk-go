...
func Test_ske_DefaultApiService(t *testing.T) {
	...
	t.Run("Test DefaultApiService GetIDPKubeconfig", func(t *testing.T) {
		_apiUrlPath := "/v2/projects/{projectId}/regions/{region}/clusters/{clusterName}/kubeconfig/idp"
		projectIdValue := "projectId-value"
		_apiUrlPath = strings.Replace(_apiUrlPath, "{"+"projectId"+"}", url.PathEscape(ParameterValueToString(projectIdValue, "projectId")), -1)
		regionValue := "region-value"
		_apiUrlPath = strings.Replace(_apiUrlPath, "{"+"region"+"}", url.PathEscape(ParameterValueToString(regionValue, "region")), -1)
		...
		resp, reqErr := apiClient.GetIDPKubeconfig(context.Background(), projectId, region, clusterName).Execute()
	...
	t.Run("Test DefaultApiService TriggerWakeup", func(t *testing.T) {
		_apiUrlPath := "/v2/projects/{projectId}/regions/{region}/clusters/{clusterName}/wakeup"
		projectIdValue := "projectId-value"
		_apiUrlPath = strings.Replace(_apiUrlPath, "{"+"projectId"+"}", url.PathEscape(ParameterValueToString(projectIdValue, "projectId")), -1)
		regionValue := "region-value"
		_apiUrlPath = strings.Replace(_apiUrlPath, "{"+"region"+"}", url.PathEscape(ParameterValueToString(regionValue, "region")), -1)
		...
		resp, reqErr := apiClient.TriggerWakeup(context.Background(), projectId, region, clusterName).Execute()
