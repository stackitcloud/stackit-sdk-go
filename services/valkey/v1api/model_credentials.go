...
func (o *Credentials) GetLoadBalancedHost() string {
	if o == nil || IsNil(o.LoadBalancedHost) {
		var ret string
		return ret
	}
	return *o.LoadBalancedHost
}
...
func (o *Credentials) GetLoadBalancedHostOk() (*string, bool) {
	...
	return o.LoadBalancedHost, true
}
...
func (o Credentials) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.LoadBalancedHost) {
		toSerialize["load_balanced_host"] = o.LoadBalancedHost
	}
...
func (o *Credentials) UnmarshalJSON(data []byte) (err error) {
	...
	*o = Credentials(varCredentials)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "load_balanced_host")
