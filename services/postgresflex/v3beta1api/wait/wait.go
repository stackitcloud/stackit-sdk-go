...
func DeleteUserWaitHandler(ctx context.Context, a postgresflex.DefaultAPI, projectId, region, instanceId string, userId int32) *wait.AsyncActionHandler[struct{}] {
