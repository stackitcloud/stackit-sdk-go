...
func (o *PostgresDatabaseParameter) HasContext() bool {
	if o != nil && !IsNil(o.Context) && !IsNil(o.Context) {
		return true
	}
...
func (o *PostgresDatabaseParameter) HasDataType() bool {
	if o != nil && !IsNil(o.DataType) && !IsNil(o.DataType) {
		return true
	}
...
func (o *PostgresDatabaseParameter) HasDefaultValue() bool {
	if o != nil && !IsNil(o.DefaultValue) && !IsNil(o.DefaultValue) {
		return true
	}
...
func (o *PostgresDatabaseParameter) HasEdit() bool {
	if o != nil && !IsNil(o.Edit) && !IsNil(o.Edit) {
		return true
	}
...
func (o *PostgresDatabaseParameter) HasMaxValue() bool {
	if o != nil && !IsNil(o.MaxValue) && !IsNil(o.MaxValue) {
		return true
	}
...
func (o *PostgresDatabaseParameter) HasMinValue() bool {
	if o != nil && !IsNil(o.MinValue) && !IsNil(o.MinValue) {
		return true
	}
...
func (o *PostgresDatabaseParameter) HasPendingRestart() bool {
	if o != nil && !IsNil(o.PendingRestart) && !IsNil(o.PendingRestart) {
		return true
	}
...
func (o *PostgresDatabaseParameter) HasResetValue() bool {
	if o != nil && !IsNil(o.ResetValue) && !IsNil(o.ResetValue) {
		return true
	}
...
func (o *PostgresDatabaseParameter) HasUnit() bool {
	if o != nil && !IsNil(o.Unit) && !IsNil(o.Unit) {
		return true
	}
