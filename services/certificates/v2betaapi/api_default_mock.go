...
type DefaultAPIServiceMock struct {
	...
	CreateCertificateExecuteMock *func(r ApiCreateCertificateRequest) (*CreateCertificateResponse, *http.Response, error)
...
func (a DefaultAPIServiceMock) CreateCertificateExecute(r ApiCreateCertificateRequest) (*CreateCertificateResponse, *http.Response, error) {
