...
type Usage struct {
	...
	Items                []CertificateUsageItem `json:"items,omitempty"`
...
func (o *Usage) GetItems() []CertificateUsageItem {
	if o == nil || IsNil(o.Items) {
		var ret []CertificateUsageItem
		return ret
	}
	return o.Items
}
...
// and a boolean to check if the value has been set.
func (o *Usage) GetItemsOk() ([]CertificateUsageItem, bool) {
	if o == nil || IsNil(o.Items) {
		return nil, false
	}
	return o.Items, true
...
func (o *Usage) SetItems(v []CertificateUsageItem) {
	o.Items = v
}
