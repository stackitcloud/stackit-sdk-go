...
const (
	// Deprecated: InstanceStatusActive is deprecated and will be removed after 9th November 2025. Use [redis.INSTANCESTATUS_ACTIVE] instead.
	InstanceStatusActive = "active"
	// Deprecated: InstanceStatusFailed is deprecated and will be removed after 9th November 2025. Use [redis.INSTANCESTATUS_FAILED] instead.
	InstanceStatusFailed = "failed"
	// Deprecated: InstanceStatusStopped is deprecated and will be removed after 9th November 2025. Use [redis.INSTANCESTATUS_STOPPED] instead.
	InstanceStatusStopped = "stopped"
	// Deprecated: InstanceStatusCreating is deprecated and will be removed after 9th November 2025. Use [redis.INSTANCESTATUS_CREATING] instead.
	InstanceStatusCreating = "creating"
	// Deprecated: InstanceStatusDeleting is deprecated and will be removed after 9th November 2025. Use [redis.INSTANCESTATUS_DELETING] instead.
	InstanceStatusDeleting = "deleting"
	// Deprecated: InstanceStatusUpdating is deprecated and will be removed after 9th November 2025. Use [redis.INSTANCESTATUS_UPDATING] instead.
	InstanceStatusUpdating = "updating"

	// Deprecated: InstanceOperationStateInProgress is deprecated and will be removed after 9th November 2025. Use [redis.INSTANCELASTOPERATIONSTATE_IN_PROGRESS] instead.
	InstanceOperationStateInProgress = "in progress"
	// Deprecated: InstanceOperationStateSucceeded is deprecated and will be removed after 9th November 2025. Use [redis.INSTANCELASTOPERATIONSTATE_SUCCEEDED] instead.
	InstanceOperationStateSucceeded = "succeeded"
	// Deprecated: InstanceOperationStateFailed is deprecated and will be removed after 9th November 2025. Use [redis.INSTANCELASTOPERATIONSTATE_FAILED] instead.
	InstanceOperationStateFailed = "failed"
	// Deprecated: InstanceOperationTypeCreate is deprecated and will be removed after 9th November 2025. Use [redis.INSTANCELASTOPERATIONTYPE_CREATE] instead.
	InstanceOperationTypeCreate = "create"
	// Deprecated: InstanceOperationTypeUpdate is deprecated and will be removed after 9th November 2025. Use [redis.INSTANCELASTOPERATIONTYPE_UPDATE] instead.
	InstanceOperationTypeUpdate = "update"
	// Deprecated: InstanceOperationTypeDelete is deprecated and will be removed after 9th November 2025. Use [redis.INSTANCELASTOPERATIONTYPE_DELETE] instead.
