...
type DefaultAPI interface {
	...
	*/
	...
	CreateDistributionExecute(r ApiCreateDistributionRequest) (*CreateDistributionResponse, *http.Response, error)
	...
	*/
	...
	DeleteCustomDomainExecute(r ApiDeleteCustomDomainRequest) (*DeleteCustomDomainResponse, *http.Response, error)
	...
	*/
	...
	DeleteDistributionExecute(r ApiDeleteDistributionRequest) (*DeleteDistributionResponse, *http.Response, error)
	...
	*/
	...
	FindCachePathsExecute(r ApiFindCachePathsRequest) (*FindCachePathsResponse, *http.Response, error)
	...
	*/
	...
	GetCacheInfoExecute(r ApiGetCacheInfoRequest) (*GetCacheInfoResponse, *http.Response, error)
	...
	*/
	...
	GetCustomDomainExecute(r ApiGetCustomDomainRequest) (*GetCustomDomainResponse, *http.Response, error)
	...
	*/
	...
	GetDistributionExecute(r ApiGetDistributionRequest) (*GetDistributionResponse, *http.Response, error)
	...
	*/
	...
	GetLogsExecute(r ApiGetLogsRequest) (*GetLogsResponse, *http.Response, error)
	...
	*/
	...
	GetLogsSearchFiltersExecute(r ApiGetLogsSearchFiltersRequest) (*GetLogsSearchFiltersResponse, *http.Response, error)
	...
	*/
	...
	GetStatisticsExecute(r ApiGetStatisticsRequest) (*GetStatisticsResponse, *http.Response, error)
	...
	*/
	...
	ListDistributionsExecute(r ApiListDistributionsRequest) (*ListDistributionsResponse, *http.Response, error)
	...
	*/
	...
	ListWafCollectionsExecute(r ApiListWafCollectionsRequest) (*ListWafCollectionsResponse, *http.Response, error)
	...
	*/
	...
	PatchDistributionExecute(r ApiPatchDistributionRequest) (*PatchDistributionResponse, *http.Response, error)
	...
	*/
	...
	PurgeCacheExecute(r ApiPurgeCacheRequest) (map[string]interface{}, *http.Response, error)
	...
	*/
	...
	PutCustomDomainExecute(r ApiPutCustomDomainRequest) (*PutCustomDomainResponse, *http.Response, error)
}
...
func (r ApiCreateDistributionRequest) Execute() (*CreateDistributionResponse, *http.Response, error) {
...
//
//	@return CreateDistributionResponse
func (a *DefaultAPIService) CreateDistributionExecute(r ApiCreateDistributionRequest) (*CreateDistributionResponse, *http.Response, error) {
	var (
	...
	if r.createDistributionPayload == nil {
		return localVarReturnValue, nil, reportError("createDistributionPayload is required and must be specified")
	}
...
func (r ApiDeleteCustomDomainRequest) Execute() (*DeleteCustomDomainResponse, *http.Response, error) {
...
//
//	@return DeleteCustomDomainResponse
func (a *DefaultAPIService) DeleteCustomDomainExecute(r ApiDeleteCustomDomainRequest) (*DeleteCustomDomainResponse, *http.Response, error) {
	var (
	...
	if strlen(r.domain) > 72 {
		return localVarReturnValue, nil, reportError("domain must have less than 72 elements")
	}
...
func (r ApiDeleteDistributionRequest) Execute() (*DeleteDistributionResponse, *http.Response, error) {
...
//
//	@return DeleteDistributionResponse
func (a *DefaultAPIService) DeleteDistributionExecute(r ApiDeleteDistributionRequest) (*DeleteDistributionResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodDelete
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiFindCachePathsRequest) Execute() (*FindCachePathsResponse, *http.Response, error) {
...
//
//	@return FindCachePathsResponse
func (a *DefaultAPIService) FindCachePathsExecute(r ApiFindCachePathsRequest) (*FindCachePathsResponse, *http.Response, error) {
	var (
...
func (r ApiGetCacheInfoRequest) Execute() (*GetCacheInfoResponse, *http.Response, error) {
...
//
//	@return GetCacheInfoResponse
func (a *DefaultAPIService) GetCacheInfoExecute(r ApiGetCacheInfoRequest) (*GetCacheInfoResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiGetCustomDomainRequest) Execute() (*GetCustomDomainResponse, *http.Response, error) {
...
//
//	@return GetCustomDomainResponse
func (a *DefaultAPIService) GetCustomDomainExecute(r ApiGetCustomDomainRequest) (*GetCustomDomainResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiGetDistributionRequest) Execute() (*GetDistributionResponse, *http.Response, error) {
...
//
//	@return GetDistributionResponse
func (a *DefaultAPIService) GetDistributionExecute(r ApiGetDistributionRequest) (*GetDistributionResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
//
//	@return GetLogsResponse
func (a *DefaultAPIService) GetLogsExecute(r ApiGetLogsRequest) (*GetLogsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiGetLogsSearchFiltersRequest) Execute() (*GetLogsSearchFiltersResponse, *http.Response, error) {
...
//
//	@return GetLogsSearchFiltersResponse
func (a *DefaultAPIService) GetLogsSearchFiltersExecute(r ApiGetLogsSearchFiltersRequest) (*GetLogsSearchFiltersResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiListDistributionsRequest) Execute() (*ListDistributionsResponse, *http.Response, error) {
...
//
//	@return ListDistributionsResponse
func (a *DefaultAPIService) ListDistributionsExecute(r ApiListDistributionsRequest) (*ListDistributionsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiListWafCollectionsRequest) Execute() (*ListWafCollectionsResponse, *http.Response, error) {
...
//
//	@return ListWafCollectionsResponse
func (a *DefaultAPIService) ListWafCollectionsExecute(r ApiListWafCollectionsRequest) (*ListWafCollectionsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiPatchDistributionRequest) Execute() (*PatchDistributionResponse, *http.Response, error) {
...
//
//	@return PatchDistributionResponse
func (a *DefaultAPIService) PatchDistributionExecute(r ApiPatchDistributionRequest) (*PatchDistributionResponse, *http.Response, error) {
	var (
...
func (r ApiPurgeCacheRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
//
//	@return map[string]interface{}
func (a *DefaultAPIService) PurgeCacheExecute(r ApiPurgeCacheRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiPutCustomDomainRequest) Execute() (*PutCustomDomainResponse, *http.Response, error) {
...
//
//	@return PutCustomDomainResponse
func (a *DefaultAPIService) PutCustomDomainExecute(r ApiPutCustomDomainRequest) (*PutCustomDomainResponse, *http.Response, error) {
	var (
