...
func (o *ConfigPatch) GetRedirects() RedirectConfig {
	if o == nil || IsNil(o.Redirects) {
		var ret RedirectConfig
		return ret
	}
	return *o.Redirects
}
...
// and a boolean to check if the value has been set.
func (o *ConfigPatch) GetRedirectsOk() (*RedirectConfig, bool) {
	if o == nil || IsNil(o.Redirects) {
		return nil, false
	}
...
func (o *ConfigPatch) SetRedirects(v RedirectConfig) {
	o.Redirects = &v
}
