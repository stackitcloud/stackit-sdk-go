...
func (o *CreateDistributionPayload) GetBackend() CreateDistributionPayloadBackend {
	if o == nil {
		var ret CreateDistributionPayloadBackend
		return ret
	}
...
func (o *CreateDistributionPayload) GetLabels() map[string]string {
...
// and a boolean to check if the value has been set.
func (o *CreateDistributionPayload) GetLabelsOk() (*map[string]string, bool) {
	if o == nil || IsNil(o.Labels) {
		return nil, false
	}
...
func (o *CreateDistributionPayload) SetLabels(v map[string]string) {
	o.Labels = &v
}
...
func (o *CreateDistributionPayload) GetRedirects() RedirectConfig {
...
// and a boolean to check if the value has been set.
func (o *CreateDistributionPayload) GetRedirectsOk() (*RedirectConfig, bool) {
	if o == nil || IsNil(o.Redirects) {
		return nil, false
	}
...
func (o *CreateDistributionPayload) SetRedirects(v RedirectConfig) {
	o.Redirects = &v
}
