...
type DefaultAPIServiceMock struct {
	...
	CreateDistributionExecuteMock *func(r ApiCreateDistributionRequest) (*CreateDistributionResponse, *http.Response, error)
	...
	DeleteCustomDomainExecuteMock *func(r ApiDeleteCustomDomainRequest) (*DeleteCustomDomainResponse, *http.Response, error)
	...
	DeleteDistributionExecuteMock *func(r ApiDeleteDistributionRequest) (*DeleteDistributionResponse, *http.Response, error)
	// FindCachePathsExecuteMock can be populated to implement the behavior of the FindCachePathsExecute function of this mock
	FindCachePathsExecuteMock *func(r ApiFindCachePathsRequest) (*FindCachePathsResponse, *http.Response, error)
	// GetCacheInfoExecuteMock can be populated to implement the behavior of the GetCacheInfoExecute function of this mock
	GetCacheInfoExecuteMock *func(r ApiGetCacheInfoRequest) (*GetCacheInfoResponse, *http.Response, error)
	...
	GetCustomDomainExecuteMock *func(r ApiGetCustomDomainRequest) (*GetCustomDomainResponse, *http.Response, error)
	...
	GetDistributionExecuteMock *func(r ApiGetDistributionRequest) (*GetDistributionResponse, *http.Response, error)
	// GetLogsExecuteMock can be populated to implement the behavior of the GetLogsExecute function of this mock
	GetLogsExecuteMock *func(r ApiGetLogsRequest) (*GetLogsResponse, *http.Response, error)
	...
	GetLogsSearchFiltersExecuteMock *func(r ApiGetLogsSearchFiltersRequest) (*GetLogsSearchFiltersResponse, *http.Response, error)
	// GetStatisticsExecuteMock can be populated to implement the behavior of the GetStatisticsExecute function of this mock
	GetStatisticsExecuteMock *func(r ApiGetStatisticsRequest) (*GetStatisticsResponse, *http.Response, error)
	...
	ListDistributionsExecuteMock *func(r ApiListDistributionsRequest) (*ListDistributionsResponse, *http.Response, error)
	...
	ListWAFCollectionsExecuteMock *func(r ApiListWAFCollectionsRequest) (*ListWAFCollectionsResponse, *http.Response, error)
	...
	PatchDistributionExecuteMock *func(r ApiPatchDistributionRequest) (*PatchDistributionResponse, *http.Response, error)
	// PurgeCacheExecuteMock can be populated to implement the behavior of the PurgeCacheExecute function of this mock
	PurgeCacheExecuteMock *func(r ApiPurgeCacheRequest) (map[string]interface{}, *http.Response, error)
	...
	PutCustomDomainExecuteMock *func(r ApiPutCustomDomainRequest) (*PutCustomDomainResponse, *http.Response, error)
}
...
func (a DefaultAPIServiceMock) CreateDistributionExecute(r ApiCreateDistributionRequest) (*CreateDistributionResponse, *http.Response, error) {
...
func (a DefaultAPIServiceMock) DeleteCustomDomainExecute(r ApiDeleteCustomDomainRequest) (*DeleteCustomDomainResponse, *http.Response, error) {
...
func (a DefaultAPIServiceMock) DeleteDistributionExecute(r ApiDeleteDistributionRequest) (*DeleteDistributionResponse, *http.Response, error) {
...
func (a DefaultAPIServiceMock) FindCachePathsExecute(r ApiFindCachePathsRequest) (*FindCachePathsResponse, *http.Response, error) {
...
func (a DefaultAPIServiceMock) GetCacheInfoExecute(r ApiGetCacheInfoRequest) (*GetCacheInfoResponse, *http.Response, error) {
...
func (a DefaultAPIServiceMock) GetCustomDomainExecute(r ApiGetCustomDomainRequest) (*GetCustomDomainResponse, *http.Response, error) {
...
func (a DefaultAPIServiceMock) GetDistributionExecute(r ApiGetDistributionRequest) (*GetDistributionResponse, *http.Response, error) {
...
func (a DefaultAPIServiceMock) GetLogsExecute(r ApiGetLogsRequest) (*GetLogsResponse, *http.Response, error) {
...
func (a DefaultAPIServiceMock) GetLogsSearchFiltersExecute(r ApiGetLogsSearchFiltersRequest) (*GetLogsSearchFiltersResponse, *http.Response, error) {
...
func (a DefaultAPIServiceMock) GetStatisticsExecute(r ApiGetStatisticsRequest) (*GetStatisticsResponse, *http.Response, error) {
...
func (a DefaultAPIServiceMock) ListDistributionsExecute(r ApiListDistributionsRequest) (*ListDistributionsResponse, *http.Response, error) {
...
func (a DefaultAPIServiceMock) ListWAFCollectionsExecute(r ApiListWAFCollectionsRequest) (*ListWAFCollectionsResponse, *http.Response, error) {
...
func (a DefaultAPIServiceMock) PatchDistributionExecute(r ApiPatchDistributionRequest) (*PatchDistributionResponse, *http.Response, error) {
...
func (a DefaultAPIServiceMock) PurgeCacheExecute(r ApiPurgeCacheRequest) (map[string]interface{}, *http.Response, error) {
...
func (a DefaultAPIServiceMock) PutCustomDomainExecute(r ApiPutCustomDomainRequest) (*PutCustomDomainResponse, *http.Response, error) {
