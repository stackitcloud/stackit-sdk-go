...
type CreateServiceAccountKeyResponse struct {
	...
	Id           string                                      `json:"id"`
	KeyAlgorithm CreateServiceAccountKeyResponseKeyAlgorithm `json:"keyAlgorithm"`
	KeyOrigin    CreateServiceAccountKeyResponseKeyOrigin    `json:"keyOrigin"`
	KeyType      CreateServiceAccountKeyResponseKeyType      `json:"keyType"`
...
func NewCreateServiceAccountKeyResponse(active bool, createdAt time.Time, credentials CreateServiceAccountKeyResponseCredentials, id string, keyAlgorithm CreateServiceAccountKeyResponseKeyAlgorithm, keyOrigin CreateServiceAccountKeyResponseKeyOrigin, keyType CreateServiceAccountKeyResponseKeyType, publicKey string) *CreateServiceAccountKeyResponse {
...
func (o *CreateServiceAccountKeyResponse) GetKeyAlgorithm() CreateServiceAccountKeyResponseKeyAlgorithm {
	if o == nil {
		var ret CreateServiceAccountKeyResponseKeyAlgorithm
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CreateServiceAccountKeyResponse) GetKeyAlgorithmOk() (*CreateServiceAccountKeyResponseKeyAlgorithm, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CreateServiceAccountKeyResponse) SetKeyAlgorithm(v CreateServiceAccountKeyResponseKeyAlgorithm) {
	o.KeyAlgorithm = v
}

// GetKeyOrigin returns the KeyOrigin field value
func (o *CreateServiceAccountKeyResponse) GetKeyOrigin() CreateServiceAccountKeyResponseKeyOrigin {
	if o == nil {
		var ret CreateServiceAccountKeyResponseKeyOrigin
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CreateServiceAccountKeyResponse) GetKeyOriginOk() (*CreateServiceAccountKeyResponseKeyOrigin, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CreateServiceAccountKeyResponse) SetKeyOrigin(v CreateServiceAccountKeyResponseKeyOrigin) {
	o.KeyOrigin = v
}

// GetKeyType returns the KeyType field value
func (o *CreateServiceAccountKeyResponse) GetKeyType() CreateServiceAccountKeyResponseKeyType {
	if o == nil {
		var ret CreateServiceAccountKeyResponseKeyType
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CreateServiceAccountKeyResponse) GetKeyTypeOk() (*CreateServiceAccountKeyResponseKeyType, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CreateServiceAccountKeyResponse) SetKeyType(v CreateServiceAccountKeyResponseKeyType) {
	o.KeyType = v
}
...
func (o *CreateServiceAccountKeyResponse) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varCreateServiceAccountKeyResponse)
