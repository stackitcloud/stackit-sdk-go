...
type DefaultAPI interface {
	...
	*/
	...
	CreateBackupExecute(r ApiCreateBackupRequest) ([]CreateBackupResponseItem, *http.Response, error)
	...
	*/
	...
	CreateCredentialsExecute(r ApiCreateCredentialsRequest) (*CredentialsResponse, *http.Response, error)
	...
	*/
	...
	//  @return *os.File
	DownloadBackupExecute(r ApiDownloadBackupRequest) (*os.File, *http.Response, error)
	...
	*/
	...
	//  @return CredentialsResponse
	GetCredentialsExecute(r ApiGetCredentialsRequest) (*CredentialsResponse, *http.Response, error)
	...
	*/
	...
	GetMetricsExecute(r ApiGetMetricsRequest) (*GetMetricsResponse, *http.Response, error)
	...
	*/
	...
	ListOfferingsExecute(r ApiListOfferingsRequest) (*ListOfferingsResponse, *http.Response, error)
	...
	*/
	...
	ListRestoresExecute(r ApiListRestoresRequest) (*ListRestoresResponse, *http.Response, error)
	...
	*/
	...
	PartialUpdateInstanceExecute(r ApiPartialUpdateInstanceRequest) (*http.Response, error)
	...
	*/
	...
	//  @return CreateInstanceResponse
	TriggerRecreateExecute(r ApiTriggerRecreateRequest) (*CreateInstanceResponse, *http.Response, error)
	...
	*/
	...
	//  @return CreateInstanceResponse
	TriggerRestartExecute(r ApiTriggerRestartRequest) (*CreateInstanceResponse, *http.Response, error)
	...
	*/
	...
	TriggerRestoreExecute(r ApiTriggerRestoreRequest) (*TriggerRestoreResponse, *http.Response, error)
	...
	*/
	...
	UpdateBackupsConfigExecute(r ApiUpdateBackupsConfigRequest) (*UpdateBackupsConfigResponse, *http.Response, error)
}
...
func (r ApiCreateBackupRequest) Execute() ([]CreateBackupResponseItem, *http.Response, error) {
...
//
//	@return []CreateBackupResponseItem
func (a *DefaultAPIService) CreateBackupExecute(r ApiCreateBackupRequest) ([]CreateBackupResponseItem, *http.Response, error) {
	var (
...
func (r ApiCreateCredentialsRequest) Execute() (*CredentialsResponse, *http.Response, error) {
...
//
//	@return CredentialsResponse
func (a *DefaultAPIService) CreateCredentialsExecute(r ApiCreateCredentialsRequest) (*CredentialsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
...
// Execute executes the request
func (a *DefaultAPIService) DeleteCredentialsExecute(r ApiDeleteCredentialsRequest) (*http.Response, error) {
	var (
...
func (r ApiDownloadBackupRequest) Execute() (*os.File, *http.Response, error) {
...
//
//	@return *os.File
func (a *DefaultAPIService) DownloadBackupExecute(r ApiDownloadBackupRequest) (*os.File, *http.Response, error) {
	var (
...
func (r ApiGetCredentialsRequest) Execute() (*CredentialsResponse, *http.Response, error) {
...
//
//	@return CredentialsResponse
func (a *DefaultAPIService) GetCredentialsExecute(r ApiGetCredentialsRequest) (*CredentialsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiGetMetricsRequest) Execute() (*GetMetricsResponse, *http.Response, error) {
...
//
//	@return GetMetricsResponse
func (a *DefaultAPIService) GetMetricsExecute(r ApiGetMetricsRequest) (*GetMetricsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiListOfferingsRequest) Execute() (*ListOfferingsResponse, *http.Response, error) {
...
//
//	@return ListOfferingsResponse
func (a *DefaultAPIService) ListOfferingsExecute(r ApiListOfferingsRequest) (*ListOfferingsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiListRestoresRequest) Execute() (*ListRestoresResponse, *http.Response, error) {
...
//
//	@return ListRestoresResponse
func (a *DefaultAPIService) ListRestoresExecute(r ApiListRestoresRequest) (*ListRestoresResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiPartialUpdateInstanceRequest) Execute() (*http.Response, error) {
...
// Execute executes the request
func (a *DefaultAPIService) PartialUpdateInstanceExecute(r ApiPartialUpdateInstanceRequest) (*http.Response, error) {
	var (
	...
	if r.partialUpdateInstancePayload == nil {
		return nil, reportError("partialUpdateInstancePayload is required and must be specified")
	}
...
func (r ApiTriggerRecreateRequest) Execute() (*CreateInstanceResponse, *http.Response, error) {
...
//
//	@return CreateInstanceResponse
func (a *DefaultAPIService) TriggerRecreateExecute(r ApiTriggerRecreateRequest) (*CreateInstanceResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPatch
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiTriggerRestartRequest) Execute() (*CreateInstanceResponse, *http.Response, error) {
...
//
//	@return CreateInstanceResponse
func (a *DefaultAPIService) TriggerRestartExecute(r ApiTriggerRestartRequest) (*CreateInstanceResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPatch
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiTriggerRestoreRequest) Execute() (*TriggerRestoreResponse, *http.Response, error) {
...
//
//	@return TriggerRestoreResponse
func (a *DefaultAPIService) TriggerRestoreExecute(r ApiTriggerRestoreRequest) (*TriggerRestoreResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiUpdateBackupsConfigRequest) Execute() (*UpdateBackupsConfigResponse, *http.Response, error) {
...
//
//	@return UpdateBackupsConfigResponse
func (a *DefaultAPIService) UpdateBackupsConfigExecute(r ApiUpdateBackupsConfigRequest) (*UpdateBackupsConfigResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPatch
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	if r.updateBackupsConfigPayload == nil {
		return localVarReturnValue, nil, reportError("updateBackupsConfigPayload is required and must be specified")
	}
