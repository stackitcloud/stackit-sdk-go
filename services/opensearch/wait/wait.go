...
const (
	// Deprecated: InstanceStatusActive is deprecated and will be removed after 12th November 2025. Use [opensearch.INSTANCESTATUS_ACTIVE] instead.
	InstanceStatusActive = "active"
	// Deprecated: InstanceStatusFailed is deprecated and will be removed after 12th November 2025. Use [opensearch.INSTANCESTATUS_FAILED] instead.
	InstanceStatusFailed = "failed"
	// Deprecated: InstanceStatusStopped is deprecated and will be removed after 12th November 2025. Use [opensearch.INSTANCESTATUS_STOPPED] instead.
	InstanceStatusStopped = "stopped"
	// Deprecated: InstanceStatusCreating is deprecated and will be removed after 12th November 2025. Use [opensearch.INSTANCESTATUS_CREATING] instead.
	InstanceStatusCreating = "creating"
	// Deprecated: InstanceStatusDeleting is deprecated and will be removed after 12th November 2025. Use [opensearch.INSTANCESTATUS_DELETING] instead.
	InstanceStatusDeleting = "deleting"
	// Deprecated: InstanceStatusUpdating is deprecated and will be removed after 12th November 2025. Use [opensearch.INSTANCESTATUS_UPDATING] instead.
	InstanceStatusUpdating = "updating"

	// Deprecated: InstanceOperationStateInProgress is deprecated and will be removed after 12th November 2025. Use [opensearch.INSTANCELASTOPERATIONSTATE_IN_PROGRESS] instead.
	InstanceOperationStateInProgress = "in progress"
	// Deprecated: InstanceOperationStateSucceeded is deprecated and will be removed after 12th November 2025. Use [opensearch.INSTANCELASTOPERATIONSTATE_SUCCEEDED] instead.
	InstanceOperationStateSucceeded = "succeeded"
	// Deprecated: InstanceOperationStateFailed is deprecated and will be removed after 12th November 2025. Use [opensearch.INSTANCELASTOPERATIONSTATE_FAILED] instead.
	InstanceOperationStateFailed = "failed"
	// Deprecated: InstanceOperationTypeCreate is deprecated and will be removed after 12th November 2025. Use [opensearch.INSTANCELASTOPERATIONTYPE_CREATE] instead.
	InstanceOperationTypeCreate = "create"
	// Deprecated: InstanceOperationTypeUpdate is deprecated and will be removed after 12th November 2025. Use [opensearch.INSTANCELASTOPERATIONTYPE_UPDATE] instead.
	InstanceOperationTypeUpdate = "update"
	// Deprecated: InstanceOperationTypeDelete is deprecated and will be removed after 12th November 2025. Use [opensearch.INSTANCELASTOPERATIONTYPE_DELETE] instead.
	InstanceOperationTypeDelete = "delete"

	// Deprecated: InstanceStateSuccess is deprecated and will be removed after 2nd October 2025. Use [opensearch.INSTANCELASTOPERATIONSTATE_SUCCEEDED] instead.
	InstanceStateSuccess = "succeeded"
	// Deprecated: InstanceStateFailed is deprecated and will be removed after 2nd October 2025. Use [opensearch.INSTANCELASTOPERATIONSTATE_FAILED] instead.
	InstanceStateFailed = "failed"
	// Deprecated: InstanceTypeCreate is deprecated and will be removed after 2nd October 2025. Use [opensearch.INSTANCELASTOPERATIONTYPE_CREATE] instead.
	InstanceTypeCreate = "create"
	// Deprecated: InstanceTypeUpdate is deprecated and will be removed after 2nd October 2025. Use [opensearch.INSTANCELASTOPERATIONTYPE_UPDATE] instead.
	InstanceTypeUpdate = "update"
	// Deprecated: InstanceTypeDelete is deprecated and will be removed after 2nd October 2025. Use [opensearch.INSTANCELASTOPERATIONTYPE_DELETE] instead.
...
func CreateInstanceWaitHandler(ctx context.Context, a APIClientInstanceInterface, projectId, instanceId string) *wait.AsyncActionHandler[opensearch.Instance] {
	handler := wait.New(func() (waitFinished bool, response *opensearch.Instance, err error) {
		...
		switch *s.Status {
		case opensearch.INSTANCESTATUS_ACTIVE:
			return true, s, nil
		case opensearch.INSTANCESTATUS_FAILED:
