...
// checks if the PartialUpdateVPCPayload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PartialUpdateVPCPayload{}
...
type _PartialUpdateVPCPayload PartialUpdateVPCPayload

// NewPartialUpdateVPCPayload instantiates a new PartialUpdateVPCPayload object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPartialUpdateVPCPayload() *PartialUpdateVPCPayload {
	this := PartialUpdateVPCPayload{}
	return &this
}

// NewPartialUpdateVPCPayloadWithDefaults instantiates a new PartialUpdateVPCPayload object
...
func (o *PartialUpdateVPCPayload) UnmarshalJSON(data []byte) (err error) {
	varPartialUpdateVPCPayload := _PartialUpdateVPCPayload{}

	err = json.Unmarshal(data, &varPartialUpdateVPCPayload)

	if err != nil {
		return err
	}

	*o = PartialUpdateVPCPayload(varPartialUpdateVPCPayload)
...
func NewNullablePartialUpdateVPCPayload(val *PartialUpdateVPCPayload) *NullablePartialUpdateVPCPayload {
	return &NullablePartialUpdateVPCPayload{value: val, isSet: true}
}
