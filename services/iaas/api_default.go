...
type ApiV1beta1CreateSnapshotRequest struct {
	ctx                          context.Context
	apiService                   *DefaultApiService
	projectId                    string
	v1beta1CreateSnapshotPayload *V1beta1CreateSnapshotPayload
}

// Request a snapshot creation.

func (r ApiV1beta1CreateSnapshotRequest) V1beta1CreateSnapshotPayload(v1beta1CreateSnapshotPayload V1beta1CreateSnapshotPayload) ApiV1beta1CreateSnapshotRequest {
	r.v1beta1CreateSnapshotPayload = &v1beta1CreateSnapshotPayload
	return r
}

func (r ApiV1beta1CreateSnapshotRequest) Execute() (*Snapshot, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	a := r.apiService
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.V1beta1CreateSnapshot")
	if err != nil {
		return localVarReturnValue, &oapierror.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
	...
	if r.v1beta1CreateSnapshotPayload == nil {
		return localVarReturnValue, fmt.Errorf("v1beta1CreateSnapshotPayload is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.v1beta1CreateSnapshotPayload
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, err
	}
...
/*
V1beta1CreateSnapshot: Create new Snapshot.

Create a new Snapshot from a Volume in a project.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param projectId The identifier (ID) of a STACKIT Project.
	@return ApiV1beta1CreateSnapshotRequest
*/
func (a *APIClient) V1beta1CreateSnapshot(ctx context.Context, projectId string) ApiV1beta1CreateSnapshotRequest {
	return ApiV1beta1CreateSnapshotRequest{
		apiService: a.defaultApi,
		ctx:        ctx,
		projectId:  projectId,
...
func (a *APIClient) V1beta1CreateSnapshotExecute(ctx context.Context, projectId string) (*Snapshot, error) {
	r := ApiV1beta1CreateSnapshotRequest{
		apiService: a.defaultApi,
		ctx:        ctx,
		projectId:  projectId,
	}
...
type ApiV1beta1DeleteSnapshotRequest struct {
	ctx        context.Context
	apiService *DefaultApiService
	projectId  string
	snapshotId string
...
func (r ApiV1beta1DeleteSnapshotRequest) Execute() error {
	var (
		localVarHTTPMethod = http.MethodDelete
		localVarPostBody   interface{}
		formFiles          []formFile
	...
	a := r.apiService
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.V1beta1DeleteSnapshot")
	if err != nil {
		return &oapierror.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
/*
V1beta1DeleteSnapshot: Delete a snapshot.
...
*/
func (a *APIClient) V1beta1DeleteSnapshot(ctx context.Context, projectId string, snapshotId string) ApiV1beta1DeleteSnapshotRequest {
	return ApiV1beta1DeleteSnapshotRequest{
		apiService: a.defaultApi,
		ctx:        ctx,
		projectId:  projectId,
...
func (a *APIClient) V1beta1DeleteSnapshotExecute(ctx context.Context, projectId string, snapshotId string) error {
	r := ApiV1beta1DeleteSnapshotRequest{
		apiService: a.defaultApi,
		ctx:        ctx,
		projectId:  projectId,
		snapshotId: snapshotId,
...
type ApiV1beta1GetSnapshotRequest struct {
	ctx        context.Context
	apiService *DefaultApiService
	projectId  string
	snapshotId string
...
func (r ApiV1beta1GetSnapshotRequest) Execute() (*Snapshot, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	a := r.apiService
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.V1beta1GetSnapshot")
	if err != nil {
		return localVarReturnValue, &oapierror.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
/*
V1beta1GetSnapshot: Get details about a snapshot.
...
Get details about a block device snapshot.
	...
	@param projectId The identifier (ID) of a STACKIT Project.
	@param snapshotId The identifier (ID) of a STACKIT Snapshot.
	@return ApiV1beta1GetSnapshotRequest
*/
func (a *APIClient) V1beta1GetSnapshot(ctx context.Context, projectId string, snapshotId string) ApiV1beta1GetSnapshotRequest {
	return ApiV1beta1GetSnapshotRequest{
		apiService: a.defaultApi,
		ctx:        ctx,
		projectId:  projectId,
...
func (a *APIClient) V1beta1GetSnapshotExecute(ctx context.Context, projectId string, snapshotId string) (*Snapshot, error) {
	r := ApiV1beta1GetSnapshotRequest{
		apiService: a.defaultApi,
		ctx:        ctx,
		projectId:  projectId,
		snapshotId: snapshotId,
...
type ApiV1beta1ListSnapshotsInProjectRequest struct {
	ctx           context.Context
	apiService    *DefaultApiService
	projectId     string
	labelSelector *string
...
func (r ApiV1beta1ListSnapshotsInProjectRequest) LabelSelector(labelSelector string) ApiV1beta1ListSnapshotsInProjectRequest {
	r.labelSelector = &labelSelector
	return r
}

func (r ApiV1beta1ListSnapshotsInProjectRequest) Execute() (*SnapshotListResponse, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	a := r.apiService
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.V1beta1ListSnapshotsInProject")
	if err != nil {
		return localVarReturnValue, &oapierror.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
/*
V1beta1ListSnapshotsInProject: List all snapshots inside a project.

Get a list of all snapshots inside a project.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param projectId The identifier (ID) of a STACKIT Project.
	@return ApiV1beta1ListSnapshotsInProjectRequest
*/
func (a *APIClient) V1beta1ListSnapshotsInProject(ctx context.Context, projectId string) ApiV1beta1ListSnapshotsInProjectRequest {
	return ApiV1beta1ListSnapshotsInProjectRequest{
		apiService: a.defaultApi,
		ctx:        ctx,
		projectId:  projectId,
...
func (a *APIClient) V1beta1ListSnapshotsInProjectExecute(ctx context.Context, projectId string) (*SnapshotListResponse, error) {
	r := ApiV1beta1ListSnapshotsInProjectRequest{
		apiService: a.defaultApi,
		ctx:        ctx,
		projectId:  projectId,
	}
...
type ApiV1beta1UpdateBackupRequest struct {
	ctx                        context.Context
	apiService                 *DefaultApiService
	projectId                  string
	backupId                   string
	v1beta1UpdateBackupPayload *V1beta1UpdateBackupPayload
}

// Request an update of a backup.

func (r ApiV1beta1UpdateBackupRequest) V1beta1UpdateBackupPayload(v1beta1UpdateBackupPayload V1beta1UpdateBackupPayload) ApiV1beta1UpdateBackupRequest {
	r.v1beta1UpdateBackupPayload = &v1beta1UpdateBackupPayload
	return r
}

func (r ApiV1beta1UpdateBackupRequest) Execute() (*Backup, error) {
	var (
		localVarHTTPMethod  = http.MethodPatch
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	a := r.apiService
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.V1beta1UpdateBackup")
	if err != nil {
		return localVarReturnValue, &oapierror.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
	...
	if r.v1beta1UpdateBackupPayload == nil {
		return localVarReturnValue, fmt.Errorf("v1beta1UpdateBackupPayload is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.v1beta1UpdateBackupPayload
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, err
	}
...
/*
V1beta1UpdateBackup: Update information of a backup.
...
Update name or labels of the backup.
	...
	@param projectId The identifier (ID) of a STACKIT Project.
	@param backupId The identifier (ID) of a STACKIT Backup.
	@return ApiV1beta1UpdateBackupRequest
*/
func (a *APIClient) V1beta1UpdateBackup(ctx context.Context, projectId string, backupId string) ApiV1beta1UpdateBackupRequest {
	return ApiV1beta1UpdateBackupRequest{
		apiService: a.defaultApi,
		ctx:        ctx,
		projectId:  projectId,
...
func (a *APIClient) V1beta1UpdateBackupExecute(ctx context.Context, projectId string, backupId string) (*Backup, error) {
	r := ApiV1beta1UpdateBackupRequest{
		apiService: a.defaultApi,
		ctx:        ctx,
		projectId:  projectId,
		backupId:   backupId,
...
type ApiV1beta1UpdateSnapshotRequest struct {
	ctx                          context.Context
	apiService                   *DefaultApiService
	projectId                    string
	snapshotId                   string
	v1beta1UpdateSnapshotPayload *V1beta1UpdateSnapshotPayload
}

// Request an update of a snapshot.

func (r ApiV1beta1UpdateSnapshotRequest) V1beta1UpdateSnapshotPayload(v1beta1UpdateSnapshotPayload V1beta1UpdateSnapshotPayload) ApiV1beta1UpdateSnapshotRequest {
	r.v1beta1UpdateSnapshotPayload = &v1beta1UpdateSnapshotPayload
	return r
}

func (r ApiV1beta1UpdateSnapshotRequest) Execute() (*Snapshot, error) {
	var (
		localVarHTTPMethod  = http.MethodPatch
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	a := r.apiService
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.V1beta1UpdateSnapshot")
	if err != nil {
		return localVarReturnValue, &oapierror.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
	...
	if r.v1beta1UpdateSnapshotPayload == nil {
		return localVarReturnValue, fmt.Errorf("v1beta1UpdateSnapshotPayload is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.v1beta1UpdateSnapshotPayload
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, err
	}
...
/*
V1beta1UpdateSnapshot: Update information of the snapshot.
...
Update information like name or labels of the snapshot.
	...
	@param projectId The identifier (ID) of a STACKIT Project.
	@param snapshotId The identifier (ID) of a STACKIT Snapshot.
	@return ApiV1beta1UpdateSnapshotRequest
*/
func (a *APIClient) V1beta1UpdateSnapshot(ctx context.Context, projectId string, snapshotId string) ApiV1beta1UpdateSnapshotRequest {
	return ApiV1beta1UpdateSnapshotRequest{
		apiService: a.defaultApi,
		ctx:        ctx,
		projectId:  projectId,
...
func (a *APIClient) V1beta1UpdateSnapshotExecute(ctx context.Context, projectId string, snapshotId string) (*Snapshot, error) {
	r := ApiV1beta1UpdateSnapshotRequest{
		apiService: a.defaultApi,
		ctx:        ctx,
		projectId:  projectId,
		snapshotId: snapshotId,
