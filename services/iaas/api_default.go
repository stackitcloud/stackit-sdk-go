...
func (r ApiCreateNetworkAreaRequest) Execute() (*V1NetworkArea, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (a *APIClient) CreateNetworkAreaExecute(ctx context.Context, organizationId string) (*V1NetworkArea, error) {
...
type ApiUpdateNetworkRequest struct {
	...
	projectId            string
	networkId            string
	updateNetworkPayload *UpdateNetworkPayload
}

// Update network request.

func (r ApiUpdateNetworkRequest) UpdateNetworkPayload(updateNetworkPayload UpdateNetworkPayload) ApiUpdateNetworkRequest {
	r.updateNetworkPayload = &updateNetworkPayload
	return r
}

func (r ApiUpdateNetworkRequest) Execute() error {
	var (
	...
	a := r.apiService
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.UpdateNetwork")
	if err != nil {
		return &oapierror.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
	...
	if r.updateNetworkPayload == nil {
		return fmt.Errorf("updateNetworkPayload is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.updateNetworkPayload
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return err
	}
...
*/
func (a *APIClient) UpdateNetwork(ctx context.Context, projectId string, networkId string) ApiUpdateNetworkRequest {
	return ApiUpdateNetworkRequest{
		apiService: a.defaultApi,
		ctx:        ctx,
		projectId:  projectId,
...
func (a *APIClient) UpdateNetworkExecute(ctx context.Context, projectId string, networkId string) error {
	r := ApiUpdateNetworkRequest{
		apiService: a.defaultApi,
		ctx:        ctx,
		projectId:  projectId,
		networkId:  networkId,
