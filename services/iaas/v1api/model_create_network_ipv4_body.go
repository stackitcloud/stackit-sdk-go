...
type _CreateNetworkIPv4Body CreateNetworkIPv4Body
...
func (o *CreateNetworkIPv4Body) UnmarshalJSON(data []byte) (err error) {
	varCreateNetworkIPv4Body := _CreateNetworkIPv4Body{}

	err = json.Unmarshal(data, &varCreateNetworkIPv4Body)

	if err != nil {
		return err
	}

	*o = CreateNetworkIPv4Body(varCreateNetworkIPv4Body)
