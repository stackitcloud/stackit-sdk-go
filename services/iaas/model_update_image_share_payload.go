...
// UpdateImageSharePayload Share details of an Image. ParentOrganization and Projects are mutually exclusive.
...
func (o *UpdateImageSharePayload) HasParentOrganization() bool {
	if o != nil && !IsNil(o.ParentOrganization) && !IsNil(o.ParentOrganization) {
		return true
	}
...
func (o *UpdateImageSharePayload) HasProjects() bool {
	if o != nil && !IsNil(o.Projects) && !IsNil(o.Projects) {
		return true
	}
