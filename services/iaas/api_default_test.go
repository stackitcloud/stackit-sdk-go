...
func Test_iaas_DefaultApiService(t *testing.T) {
	...
	t.Run("Test DefaultApiService CreateIsolatedNetwork", func(t *testing.T) {
		_apiUrlPath := "/v2/projects/{projectId}/regions/{region}/isolated-network"
		projectIdValue := randString(36)
		_apiUrlPath = strings.Replace(_apiUrlPath, "{"+"projectId"+"}", url.PathEscape(ParameterValueToString(projectIdValue, "projectId")), -1)
		regionValue := "region-value"
		_apiUrlPath = strings.Replace(_apiUrlPath, "{"+"region"+"}", url.PathEscape(ParameterValueToString(regionValue, "region")), -1)
	...
	t.Run("Test DefaultApiService ImageFromVolume", func(t *testing.T) {
		...
		resp, reqErr := apiClient.ImageFromVolume(context.Background(), projectId, volumeId, region).Execute()
