...
// isModel
type CreateNetworkAreaPayloadGetAddressFamilyAttributeType = *CreateAreaAddressFamily
type CreateNetworkAreaPayloadGetAddressFamilyArgType = CreateAreaAddressFamily
type CreateNetworkAreaPayloadGetAddressFamilyRetType = CreateAreaAddressFamily

func getCreateNetworkAreaPayloadGetAddressFamilyAttributeTypeOk(arg CreateNetworkAreaPayloadGetAddressFamilyAttributeType) (ret CreateNetworkAreaPayloadGetAddressFamilyRetType, ok bool) {
	if arg == nil {
		return ret, false
	}
	return *arg, true
...
func setCreateNetworkAreaPayloadGetAddressFamilyAttributeType(arg *CreateNetworkAreaPayloadGetAddressFamilyAttributeType, val CreateNetworkAreaPayloadGetAddressFamilyRetType) {
	*arg = &val
}
...
type CreateNetworkAreaPayload struct {
	// REQUIRED
	AddressFamily CreateNetworkAreaPayloadGetAddressFamilyAttributeType `json:"addressFamily" required:"true"`
...
func NewCreateNetworkAreaPayload(addressFamily CreateNetworkAreaPayloadGetAddressFamilyArgType, name CreateNetworkAreaPayloadGetNameArgType) *CreateNetworkAreaPayload {
	this := CreateNetworkAreaPayload{}
	setCreateNetworkAreaPayloadGetAddressFamilyAttributeType(&this.AddressFamily, addressFamily)
...
func (o *CreateNetworkAreaPayload) GetAddressFamily() (ret CreateNetworkAreaPayloadGetAddressFamilyRetType) {
	ret, _ = o.GetAddressFamilyOk()
	return ret
}

// GetAddressFamilyOk returns a tuple with the AddressFamily field value
// and a boolean to check if the value has been set.
func (o *CreateNetworkAreaPayload) GetAddressFamilyOk() (ret CreateNetworkAreaPayloadGetAddressFamilyRetType, ok bool) {
	return getCreateNetworkAreaPayloadGetAddressFamilyAttributeTypeOk(o.AddressFamily)
}

// SetAddressFamily sets field value
func (o *CreateNetworkAreaPayload) SetAddressFamily(v CreateNetworkAreaPayloadGetAddressFamilyRetType) {
	setCreateNetworkAreaPayloadGetAddressFamilyAttributeType(&o.AddressFamily, v)
}
