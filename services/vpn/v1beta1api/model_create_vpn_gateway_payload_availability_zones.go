...
func (o *CreateVPNGatewayPayloadAvailabilityZones) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateVPNGatewayPayloadAvailabilityZones := _CreateVPNGatewayPayloadAvailabilityZones{}

	err = json.Unmarshal(data, &varCreateVPNGatewayPayloadAvailabilityZones)

	if err != nil {
		return err
	}

	*o = CreateVPNGatewayPayloadAvailabilityZones(varCreateVPNGatewayPayloadAvailabilityZones)
