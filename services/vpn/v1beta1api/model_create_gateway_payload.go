...
func (o *CreateGatewayPayload) GetNetworkArea() NetworkConfig {
...
// and a boolean to check if the value has been set.
func (o *CreateGatewayPayload) GetNetworkAreaOk() (*NetworkConfig, bool) {
	if o == nil || IsNil(o.NetworkArea) {
		return nil, false
	}
...
func (o *CreateGatewayPayload) HasNetworkArea() bool {
	if o != nil && !IsNil(o.NetworkArea) {
		return true
	}
...
func (o *CreateGatewayPayload) SetNetworkArea(v NetworkConfig) {
	o.NetworkArea = &v
}
