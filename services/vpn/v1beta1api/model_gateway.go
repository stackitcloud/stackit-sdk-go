...
func (o *Gateway) GetNetworkArea() NetworkConfig {
...
// and a boolean to check if the value has been set.
func (o *Gateway) GetNetworkAreaOk() (*NetworkConfig, bool) {
	if o == nil || IsNil(o.NetworkArea) {
		return nil, false
	}
...
func (o *Gateway) HasNetworkArea() bool {
	if o != nil && !IsNil(o.NetworkArea) {
		return true
	}
...
func (o *Gateway) SetNetworkArea(v NetworkConfig) {
	o.NetworkArea = &v
}
