...
func NewCreateVPNGatewayPayload(availabilityZones CreateVPNGatewayPayloadAvailabilityZones, planId string, routingType RoutingType) *CreateVPNGatewayPayload {
...
func (o *CreateVPNGatewayPayload) HasDisplayName() bool {
	if o != nil && !IsNil(o.DisplayName) {
		return true
	}
...
func (o *CreateVPNGatewayPayload) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varCreateVPNGatewayPayload)
