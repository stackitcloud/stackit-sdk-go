...
func NewUpdateGatewayConnectionPayload(tunnel1 TunnelConfiguration, tunnel2 TunnelConfiguration) *UpdateGatewayConnectionPayload {
...
func (o *UpdateGatewayConnectionPayload) HasDisplayName() bool {
	if o != nil && !IsNil(o.DisplayName) {
		return true
	}
