...
func NewUpdateVPNGatewayPayload(availabilityZones UpdateVPNGatewayPayloadAvailabilityZones, planId string, routingType RoutingType) *UpdateVPNGatewayPayload {
...
func (o *UpdateVPNGatewayPayload) HasDisplayName() bool {
	if o != nil && !IsNil(o.DisplayName) {
		return true
	}
