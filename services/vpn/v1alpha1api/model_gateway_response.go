...
func NewGatewayResponse(availabilityZones GatewayAvailabilityZones, planId string, routingType RoutingType) *GatewayResponse {
...
func (o *GatewayResponse) HasDisplayName() bool {
	if o != nil && !IsNil(o.DisplayName) {
		return true
	}
