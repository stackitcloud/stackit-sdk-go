...
// checks if the UpdateGatewayBGPFilterRulePayloadMatch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateGatewayBGPFilterRulePayloadMatch{}
...
type _UpdateGatewayBGPFilterRulePayloadMatch UpdateGatewayBGPFilterRulePayloadMatch

// NewUpdateGatewayBGPFilterRulePayloadMatch instantiates a new UpdateGatewayBGPFilterRulePayloadMatch object
...
func NewUpdateGatewayBGPFilterRulePayloadMatch() *UpdateGatewayBGPFilterRulePayloadMatch {
	this := UpdateGatewayBGPFilterRulePayloadMatch{}
	return &this
}

// NewUpdateGatewayBGPFilterRulePayloadMatchWithDefaults instantiates a new UpdateGatewayBGPFilterRulePayloadMatch object
...
func (o *UpdateGatewayBGPFilterRulePayloadMatch) GetFirstASN() int64 {
...
func (o *UpdateGatewayBGPFilterRulePayloadMatch) HasFirstASN() bool {
	if o != nil && !IsNil(o.FirstASN) {
		return true
	}
...
func (o *UpdateGatewayBGPFilterRulePayloadMatch) SetFirstASN(v int64) {
	o.FirstASN = &v
}
...
func (o *UpdateGatewayBGPFilterRulePayloadMatch) GetPeer() string {
...
// and a boolean to check if the value has been set.
func (o *UpdateGatewayBGPFilterRulePayloadMatch) GetPeerOk() (*string, bool) {
	if o == nil || IsNil(o.Peer) {
		return nil, false
	}
	return o.Peer, true
...
func (o *UpdateGatewayBGPFilterRulePayloadMatch) HasPeer() bool {
	if o != nil && !IsNil(o.Peer) {
		return true
	}
...
func (o *UpdateGatewayBGPFilterRulePayloadMatch) SetPeer(v string) {
	o.Peer = &v
}

// GetPrefixes returns the Prefixes field value if set, zero value otherwise.
func (o *UpdateGatewayBGPFilterRulePayloadMatch) GetPrefixes() []string {
...
func (o *UpdateGatewayBGPFilterRulePayloadMatch) HasPrefixes() bool {
	if o != nil && !IsNil(o.Prefixes) {
		return true
	}
...
func (o *UpdateGatewayBGPFilterRulePayloadMatch) UnmarshalJSON(data []byte) (err error) {
	varUpdateGatewayBGPFilterRulePayloadMatch := _UpdateGatewayBGPFilterRulePayloadMatch{}

	err = json.Unmarshal(data, &varUpdateGatewayBGPFilterRulePayloadMatch)

	if err != nil {
		return err
	}

	*o = UpdateGatewayBGPFilterRulePayloadMatch(varUpdateGatewayBGPFilterRulePayloadMatch)
...
type NullableUpdateGatewayBGPFilterRulePayloadMatch struct {
	value *UpdateGatewayBGPFilterRulePayloadMatch
	isSet bool
}

func (v NullableUpdateGatewayBGPFilterRulePayloadMatch) Get() *UpdateGatewayBGPFilterRulePayloadMatch {
	return v.value
}

func (v *NullableUpdateGatewayBGPFilterRulePayloadMatch) Set(val *UpdateGatewayBGPFilterRulePayloadMatch) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateGatewayBGPFilterRulePayloadMatch) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateGatewayBGPFilterRulePayloadMatch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateGatewayBGPFilterRulePayloadMatch(val *UpdateGatewayBGPFilterRulePayloadMatch) *NullableUpdateGatewayBGPFilterRulePayloadMatch {
	return &NullableUpdateGatewayBGPFilterRulePayloadMatch{value: val, isSet: true}
}

func (v NullableUpdateGatewayBGPFilterRulePayloadMatch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateGatewayBGPFilterRulePayloadMatch) UnmarshalJSON(src []byte) error {
	v.isSet = true
