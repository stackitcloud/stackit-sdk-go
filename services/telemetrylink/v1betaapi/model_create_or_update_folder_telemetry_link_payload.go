...
func NewCreateOrUpdateFolderTelemetryLinkPayload(accessToken string, displayName string, telemetryRouterId string) *CreateOrUpdateFolderTelemetryLinkPayload {
