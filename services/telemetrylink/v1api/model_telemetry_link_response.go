...
func (o *TelemetryLinkResponse) GetAccessId() string {
...
func (o *TelemetryLinkResponse) GetAccessIdOk() (*string, bool) {
	if o == nil || IsNil(o.AccessId) {
		return nil, false
	}
...
func (o *TelemetryLinkResponse) HasAccessId() bool {
	if o != nil && !IsNil(o.AccessId) {
		return true
	}
...
func (o *TelemetryLinkResponse) SetAccessId(v string) {
	o.AccessId = &v
}
