...
// checks if the TelemetryLinkRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TelemetryLinkRequest{}
...
type _TelemetryLinkRequest TelemetryLinkRequest

// NewTelemetryLinkRequest instantiates a new TelemetryLinkRequest object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewTelemetryLinkRequest() *TelemetryLinkRequest {
	this := TelemetryLinkRequest{}
	var enabled bool = true
	this.Enabled = &enabled
	return &this
}

// NewTelemetryLinkRequestWithDefaults instantiates a new TelemetryLinkRequest object
...
func (o *TelemetryLinkRequest) GetAccessId() string {
...
func (o *TelemetryLinkRequest) GetAccessIdOk() (*string, bool) {
	if o == nil || IsNil(o.AccessId) {
		return nil, false
	}
...
func (o *TelemetryLinkRequest) HasAccessId() bool {
	if o != nil && !IsNil(o.AccessId) {
		return true
	}
...
func (o *TelemetryLinkRequest) SetAccessId(v string) {
	o.AccessId = &v
}
...
func (o *TelemetryLinkRequest) UnmarshalJSON(data []byte) (err error) {
	varTelemetryLinkRequest := _TelemetryLinkRequest{}

	err = json.Unmarshal(data, &varTelemetryLinkRequest)

	if err != nil {
		return err
	}

	*o = TelemetryLinkRequest(varTelemetryLinkRequest)
...
func NewNullableTelemetryLinkRequest(val *TelemetryLinkRequest) *NullableTelemetryLinkRequest {
	return &NullableTelemetryLinkRequest{value: val, isSet: true}
}
