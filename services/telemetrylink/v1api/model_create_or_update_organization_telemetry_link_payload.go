...
func NewCreateOrUpdateOrganizationTelemetryLinkPayload(accessToken string, displayName string, telemetryRouterId string) *CreateOrUpdateOrganizationTelemetryLinkPayload {
