...
// checks if the PartialUpdateFolderTelemetryLinkPayload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PartialUpdateFolderTelemetryLinkPayload{}
...
type _PartialUpdateFolderTelemetryLinkPayload PartialUpdateFolderTelemetryLinkPayload
...
func NewPartialUpdateFolderTelemetryLinkPayload() *PartialUpdateFolderTelemetryLinkPayload {
	this := PartialUpdateFolderTelemetryLinkPayload{}
	var enabled bool = true
	this.Enabled = &enabled
	return &this
}

// NewPartialUpdateFolderTelemetryLinkPayloadWithDefaults instantiates a new PartialUpdateFolderTelemetryLinkPayload object
...
func (o *PartialUpdateFolderTelemetryLinkPayload) GetAccessId() string {
...
func (o *PartialUpdateFolderTelemetryLinkPayload) GetAccessIdOk() (*string, bool) {
	if o == nil || IsNil(o.AccessId) {
		return nil, false
	}
...
func (o *PartialUpdateFolderTelemetryLinkPayload) HasAccessId() bool {
	if o != nil && !IsNil(o.AccessId) {
		return true
	}
...
func (o *PartialUpdateFolderTelemetryLinkPayload) SetAccessId(v string) {
	o.AccessId = &v
}
...
func (o *PartialUpdateFolderTelemetryLinkPayload) UnmarshalJSON(data []byte) (err error) {
	varPartialUpdateFolderTelemetryLinkPayload := _PartialUpdateFolderTelemetryLinkPayload{}

	err = json.Unmarshal(data, &varPartialUpdateFolderTelemetryLinkPayload)

	if err != nil {
		return err
	}

	*o = PartialUpdateFolderTelemetryLinkPayload(varPartialUpdateFolderTelemetryLinkPayload)
...
type NullablePartialUpdateFolderTelemetryLinkPayload struct {
	value *PartialUpdateFolderTelemetryLinkPayload
	isSet bool
}
...
func NewNullablePartialUpdateFolderTelemetryLinkPayload(val *PartialUpdateFolderTelemetryLinkPayload) *NullablePartialUpdateFolderTelemetryLinkPayload {
	return &NullablePartialUpdateFolderTelemetryLinkPayload{value: val, isSet: true}
}
