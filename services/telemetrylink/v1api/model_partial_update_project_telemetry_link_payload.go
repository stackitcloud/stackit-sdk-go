...
func (o *PartialUpdateProjectTelemetryLinkPayload) GetAccessId() string {
...
func (o *PartialUpdateProjectTelemetryLinkPayload) GetAccessIdOk() (*string, bool) {
	if o == nil || IsNil(o.AccessId) {
		return nil, false
	}
...
func (o *PartialUpdateProjectTelemetryLinkPayload) HasAccessId() bool {
	if o != nil && !IsNil(o.AccessId) {
		return true
	}
...
func (o *PartialUpdateProjectTelemetryLinkPayload) SetAccessId(v string) {
	o.AccessId = &v
}
