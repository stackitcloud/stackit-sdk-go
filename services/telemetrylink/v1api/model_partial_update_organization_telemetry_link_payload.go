...
// checks if the PartialUpdateOrganizationTelemetryLinkPayload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PartialUpdateOrganizationTelemetryLinkPayload{}
...
type _PartialUpdateOrganizationTelemetryLinkPayload PartialUpdateOrganizationTelemetryLinkPayload

// NewPartialUpdateOrganizationTelemetryLinkPayload instantiates a new PartialUpdateOrganizationTelemetryLinkPayload object
...
func NewPartialUpdateOrganizationTelemetryLinkPayload() *PartialUpdateOrganizationTelemetryLinkPayload {
	this := PartialUpdateOrganizationTelemetryLinkPayload{}
	var enabled bool = true
	this.Enabled = &enabled
	return &this
}

// NewPartialUpdateOrganizationTelemetryLinkPayloadWithDefaults instantiates a new PartialUpdateOrganizationTelemetryLinkPayload object
...
func (o *PartialUpdateOrganizationTelemetryLinkPayload) GetAccessId() string {
...
func (o *PartialUpdateOrganizationTelemetryLinkPayload) GetAccessIdOk() (*string, bool) {
	if o == nil || IsNil(o.AccessId) {
		return nil, false
	}
...
func (o *PartialUpdateOrganizationTelemetryLinkPayload) HasAccessId() bool {
	if o != nil && !IsNil(o.AccessId) {
		return true
	}
...
func (o *PartialUpdateOrganizationTelemetryLinkPayload) SetAccessId(v string) {
	o.AccessId = &v
}
...
func (o *PartialUpdateOrganizationTelemetryLinkPayload) UnmarshalJSON(data []byte) (err error) {
	varPartialUpdateOrganizationTelemetryLinkPayload := _PartialUpdateOrganizationTelemetryLinkPayload{}

	err = json.Unmarshal(data, &varPartialUpdateOrganizationTelemetryLinkPayload)

	if err != nil {
		return err
	}

	*o = PartialUpdateOrganizationTelemetryLinkPayload(varPartialUpdateOrganizationTelemetryLinkPayload)
...
type NullablePartialUpdateOrganizationTelemetryLinkPayload struct {
	value *PartialUpdateOrganizationTelemetryLinkPayload
	isSet bool
}
...
func NewNullablePartialUpdateOrganizationTelemetryLinkPayload(val *PartialUpdateOrganizationTelemetryLinkPayload) *NullablePartialUpdateOrganizationTelemetryLinkPayload {
	return &NullablePartialUpdateOrganizationTelemetryLinkPayload{value: val, isSet: true}
}
