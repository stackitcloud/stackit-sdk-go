...
func (o *InstanceParameters) GetConsumerTimeout() *int64 {
...
func (o *InstanceParameters) GetConsumerTimeoutOk() (*int64, bool) {
	if o == nil || IsNil(o.ConsumerTimeout) {
		return nil, false
	}
...
func (o *InstanceParameters) SetConsumerTimeout(v *int64) {
	o.ConsumerTimeout = v
}
