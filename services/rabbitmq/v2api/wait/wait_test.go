	...
	for _, tt := range tests {
		t.Run(tt.desc, func(t *testing.T) {
			synctest.Test(t, func(t *testing.T) {
				...
				handler := CreateInstanceWaitHandler(context.Background(), apiClient, "pid", testRegion, instanceId)
	...
	for _, tt := range tests {
		t.Run(tt.desc, func(t *testing.T) {
			synctest.Test(t, func(t *testing.T) {
				...
				handler := PartialUpdateInstanceWaitHandler(context.Background(), apiClient, "", testRegion, instanceId)
