...
type CreateCredentialsPayload struct {
	Parameters           *CredentialsParameters `json:"parameters,omitempty"`
...
func (o *CreateCredentialsPayload) GetParameters() CredentialsParameters {
	if o == nil || IsNil(o.Parameters) {
		var ret CredentialsParameters
		return ret
	}
	return *o.Parameters
}
...
func (o *CreateCredentialsPayload) GetParametersOk() (*CredentialsParameters, bool) {
	if o == nil || IsNil(o.Parameters) {
		return nil, false
	}
...
func (o *CreateCredentialsPayload) SetParameters(v CredentialsParameters) {
	o.Parameters = &v
}
