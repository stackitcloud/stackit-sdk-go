...
type InstanceParameters struct {
	...
	ConsumerTimeout  *int32 `json:"consumer_timeout,omitempty"`
...
func NewInstanceParameters() *InstanceParameters {
	...
	var consumerTimeout int32 = 1800000
...
func (o *InstanceParameters) GetConsumerTimeout() int32 {
...
func (o *InstanceParameters) GetConsumerTimeoutOk() (*int32, bool) {
	if o == nil || IsNil(o.ConsumerTimeout) {
		return nil, false
	}
	return o.ConsumerTimeout, true
}
...
// SetConsumerTimeout gets a reference to the given int32 and assigns it to the ConsumerTimeout field.
func (o *InstanceParameters) SetConsumerTimeout(v int32) {
	o.ConsumerTimeout = &v
}
...
// Deprecated
func (o *InstanceParameters) GetRoles() []string {
...
// and a boolean to check if the value has been set.
// Deprecated
func (o *InstanceParameters) GetRolesOk() ([]string, bool) {
	if o == nil || IsNil(o.Roles) {
		return nil, false
	}
	return o.Roles, true
...
// Deprecated
func (o *InstanceParameters) SetRoles(v []string) {
	o.Roles = v
}
...
func (o InstanceParameters) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ConsumerTimeout) {
		toSerialize["consumer_timeout"] = o.ConsumerTimeout
	}
...
func (o *InstanceParameters) UnmarshalJSON(data []byte) (err error) {
	...
	*o = InstanceParameters(varInstanceParameters)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "consumer_timeout")
