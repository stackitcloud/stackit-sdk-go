...
type DefaultApi interface {
	...
	*/
	...
	/*
		...
		// Deprecated: Will be removed after 2026-09-30. Move to the packages generated for each available API version instead
	*/
	UpdateUserExecute(ctx context.Context, projectId string, instanceId string, username string) (*User, error)
}
...
type ApiGetUsersRequest interface {
	...
	// Deprecated: Will be removed after 2026-09-30. Move to the packages generated for each available API version instead
	Page(page int32) ApiGetUsersRequest
	// Deprecated: Will be removed after 2026-09-30. Move to the packages generated for each available API version instead
...
// Page number for pagination (1-indexed). Each page contains up to 50 users.
// Deprecated: Will be removed after 2026-09-30. Move to the packages generated for each available API version instead
func (r GetUsersRequest) Page(page int32) ApiGetUsersRequest {
	r.page = &page
	return r
}
...
// Deprecated: Will be removed after 2026-09-30. Move to the packages generated for each available API version instead
func (r UpdateUserRequest) Execute() (*User, error) {
	var (
		localVarHTTPMethod  = http.MethodPatch
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	if r.updateUserPayload == nil {
		return localVarReturnValue, fmt.Errorf("updateUserPayload is required and must be specified")
	}
...
Deprecated: Will be removed after 2026-09-30. Move to the packages generated for each available API version instead
	...
	@return ApiUpdateUserRequest
*/
func (a *APIClient) UpdateUser(ctx context.Context, projectId string, instanceId string, username string) ApiUpdateUserRequest {
...
// Deprecated: Will be removed after 2026-09-30. Move to the packages generated for each available API version instead
func (a *APIClient) UpdateUserExecute(ctx context.Context, projectId string, instanceId string, username string) (*User, error) {
	r := UpdateUserRequest{
		apiService: a.defaultApi,
		ctx:        ctx,
		projectId:  projectId,
