...
type DefaultAPI interface {
	...
	*/
	...
	CreateAuthenticationExecute(r ApiCreateAuthenticationRequest) (*Authentication, *http.Response, error)
	...
	*/
	...
	//  @return Runner
	CreateRunnerExecute(r ApiCreateRunnerRequest) (*Runner, *http.Response, error)
	...
	*/
	...
	DeleteAuthenticationExecute(r ApiDeleteAuthenticationRequest) (*http.Response, error)
	...
	*/
	...
	DeleteRunnerExecute(r ApiDeleteRunnerRequest) (*http.Response, error)
	...
	*/
	...
	//  @return Authentication
	GetAuthenticationExecute(r ApiGetAuthenticationRequest) (*Authentication, *http.Response, error)
	...
	*/
	...
	//  @return Runner
	GetRunnerExecute(r ApiGetRunnerRequest) (*Runner, *http.Response, error)
	...
	*/
	...
	ListAuthenticationExecute(r ApiListAuthenticationRequest) (*AuthenticationList, *http.Response, error)
	...
	*/
	...
	//  @return ListFlavors
	ListFlavorsExecute(r ApiListFlavorsRequest) (*ListFlavors, *http.Response, error)
	...
	*/
	...
	ListInstancesExecute(r ApiListInstancesRequest) (*ListInstances, *http.Response, error)
	...
	*/
	...
	ListRunnerRuntimesExecute(r ApiListRunnerRuntimesRequest) (*RunnerRuntimeList, *http.Response, error)
	...
	*/
	...
	//  @return Authentication
	PatchAuthenticationExecute(r ApiPatchAuthenticationRequest) (*Authentication, *http.Response, error)
	...
	*/
	...
	//  @return Instance
	PatchInstanceExecute(r ApiPatchInstanceRequest) (*Instance, *http.Response, error)
}
...
//
//	@return Authentication
func (a *DefaultAPIService) CreateAuthenticationExecute(r ApiCreateAuthenticationRequest) (*Authentication, *http.Response, error) {
	var (
	...
	if strlen(r.instanceId) < 36 {
		return localVarReturnValue, nil, reportError("instanceId must have at least 36 elements")
	}
	if strlen(r.instanceId) > 36 {
		return localVarReturnValue, nil, reportError("instanceId must have less than 36 elements")
	}
	if r.createAuthenticationPayload == nil {
		return localVarReturnValue, nil, reportError("createAuthenticationPayload is required and must be specified")
	}
...
func (r ApiCreateRunnerRequest) Execute() (*Runner, *http.Response, error) {
...
//
//	@return Runner
func (a *DefaultAPIService) CreateRunnerExecute(r ApiCreateRunnerRequest) (*Runner, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	if r.createRunnerPayload == nil {
		return localVarReturnValue, nil, reportError("createRunnerPayload is required and must be specified")
	}
...
func (r ApiDeleteAuthenticationRequest) Execute() (*http.Response, error) {
...
// Execute executes the request
func (a *DefaultAPIService) DeleteAuthenticationExecute(r ApiDeleteAuthenticationRequest) (*http.Response, error) {
	var (
	...
	if strlen(r.instanceId) < 36 {
		return nil, reportError("instanceId must have at least 36 elements")
	}
	if strlen(r.instanceId) > 36 {
		return nil, reportError("instanceId must have less than 36 elements")
	}
	if strlen(r.authenticationId) < 36 {
		return nil, reportError("authenticationId must have at least 36 elements")
	}
	if strlen(r.authenticationId) > 36 {
		return nil, reportError("authenticationId must have less than 36 elements")
	}
...
// Execute executes the request
func (a *DefaultAPIService) DeleteRunnerExecute(r ApiDeleteRunnerRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodDelete
		localVarPostBody   interface{}
		formFiles          []formFile
...
func (r ApiGetAuthenticationRequest) Execute() (*Authentication, *http.Response, error) {
...
//
//	@return Authentication
func (a *DefaultAPIService) GetAuthenticationExecute(r ApiGetAuthenticationRequest) (*Authentication, *http.Response, error) {
	var (
	...
	if strlen(r.authenticationId) < 36 {
		return localVarReturnValue, nil, reportError("authenticationId must have at least 36 elements")
	}
	if strlen(r.authenticationId) > 36 {
		return localVarReturnValue, nil, reportError("authenticationId must have less than 36 elements")
	}
...
func (r ApiGetRunnerRequest) Execute() (*Runner, *http.Response, error) {
...
//
//	@return Runner
func (a *DefaultAPIService) GetRunnerExecute(r ApiGetRunnerRequest) (*Runner, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiListAuthenticationRequest) Execute() (*AuthenticationList, *http.Response, error) {
...
//
//	@return AuthenticationList
func (a *DefaultAPIService) ListAuthenticationExecute(r ApiListAuthenticationRequest) (*AuthenticationList, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiListFlavorsRequest) Execute() (*ListFlavors, *http.Response, error) {
...
//
//	@return ListFlavors
func (a *DefaultAPIService) ListFlavorsExecute(r ApiListFlavorsRequest) (*ListFlavors, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiListInstancesRequest) Execute() (*ListInstances, *http.Response, error) {
...
//
//	@return ListInstances
func (a *DefaultAPIService) ListInstancesExecute(r ApiListInstancesRequest) (*ListInstances, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiListRunnerRuntimesRequest) Execute() (*RunnerRuntimeList, *http.Response, error) {
...
//
//	@return RunnerRuntimeList
func (a *DefaultAPIService) ListRunnerRuntimesExecute(r ApiListRunnerRuntimesRequest) (*RunnerRuntimeList, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiPatchAuthenticationRequest) Execute() (*Authentication, *http.Response, error) {
...
//
//	@return Authentication
func (a *DefaultAPIService) PatchAuthenticationExecute(r ApiPatchAuthenticationRequest) (*Authentication, *http.Response, error) {
	var (
	...
	if r.patchAuthenticationPayload == nil {
		return localVarReturnValue, nil, reportError("patchAuthenticationPayload is required and must be specified")
	}
...
//
//	@return Instance
func (a *DefaultAPIService) PatchInstanceExecute(r ApiPatchInstanceRequest) (*Instance, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPatch
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	if r.patchInstancePayload == nil {
		return localVarReturnValue, nil, reportError("patchInstancePayload is required and must be specified")
	}
