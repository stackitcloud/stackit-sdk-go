...
type DefaultAPI interface {
	...
	*/
	...
	GetUserExecute(r ApiGetUserRequest) error

	/*
			GetUsers Get instance Users.

			Lists STACKIT Git Users within an instance. Supports pagination via the
	...
	*/
	...
	//  @return ListUsers
	GetUsersExecute(r ApiGetUsersRequest) (*ListUsers, error)
	...
	*/
	...
	/*
		UpdateUser Update Instance User.

		Updates the Instance User.
	...
	*/
	UpdateUser(ctx context.Context, projectId string, instanceId string, username string) ApiUpdateUserRequest

	// UpdateUserExecute executes the request
	//  @return User
	UpdateUserExecute(r ApiUpdateUserRequest) (*User, error)
}
...
Deletes a STACKIT Git instance User and destroys all associated data.
	...
	@return ApiDeleteUserRequest
*/
func (a *DefaultAPIService) DeleteUser(ctx context.Context, projectId string, instanceId string, username string) ApiDeleteUserRequest {
	return ApiDeleteUserRequest{
		ApiService: a,
		ctx:        ctx,
		projectId:  projectId,
...
func (r ApiGetUserRequest) Execute() error {
...
Retrieves information about a STACKIT Git instance User.
	...
	@return ApiGetUserRequest
*/
func (a *DefaultAPIService) GetUser(ctx context.Context, projectId string, instanceId string, username string) ApiGetUserRequest {
	return ApiGetUserRequest{
		ApiService: a,
		ctx:        ctx,
		projectId:  projectId,
...
// Execute executes the request
func (a *DefaultAPIService) GetUserExecute(r ApiGetUserRequest) error {
	var (
		localVarHTTPMethod = http.MethodGet
		localVarPostBody   interface{}
		formFiles          []formFile
...
func (r ApiGetUsersRequest) Execute() (*ListUsers, error) {
...
optional `page` query parameter. Each page returns up to 50 users.
	...
	@return ApiGetUsersRequest
*/
func (a *DefaultAPIService) GetUsers(ctx context.Context, projectId string, instanceId string) ApiGetUsersRequest {
	return ApiGetUsersRequest{
		ApiService: a,
		ctx:        ctx,
		projectId:  projectId,
...
//
//	@return ListUsers
func (a *DefaultAPIService) GetUsersExecute(r ApiGetUsersRequest) (*ListUsers, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiUpdateUserRequest) Execute() (*User, error) {
...
Updates the Instance User.
	...
	@return ApiUpdateUserRequest
*/
func (a *DefaultAPIService) UpdateUser(ctx context.Context, projectId string, instanceId string, username string) ApiUpdateUserRequest {
	return ApiUpdateUserRequest{
		ApiService: a,
		ctx:        ctx,
		projectId:  projectId,
...
//
//	@return User
func (a *DefaultAPIService) UpdateUserExecute(r ApiUpdateUserRequest) (*User, error) {
	var (
		localVarHTTPMethod  = http.MethodPatch
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	if r.updateUserPayload == nil {
		return localVarReturnValue, reportError("updateUserPayload is required and must be specified")
	}
