...
type _BadErrorResponse BadErrorResponse
...
func (o *BadErrorResponse) UnmarshalJSON(data []byte) (err error) {
	varBadErrorResponse := _BadErrorResponse{}

	err = json.Unmarshal(data, &varBadErrorResponse)

	if err != nil {
		return err
	}

	*o = BadErrorResponse(varBadErrorResponse)
