...
type DefaultAPIServiceMock struct {
	...
	UpdateUserExecuteMock *func(r ApiUpdateUserRequest) (*User, error)
}
...
func (a DefaultAPIServiceMock) UpdateUser(ctx context.Context, projectId string, instanceId string, username string) ApiUpdateUserRequest {
...
func (a DefaultAPIServiceMock) UpdateUserExecute(r ApiUpdateUserRequest) (*User, error) {
