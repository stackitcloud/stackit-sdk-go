...
type ApiCreateInstanceCloneRequest struct {
	ctx                        context.Context
	apiService                 *DefaultApiService
	projectId                  string
	instanceId                 string
...
// func (r ApiCreateInstanceCloneRequest) CreateInstanceClonePayload(createInstanceClonePayload CreateInstanceClonePayload) ApiCreateInstanceCloneRequest {
func (r ApiCreateInstanceCloneRequest) CreateInstanceClonePayload(createInstanceClonePayload CreateInstanceClonePayload) ApiCreateInstanceCloneRequest {
	r.createInstanceClonePayload = &createInstanceClonePayload
	return r
}

func (r ApiCreateInstanceCloneRequest) Execute() (*CreateInstanceCloneResponse, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *CreateInstanceCloneResponse
	)
	a := r.apiService
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.CreateInstanceClone")
	if err != nil {
		return localVarReturnValue, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.createInstanceClonePayload == nil {
		return localVarReturnValue, fmt.Errorf("createInstanceClonePayload is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.createInstanceClonePayload
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, err
	}
...
/*
CreateInstanceClone Clone instance
...
As an example a valid timestamp look like "2023-04-20T15:05:15Z"
	...
	@return ApiCreateInstanceCloneRequest
*/
func (a *APIClient) CreateInstanceClone(ctx context.Context, projectId string, instanceId string) ApiCreateInstanceCloneRequest {
	return ApiCreateInstanceCloneRequest{
		apiService: a.defaultApi,
		ctx:        ctx,
		projectId:  projectId,
...
func (a *APIClient) CreateInstanceCloneExecute(ctx context.Context, projectId string, instanceId string) (*CreateInstanceCloneResponse, error) {
	r := ApiCreateInstanceCloneRequest{
		apiService: a.defaultApi,
		ctx:        ctx,
		projectId:  projectId,
		instanceId: instanceId,
...
func (r ApiGetCPUMetricsRequest) Execute() (*MetricsResponse, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (a *APIClient) GetCPUMetricsExecute(ctx context.Context, projectId string, instanceId string) (*MetricsResponse, error) {
...
func (r ApiGetDatabaseStorageMetricsRequest) Execute() (*MetricsResponse, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (a *APIClient) GetDatabaseStorageMetricsExecute(ctx context.Context, projectId string, instanceId string) (*MetricsResponse, error) {
...
func (r ApiGetDiskIOPSMetricsRequest) Execute() (*MetricsResponse, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (a *APIClient) GetDiskIOPSMetricsExecute(ctx context.Context, projectId string, instanceId string) (*MetricsResponse, error) {
...
func (r ApiGetDiskUsageMetricsRequest) Execute() (*MetricsResponse, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (a *APIClient) GetDiskUsageMetricsExecute(ctx context.Context, projectId string, instanceId string) (*MetricsResponse, error) {
...
func (r ApiGetExecutionTimesMetricsRequest) Execute() (*MetricsResponse, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (a *APIClient) GetExecutionTimesMetricsExecute(ctx context.Context, projectId string, instanceId string) (*MetricsResponse, error) {
...
func (r ApiGetMemoryMetricsRequest) Execute() (*MetricsResponse, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (a *APIClient) GetMemoryMetricsExecute(ctx context.Context, projectId string, instanceId string) (*MetricsResponse, error) {
...
func (r ApiRestoreInstanceRequest) Execute() (*InstanceCreateRestoreInstanceResponse, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *InstanceCreateRestoreInstanceResponse
	)
	a := r.apiService
...
func (a *APIClient) RestoreInstanceExecute(ctx context.Context, projectId string, instanceId string) (*InstanceCreateRestoreInstanceResponse, error) {
