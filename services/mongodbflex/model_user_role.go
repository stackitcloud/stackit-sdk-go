...
// List of user.role
const (
	USERROLE_READ_ANY_DATABASE       UserRole = "readAnyDatabase"
	USERROLE_READ_WRITE_ANY_DATABASE UserRole = "readWriteAnyDatabase"
	USERROLE_STACKIT_ADMIN           UserRole = "stackitAdmin"
)
