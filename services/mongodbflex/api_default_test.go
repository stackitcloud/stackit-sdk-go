...
func Test_mongodbflex_DefaultApiService(t *testing.T) {
	...
	t.Run("Test DefaultApiService V1ProjectsProjectIdInstancesInstanceIdAdvisorSlowQueriesGet", func(t *testing.T) {
		path := "/v1/projects/{projectId}/instances/{instanceId}/advisor/slow-queries"
		projectIdValue := "projectId"
		path = strings.Replace(path, "{"+"projectId"+"}", url.PathEscape(ParameterValueToString(projectIdValue, "projectId")), -1)
		instanceIdValue := "instanceId"
		path = strings.Replace(path, "{"+"instanceId"+"}", url.PathEscape(ParameterValueToString(instanceIdValue, "instanceId")), -1)
		...
		resp, reqErr := apiClient.V1ProjectsProjectIdInstancesInstanceIdAdvisorSlowQueriesGet(context.Background(), projectId, instanceId).Execute()
	...
	t.Run("Test DefaultApiService V1ProjectsProjectIdInstancesInstanceIdAdvisorSuggestedIndexesGet", func(t *testing.T) {
		path := "/v1/projects/{projectId}/instances/{instanceId}/advisor/suggested-indexes"
		projectIdValue := "projectId"
		path = strings.Replace(path, "{"+"projectId"+"}", url.PathEscape(ParameterValueToString(projectIdValue, "projectId")), -1)
		instanceIdValue := "instanceId"
		path = strings.Replace(path, "{"+"instanceId"+"}", url.PathEscape(ParameterValueToString(instanceIdValue, "instanceId")), -1)
		...
		resp, reqErr := apiClient.V1ProjectsProjectIdInstancesInstanceIdAdvisorSuggestedIndexesGet(context.Background(), projectId, instanceId).Execute()
