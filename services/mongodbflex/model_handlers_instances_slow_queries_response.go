...
func (o *HandlersInstancesSlowQueriesResponse) GetSlowQueries() *[]MongodbatlasSlowQuery {
	if o == nil || IsNil(o.SlowQueries) {
		var ret *[]MongodbatlasSlowQuery
		return ret
	}
...
func (o *HandlersInstancesSlowQueriesResponse) GetSlowQueriesOk() (*[]MongodbatlasSlowQuery, bool) {
	if o == nil || IsNil(o.SlowQueries) {
		return nil, false
	}
...
// SetSlowQueries gets a reference to the given []MongodbatlasSlowQuery and assigns it to the SlowQueries field.
func (o *HandlersInstancesSlowQueriesResponse) SetSlowQueries(v *[]MongodbatlasSlowQuery) {
	o.SlowQueries = v
}
