...
type HandlersInstancesSuggestedIndexesResponse struct {
	...
	Shapes *[]MongodbatlasShape `json:"shapes,omitempty"`
	// Documents with information about the indexes suggested by the Performance Advisor.
	SuggestedIndexes *[]MongodbatlasSuggestedIndex `json:"suggestedIndexes,omitempty"`
}
...
func (o *HandlersInstancesSuggestedIndexesResponse) GetShapes() *[]MongodbatlasShape {
	if o == nil || IsNil(o.Shapes) {
		var ret *[]MongodbatlasShape
		return ret
	}
	return o.Shapes
}
...
func (o *HandlersInstancesSuggestedIndexesResponse) GetShapesOk() (*[]MongodbatlasShape, bool) {
	if o == nil || IsNil(o.Shapes) {
		return nil, false
	}
...
// SetShapes gets a reference to the given []MongodbatlasShape and assigns it to the Shapes field.
func (o *HandlersInstancesSuggestedIndexesResponse) SetShapes(v *[]MongodbatlasShape) {
	o.Shapes = v
}

// GetSuggestedIndexes returns the SuggestedIndexes field value if set, zero value otherwise.
func (o *HandlersInstancesSuggestedIndexesResponse) GetSuggestedIndexes() *[]MongodbatlasSuggestedIndex {
	if o == nil || IsNil(o.SuggestedIndexes) {
		var ret *[]MongodbatlasSuggestedIndex
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *HandlersInstancesSuggestedIndexesResponse) GetSuggestedIndexesOk() (*[]MongodbatlasSuggestedIndex, bool) {
	if o == nil || IsNil(o.SuggestedIndexes) {
		return nil, false
	}
...
// SetSuggestedIndexes gets a reference to the given []MongodbatlasSuggestedIndex and assigns it to the SuggestedIndexes field.
func (o *HandlersInstancesSuggestedIndexesResponse) SetSuggestedIndexes(v *[]MongodbatlasSuggestedIndex) {
