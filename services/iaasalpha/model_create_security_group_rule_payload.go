...
// CreateSecurityGroupRulePayload Object that represents a security group rule.
...
func (o *CreateSecurityGroupRulePayload) GetProtocol() *V1SecurityGroupRuleProtocol {
...
// and a boolean to check if the value has been set.
func (o *CreateSecurityGroupRulePayload) GetProtocolOk() (*V1SecurityGroupRuleProtocol, bool) {
	if o == nil || IsNil(o.Protocol) {
		return nil, false
	}
...
func (o *CreateSecurityGroupRulePayload) SetProtocol(v *V1SecurityGroupRuleProtocol) {
	o.Protocol = v
}
