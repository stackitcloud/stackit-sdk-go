...
func (o VirtualIpListResponse) MarshalJSON() ([]byte, error) {
...
func (o *VirtualIpListResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varVirtualIpListResponse := _VirtualIpListResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVirtualIpListResponse)

	if err != nil {
		return err
	}

	*o = VirtualIpListResponse(varVirtualIpListResponse)
