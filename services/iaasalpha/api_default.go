...
type DefaultApi interface {
	...
	*/
	AddMemberToVirtualIP(ctx context.Context, projectId string, networkId string, virtualIpId string) ApiAddMemberToVirtualIPRequest
	/*
		AddMemberToVirtualIPExecute executes the request
	...
	*/
	AddMemberToVirtualIPExecute(ctx context.Context, projectId string, networkId string, virtualIpId string) (*VirtualIp, error)
	/*
	...
	*/
	CreateVirtualIP(ctx context.Context, projectId string, networkId string) ApiCreateVirtualIPRequest
	/*
		CreateVirtualIPExecute executes the request
	...
	*/
	CreateVirtualIPExecute(ctx context.Context, projectId string, networkId string) (*VirtualIp, error)
	/*
	...
	*/
	DeleteVirtualIP(ctx context.Context, projectId string, networkId string, virtualIpId string) ApiDeleteVirtualIPRequest
	/*
		DeleteVirtualIPExecute executes the request

	*/
	DeleteVirtualIPExecute(ctx context.Context, projectId string, networkId string, virtualIpId string) error
	/*
	...
	*/
	GetVirtualIP(ctx context.Context, projectId string, networkId string, virtualIpId string) ApiGetVirtualIPRequest
	/*
		GetVirtualIPExecute executes the request
	...
	*/
	GetVirtualIPExecute(ctx context.Context, projectId string, networkId string, virtualIpId string) (*VirtualIp, error)
	/*
	...
	*/
	ListVirtualIPs(ctx context.Context, projectId string, networkId string) ApiListVirtualIPsRequest
	/*
		ListVirtualIPsExecute executes the request

		@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
		@param projectId The identifier (ID) of a STACKIT Project.
		@param networkId The identifier (ID) of a STACKIT Network.
		@return VirtualIpListResponse

	*/
	ListVirtualIPsExecute(ctx context.Context, projectId string, networkId string) (*VirtualIpListResponse, error)
	/*
	...
	*/
	RemoveMemberFromVirtualIP(ctx context.Context, projectId string, networkId string, virtualIpId string) ApiRemoveMemberFromVirtualIPRequest
	/*
		RemoveMemberFromVirtualIPExecute executes the request
	...
	*/
	RemoveMemberFromVirtualIPExecute(ctx context.Context, projectId string, networkId string, virtualIpId string) (*VirtualIp, error)
	/*
	...
	*/
	...
	/*
		UpdateVirtualIPExecute executes the request

	*/
	UpdateVirtualIPExecute(ctx context.Context, projectId string, networkId string, virtualIpId string) error
	/*
	...
	*/
	...
	/*
		V1alpha1UpdateRouteOfArea Update a network route.
		...
		@param areaId The identifier (ID) of a STACKIT Network Area.
		@param routeId The identifier (ID) of a STACKIT Route.
		@return ApiV1alpha1UpdateRouteOfAreaRequest
	*/
	V1alpha1UpdateRouteOfArea(ctx context.Context, organizationId string, areaId string, routeId string) ApiV1alpha1UpdateRouteOfAreaRequest
	/*
		V1alpha1UpdateRouteOfAreaExecute executes the request
	...
	*/
	V1alpha1UpdateRouteOfAreaExecute(ctx context.Context, organizationId string, areaId string, routeId string) (*Route, error)
}

type ApiAddMemberToVirtualIPRequest interface {
	// Request to add a member to a virtual IP.
	AddMemberToVirtualIPPayload(addMemberToVirtualIPPayload AddMemberToVirtualIPPayload) ApiAddMemberToVirtualIPRequest
	Execute() (*VirtualIp, error)
}
...
type ApiCreateVirtualIPRequest interface {
	// Request a virtual IP creation.
	CreateVirtualIPPayload(createVirtualIPPayload CreateVirtualIPPayload) ApiCreateVirtualIPRequest
	Execute() (*VirtualIp, error)
}
...
type ApiDeleteVirtualIPRequest interface {
	Execute() error
}
...
type ApiGetVirtualIPRequest interface {
	Execute() (*VirtualIp, error)
}
...
type ApiListVirtualIPsRequest interface {
	// Filter resources by labels.
	LabelSelector(labelSelector string) ApiListVirtualIPsRequest
	Execute() (*VirtualIpListResponse, error)
}
...
type ApiRemoveMemberFromVirtualIPRequest interface {
...
type ApiUpdateVirtualIPRequest interface {
...
type ApiV1alpha1UpdateRouteOfAreaRequest interface {
	// Request an update of a network route.
	V1alpha1UpdateRouteOfAreaPayload(v1alpha1UpdateRouteOfAreaPayload V1alpha1UpdateRouteOfAreaPayload) ApiV1alpha1UpdateRouteOfAreaRequest
	Execute() (*Route, error)
}
...
type AddMemberToVirtualIPRequest struct {
	ctx                         context.Context
...
func (r AddMemberToVirtualIPRequest) AddMemberToVirtualIPPayload(addMemberToVirtualIPPayload AddMemberToVirtualIPPayload) ApiAddMemberToVirtualIPRequest {
	r.addMemberToVirtualIPPayload = &addMemberToVirtualIPPayload
	return r
}

func (r AddMemberToVirtualIPRequest) Execute() (*VirtualIp, error) {
	var (
	...
	localBasePath, err := client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.AddMemberToVirtualIP")
	if err != nil {
...
func (a *APIClient) AddMemberToVirtualIP(ctx context.Context, projectId string, networkId string, virtualIpId string) ApiAddMemberToVirtualIPRequest {
	return AddMemberToVirtualIPRequest{
...
func (r CreateAffinityGroupRequest) Execute() (*AffinityGroup, error) {
	...
	localVarPath := localBasePath + "/v1alpha1/projects/{projectId}/affinity-groups"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(ParameterValueToString(r.projectId, "projectId")), -1)
...
func (r CreateBackupRequest) Execute() (*Backup, error) {
	...
	localVarPath := localBasePath + "/v1alpha1/projects/{projectId}/backups"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(ParameterValueToString(r.projectId, "projectId")), -1)
...
func (r CreateNetworkAreaRangeRequest) Execute() (*NetworkRangeListResponse, error) {
	...
	localVarPath := localBasePath + "/v1alpha1/organizations/{organizationId}/network-areas/{areaId}/network-ranges"
	localVarPath = strings.Replace(localVarPath, "{"+"organizationId"+"}", url.PathEscape(ParameterValueToString(r.organizationId, "organizationId")), -1)
...
func (r CreateNetworkAreaRouteRequest) Execute() (*RouteListResponse, error) {
	...
	localVarPath := localBasePath + "/v1alpha1/organizations/{organizationId}/network-areas/{areaId}/routes"
	localVarPath = strings.Replace(localVarPath, "{"+"organizationId"+"}", url.PathEscape(ParameterValueToString(r.organizationId, "organizationId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"areaId"+"}", url.PathEscape(ParameterValueToString(r.areaId, "areaId")), -1)
...
func (r CreateSnapshotRequest) Execute() (*Snapshot, error) {
	...
	localVarPath := localBasePath + "/v1alpha1/projects/{projectId}/snapshots"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(ParameterValueToString(r.projectId, "projectId")), -1)
...
func (r CreateVirtualIPRequest) CreateVirtualIPPayload(createVirtualIPPayload CreateVirtualIPPayload) ApiCreateVirtualIPRequest {
	r.createVirtualIPPayload = &createVirtualIPPayload
	return r
}

func (r CreateVirtualIPRequest) Execute() (*VirtualIp, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.CreateVirtualIP")
	if err != nil {
		return localVarReturnValue, &oapierror.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
func (r DeleteAffinityGroupRequest) Execute() error {
	...
	localVarPath := localBasePath + "/v1alpha1/projects/{projectId}/affinity-groups/{affinityGroupId}"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(ParameterValueToString(r.projectId, "projectId")), -1)
...
func (r DeleteBackupRequest) Execute() error {
	...
	localVarPath := localBasePath + "/v1alpha1/projects/{projectId}/backups/{backupId}"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(ParameterValueToString(r.projectId, "projectId")), -1)
...
func (r DeleteImageShareRequest) Execute() error {
	...
	localVarPath := localBasePath + "/v1alpha1/projects/{projectId}/images/{imageId}/share"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(ParameterValueToString(r.projectId, "projectId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"imageId"+"}", url.PathEscape(ParameterValueToString(r.imageId, "imageId")), -1)
...
func (r DeleteImageShareConsumerRequest) Execute() error {
	...
	localVarPath := localBasePath + "/v1alpha1/projects/{projectId}/images/{imageId}/share/{consumerProjectId}"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(ParameterValueToString(r.projectId, "projectId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"imageId"+"}", url.PathEscape(ParameterValueToString(r.imageId, "imageId")), -1)
...
func (r DeleteNetworkAreaRangeRequest) Execute() error {
	...
	localVarPath := localBasePath + "/v1alpha1/organizations/{organizationId}/network-areas/{areaId}/network-ranges/{networkRangeId}"
	localVarPath = strings.Replace(localVarPath, "{"+"organizationId"+"}", url.PathEscape(ParameterValueToString(r.organizationId, "organizationId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"areaId"+"}", url.PathEscape(ParameterValueToString(r.areaId, "areaId")), -1)
...
func (r DeleteNetworkAreaRouteRequest) Execute() error {
	...
	localVarPath := localBasePath + "/v1alpha1/organizations/{organizationId}/network-areas/{areaId}/routes/{routeId}"
	localVarPath = strings.Replace(localVarPath, "{"+"organizationId"+"}", url.PathEscape(ParameterValueToString(r.organizationId, "organizationId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"areaId"+"}", url.PathEscape(ParameterValueToString(r.areaId, "areaId")), -1)
...
func (r DeleteSnapshotRequest) Execute() error {
	...
	localVarPath := localBasePath + "/v1alpha1/projects/{projectId}/snapshots/{snapshotId}"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(ParameterValueToString(r.projectId, "projectId")), -1)
...
func (r DeleteVirtualIPRequest) Execute() error {
	var (
		localVarHTTPMethod = http.MethodDelete
		localVarPostBody   interface{}
		formFiles          []formFile
	...
	localBasePath, err := client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.DeleteVirtualIP")
	if err != nil {
		return &oapierror.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
func (r GetProjectNICRequest) Execute() (*NIC, error) {
	...
	localVarPath := localBasePath + "/v1alpha1/projects/{projectId}/nics/{nicId}"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(ParameterValueToString(r.projectId, "projectId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"nicId"+"}", url.PathEscape(ParameterValueToString(r.nicId, "nicId")), -1)
...
func (r GetVirtualIPRequest) Execute() (*VirtualIp, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.GetVirtualIP")
	if err != nil {
		return localVarReturnValue, &oapierror.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
func (r ListAvailabilityZonesRequest) Execute() (*AvailabilityZoneListResponse, error) {
	...
	localVarPath := localBasePath + "/v1alpha1/availability-zones"
...
func (r ListProjectNICsRequest) Execute() (*NICListResponse, error) {
	...
	localVarPath := localBasePath + "/v1alpha1/projects/{projectId}/nics"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(ParameterValueToString(r.projectId, "projectId")), -1)
...
func (r ListQuotasRequest) Execute() (*QuotaListResponse, error) {
	...
	localVarPath := localBasePath + "/v1alpha1/projects/{projectId}/quotas"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(ParameterValueToString(r.projectId, "projectId")), -1)
...
type ListVirtualIPsRequest struct {
	ctx           context.Context
	apiService    *DefaultApiService
	projectId     string
	networkId     string
...
func (r ListVirtualIPsRequest) LabelSelector(labelSelector string) ApiListVirtualIPsRequest {
	r.labelSelector = &labelSelector
	return r
}

func (r ListVirtualIPsRequest) Execute() (*VirtualIpListResponse, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.ListVirtualIPs")
	if err != nil {
		return localVarReturnValue, &oapierror.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
type RemoveMemberFromVirtualIPRequest struct {
	ctx                              context.Context
	apiService                       *DefaultApiService
	projectId                        string
	networkId                        string
...
func (r RemoveMemberFromVirtualIPRequest) RemoveMemberFromVirtualIPPayload(removeMemberFromVirtualIPPayload RemoveMemberFromVirtualIPPayload) ApiRemoveMemberFromVirtualIPRequest {
	r.removeMemberFromVirtualIPPayload = &removeMemberFromVirtualIPPayload
	return r
}

func (r RemoveMemberFromVirtualIPRequest) Execute() (*VirtualIp, error) {
	var (
		localVarHTTPMethod  = http.MethodPut
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.RemoveMemberFromVirtualIP")
	if err != nil {
		return localVarReturnValue, &oapierror.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
func (a *APIClient) RemoveMemberFromVirtualIP(ctx context.Context, projectId string, networkId string, virtualIpId string) ApiRemoveMemberFromVirtualIPRequest {
	return RemoveMemberFromVirtualIPRequest{
		apiService:  a.defaultApi,
		ctx:         ctx,
		projectId:   projectId,
		networkId:   networkId,
...
func (a *APIClient) RemoveMemberFromVirtualIPExecute(ctx context.Context, projectId string, networkId string, virtualIpId string) (*VirtualIp, error) {
	r := RemoveMemberFromVirtualIPRequest{
		apiService:  a.defaultApi,
		ctx:         ctx,
		projectId:   projectId,
		networkId:   networkId,
...
func (r RestoreBackupRequest) Execute() error {
	...
	localVarPath := localBasePath + "/v1alpha1/projects/{projectId}/backups/{backupId}/restore"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(ParameterValueToString(r.projectId, "projectId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"backupId"+"}", url.PathEscape(ParameterValueToString(r.backupId, "backupId")), -1)
...
func (r UpdateImageScopeLocalRequest) Execute() (*Image, error) {
	...
	localVarPath := localBasePath + "/v1alpha1/projects/{projectId}/images/{imageId}/publish"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(ParameterValueToString(r.projectId, "projectId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"imageId"+"}", url.PathEscape(ParameterValueToString(r.imageId, "imageId")), -1)
...
func (r UpdateVirtualIPRequest) UpdateVirtualIPPayload(updateVirtualIPPayload UpdateVirtualIPPayload) ApiUpdateVirtualIPRequest {
	r.updateVirtualIPPayload = &updateVirtualIPPayload
	return r
}

func (r UpdateVirtualIPRequest) Execute() error {
	var (
		localVarHTTPMethod = http.MethodPatch
		localVarPostBody   interface{}
		formFiles          []formFile
	...
	localBasePath, err := client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.UpdateVirtualIP")
	if err != nil {
		return &oapierror.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
type V1alpha1UpdateRouteOfAreaRequest struct {
	ctx                              context.Context
	apiService                       *DefaultApiService
	organizationId                   string
	areaId                           string
...
func (r V1alpha1UpdateRouteOfAreaRequest) V1alpha1UpdateRouteOfAreaPayload(v1alpha1UpdateRouteOfAreaPayload V1alpha1UpdateRouteOfAreaPayload) ApiV1alpha1UpdateRouteOfAreaRequest {
	r.v1alpha1UpdateRouteOfAreaPayload = &v1alpha1UpdateRouteOfAreaPayload
	return r
}

func (r V1alpha1UpdateRouteOfAreaRequest) Execute() (*Route, error) {
	var (
		localVarHTTPMethod  = http.MethodPatch
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.V1alpha1UpdateRouteOfArea")
	if err != nil {
		return localVarReturnValue, &oapierror.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
	...
	if r.v1alpha1UpdateRouteOfAreaPayload == nil {
		return localVarReturnValue, fmt.Errorf("v1alpha1UpdateRouteOfAreaPayload is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.v1alpha1UpdateRouteOfAreaPayload
	req, err := client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, err
	}
...
Update a network route defined in a network area.
	...
	@return ApiV1alpha1UpdateRouteOfAreaRequest
*/
func (a *APIClient) V1alpha1UpdateRouteOfArea(ctx context.Context, organizationId string, areaId string, routeId string) ApiV1alpha1UpdateRouteOfAreaRequest {
	return V1alpha1UpdateRouteOfAreaRequest{
		apiService:     a.defaultApi,
		ctx:            ctx,
		organizationId: organizationId,
		areaId:         areaId,
...
func (a *APIClient) V1alpha1UpdateRouteOfAreaExecute(ctx context.Context, organizationId string, areaId string, routeId string) (*Route, error) {
	r := V1alpha1UpdateRouteOfAreaRequest{
		apiService:     a.defaultApi,
		ctx:            ctx,
		organizationId: organizationId,
		areaId:         areaId,
