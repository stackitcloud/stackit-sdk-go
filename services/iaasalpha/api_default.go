...
type ApiV1alpha1UpdateRouteOfAreaRequest struct {
	ctx                              context.Context
	apiService                       *DefaultApiService
	organizationId                   string
	areaId                           string
...
func (r ApiV1alpha1UpdateRouteOfAreaRequest) V1alpha1UpdateRouteOfAreaPayload(v1alpha1UpdateRouteOfAreaPayload V1alpha1UpdateRouteOfAreaPayload) ApiV1alpha1UpdateRouteOfAreaRequest {
	r.v1alpha1UpdateRouteOfAreaPayload = &v1alpha1UpdateRouteOfAreaPayload
	return r
}

func (r ApiV1alpha1UpdateRouteOfAreaRequest) Execute() (*Route, error) {
	var (
		localVarHTTPMethod  = http.MethodPatch
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	a := r.apiService
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.V1alpha1UpdateRouteOfArea")
	if err != nil {
		return localVarReturnValue, &oapierror.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
func (a *APIClient) V1alpha1UpdateRouteOfAreaExecute(ctx context.Context, organizationId string, areaId string, routeId string) (*Route, error) {
	r := ApiV1alpha1UpdateRouteOfAreaRequest{
		apiService:     a.defaultApi,
		ctx:            ctx,
		organizationId: organizationId,
		areaId:         areaId,
