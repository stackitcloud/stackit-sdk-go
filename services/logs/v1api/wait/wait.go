...
func CreateLogsInstanceWaitHandler(ctx context.Context, client logs.DefaultAPI, projectID string, region logs.ListLogsInstancesRegionIdParameter, instanceID string) *wait.AsyncActionHandler[logs.LogsInstance] {
...
func DeleteLogsInstanceWaitHandler(ctx context.Context, client logs.DefaultAPI, projectID string, region logs.ListLogsInstancesRegionIdParameter, instanceID string) *wait.AsyncActionHandler[logs.LogsInstance] {
	waitConfig := wait.WaiterHelper[logs.LogsInstance, logs.LogsInstanceStatus]{
		FetchInstance: client.GetLogsInstance(ctx, projectID, region, instanceID).Execute,
		GetState: func(l *logs.LogsInstance) (logs.LogsInstanceStatus, error) {
			if l == nil {
