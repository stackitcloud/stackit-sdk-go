...
func (a *DefaultAPIService) CreateAccessTokenExecute(r ApiCreateAccessTokenRequest) (*AccessToken, *http.Response, error) {
	...
	localVarPath := localBasePath + "/v1beta/projects/{projectId}/regions/{regionId}/instances/{instanceId}/access-tokens"
...
func (a *DefaultAPIService) CreateLogsInstanceExecute(r ApiCreateLogsInstanceRequest) (*LogsInstance, *http.Response, error) {
	...
	localVarPath := localBasePath + "/v1beta/projects/{projectId}/regions/{regionId}/instances"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(parameterValueToString(r.projectId, "projectId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"regionId"+"}", url.PathEscape(parameterValueToString(r.regionId, "regionId")), -1)
...
func (a *DefaultAPIService) DeleteAccessTokenExecute(r ApiDeleteAccessTokenRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/v1beta/projects/{projectId}/regions/{regionId}/instances/{instanceId}/access-tokens/{tId}"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(parameterValueToString(r.projectId, "projectId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"regionId"+"}", url.PathEscape(parameterValueToString(r.regionId, "regionId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"instanceId"+"}", url.PathEscape(parameterValueToString(r.instanceId, "instanceId")), -1)
...
func (a *DefaultAPIService) DeleteAllExpiredAccessTokensExecute(r ApiDeleteAllExpiredAccessTokensRequest) (*AccessTokenList, *http.Response, error) {
	...
	localVarPath := localBasePath + "/v1beta/projects/{projectId}/regions/{regionId}/instances/{instanceId}/access-tokens/expired"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(parameterValueToString(r.projectId, "projectId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"regionId"+"}", url.PathEscape(parameterValueToString(r.regionId, "regionId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"instanceId"+"}", url.PathEscape(parameterValueToString(r.instanceId, "instanceId")), -1)
