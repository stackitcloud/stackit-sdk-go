...
func NewCreateKeyPayload(algorithm CreateKeyPayloadGetAlgorithmArgType, displayName CreateKeyPayloadGetDisplayNameArgType, protection CreateKeyPayloadGetProtectionArgType, purpose CreateKeyPayloadGetPurposeArgType) *CreateKeyPayload {
	...
	setCreateKeyPayloadGetProtectionAttributeType(&this.Protection, protection)
