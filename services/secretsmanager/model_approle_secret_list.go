...
/*
	types and functions for secretIds
*/
...
// Deprecated: Will be removed after 2026-09-30. Move to the packages generated for each available API version instead
func getApproleSecretListGetSecretIdsAttributeTypeOk(arg ApproleSecretListGetSecretIdsAttributeType) (ret ApproleSecretListGetSecretIdsRetType, ok bool) {
	if arg == nil {
		return ret, false
	}
	return *arg, true
...
// Deprecated: Will be removed after 2026-09-30. Move to the packages generated for each available API version instead
func setApproleSecretListGetSecretIdsAttributeType(arg *ApproleSecretListGetSecretIdsAttributeType, val ApproleSecretListGetSecretIdsRetType) {
	*arg = &val
}
...
func NewApproleSecretList(secretIds ApproleSecretListGetSecretIdsArgType) *ApproleSecretList {
	...
	setApproleSecretListGetSecretIdsAttributeType(&this.SecretIds, secretIds)
	return &this
}
...
func (o *ApproleSecretList) GetSecretIdsOk() (ret ApproleSecretListGetSecretIdsRetType, ok bool) {
	return getApproleSecretListGetSecretIdsAttributeTypeOk(o.SecretIds)
}

// SetSecretIds sets field value
// Deprecated: Will be removed after 2026-09-30. Move to the packages generated for each available API version instead
func (o *ApproleSecretList) SetSecretIds(v ApproleSecretListGetSecretIdsRetType) {
	setApproleSecretListGetSecretIdsAttributeType(&o.SecretIds, v)
}

// Deprecated: Will be removed after 2026-09-30. Move to the packages generated for each available API version instead
func (o ApproleSecretList) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if val, ok := getApproleSecretListGetSecretIdsAttributeTypeOk(o.SecretIds); ok {
		toSerialize["SecretIds"] = val
	}
