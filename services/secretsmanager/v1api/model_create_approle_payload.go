...
func (o *CreateApprolePayload) UnmarshalJSON(data []byte) (err error) {
	varCreateApprolePayload := _CreateApprolePayload{}

	err = json.Unmarshal(data, &varCreateApprolePayload)

	if err != nil {
		return err
	}

	*o = CreateApprolePayload(varCreateApprolePayload)
