...
func (r ApiListFolderAuditLogEntriesRequest) Execute() (*ListAuditLogEntriesResponse, error) {
...
func (a *DefaultAPIService) ListFolderAuditLogEntriesExecute(r ApiListFolderAuditLogEntriesRequest) (*ListAuditLogEntriesResponse, error) {
	...
	if r.startTimeRange == nil {
		return localVarReturnValue, reportError("startTimeRange is required and must be specified")
	}
	if r.endTimeRange == nil {
		return localVarReturnValue, reportError("endTimeRange is required and must be specified")
	}
...
func (r ApiListOrganizationAuditLogEntriesRequest) Execute() (*ListAuditLogEntriesResponse, error) {
...
func (r ApiListProjectAuditLogEntriesRequest) Execute() (*ListAuditLogEntriesResponse, error) {
