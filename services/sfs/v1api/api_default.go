...
type DefaultAPI interface {
	...
	*/
	...
	//  @return map[string]interface{}
	EnableLockExecute(r ApiEnableLockRequest) (map[string]interface{}, error)
...
func (r ApiEnableLockRequest) Execute() (map[string]interface{}, error) {
...
//
//	@return map[string]interface{}
func (a *DefaultAPIService) EnableLockExecute(r ApiEnableLockRequest) (map[string]interface{}, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
