...
type DefaultApi interface {
	...
	*/
	...
	/*
		...
		// Deprecated: Will be removed after 2026-09-30. Move to the packages generated for each available API version instead
	*/
	EnableLockExecute(ctx context.Context, region string, projectId string) (map[string]interface{}, error)
	/*
...
// Deprecated: Will be removed after 2026-09-30. Move to the packages generated for each available API version instead
func (r EnableLockRequest) Execute() (map[string]interface{}, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
...
// Deprecated: Will be removed after 2026-09-30. Move to the packages generated for each available API version instead
func (a *APIClient) EnableLockExecute(ctx context.Context, region string, projectId string) (map[string]interface{}, error) {
	r := EnableLockRequest{
		apiService: a.defaultApi,
		ctx:        ctx,
		region:     region,
