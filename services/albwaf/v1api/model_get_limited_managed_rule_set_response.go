...
func NewGetLimitedManagedRuleSetResponse(name string, types Type, version string) *GetLimitedManagedRuleSetResponse {
...
func (o *GetLimitedManagedRuleSetResponse) GetType() Type {
	if o == nil {
		var ret Type
		return ret
	}
