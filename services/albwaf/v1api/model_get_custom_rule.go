...
type GetCustomRule struct {
	Behavior *GetBehavior `json:"behavior,omitempty"`
...
func NewGetCustomRule(description string, id int32) *GetCustomRule {
	this := GetCustomRule{}
...
func (o *GetCustomRule) GetBehavior() GetBehavior {
...
func (o *GetCustomRule) GetBehaviorOk() (*GetBehavior, bool) {
	if o == nil || IsNil(o.Behavior) {
		return nil, false
	}
...
func (o *GetCustomRule) HasBehavior() bool {
	if o != nil && !IsNil(o.Behavior) {
		return true
	}
...
// SetBehavior gets a reference to the given GetBehavior and assigns it to the Behavior field.
func (o *GetCustomRule) SetBehavior(v GetBehavior) {
	o.Behavior = &v
}
