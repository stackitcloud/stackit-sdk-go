...
type DefaultAPIServiceMock struct {
	...
	CreateCoreRuleSetExecuteMock *func(r ApiCreateCoreRuleSetRequest) (*CreateCoreRuleSetResponse, *http.Response, error)
	// CreateRulesExecuteMock can be populated to implement the behavior of the CreateRulesExecute function of this mock
	CreateRulesExecuteMock *func(r ApiCreateRulesRequest) (*CreateRulesResponse, *http.Response, error)
	// CreateWAFExecuteMock can be populated to implement the behavior of the CreateWAFExecute function of this mock
	CreateWAFExecuteMock *func(r ApiCreateWAFRequest) (*CreateWAFResponse, *http.Response, error)
	...
	ListCoreRuleSetsExecuteMock *func(r ApiListCoreRuleSetsRequest) (*ListCoreRuleSetResponse, *http.Response, error)
	// ListRulesExecuteMock can be populated to implement the behavior of the ListRulesExecute function of this mock
	ListRulesExecuteMock *func(r ApiListRulesRequest) (*ListRulesResponse, *http.Response, error)
	// ListWAFExecuteMock can be populated to implement the behavior of the ListWAFExecute function of this mock
	ListWAFExecuteMock *func(r ApiListWAFRequest) (*ListWAFResponse, *http.Response, error)
	...
	UpdateCoreRuleSetExecuteMock *func(r ApiUpdateCoreRuleSetRequest) (*UpdateCoreRuleSetResponse, *http.Response, error)
	// UpdateRulesExecuteMock can be populated to implement the behavior of the UpdateRulesExecute function of this mock
	UpdateRulesExecuteMock *func(r ApiUpdateRulesRequest) (*UpdateRulesResponse, *http.Response, error)
	// UpdateWAFExecuteMock can be populated to implement the behavior of the UpdateWAFExecute function of this mock
	UpdateWAFExecuteMock *func(r ApiUpdateWAFRequest) (*UpdateWAFResponse, *http.Response, error)
}
...
func (a DefaultAPIServiceMock) CreateCoreRuleSetExecute(r ApiCreateCoreRuleSetRequest) (*CreateCoreRuleSetResponse, *http.Response, error) {
...
func (a DefaultAPIServiceMock) CreateRulesExecute(r ApiCreateRulesRequest) (*CreateRulesResponse, *http.Response, error) {
...
func (a DefaultAPIServiceMock) CreateWAFExecute(r ApiCreateWAFRequest) (*CreateWAFResponse, *http.Response, error) {
...
func (a DefaultAPIServiceMock) DeleteCoreRuleSetExecute(r ApiDeleteCoreRuleSetRequest) (map[string]interface{}, *http.Response, error) {
...
func (a DefaultAPIServiceMock) DeleteRulesExecute(r ApiDeleteRulesRequest) (map[string]interface{}, *http.Response, error) {
...
func (a DefaultAPIServiceMock) DeleteWAFExecute(r ApiDeleteWAFRequest) (map[string]interface{}, *http.Response, error) {
...
func (a DefaultAPIServiceMock) GetCoreRuleSetExecute(r ApiGetCoreRuleSetRequest) (*GetCoreRuleSetResponse, *http.Response, error) {
...
func (a DefaultAPIServiceMock) GetRulesExecute(r ApiGetRulesRequest) (*GetRulesResponse, *http.Response, error) {
...
func (a DefaultAPIServiceMock) GetWAFExecute(r ApiGetWAFRequest) (*GetWAFResponse, *http.Response, error) {
...
func (a DefaultAPIServiceMock) ListCoreRuleSetsExecute(r ApiListCoreRuleSetsRequest) (*ListCoreRuleSetResponse, *http.Response, error) {
...
func (a DefaultAPIServiceMock) ListRulesExecute(r ApiListRulesRequest) (*ListRulesResponse, *http.Response, error) {
...
func (a DefaultAPIServiceMock) ListWAFExecute(r ApiListWAFRequest) (*ListWAFResponse, *http.Response, error) {
...
func (a DefaultAPIServiceMock) UpdateCoreRuleSetExecute(r ApiUpdateCoreRuleSetRequest) (*UpdateCoreRuleSetResponse, *http.Response, error) {
...
func (a DefaultAPIServiceMock) UpdateRulesExecute(r ApiUpdateRulesRequest) (*UpdateRulesResponse, *http.Response, error) {
...
func (a DefaultAPIServiceMock) UpdateWAFExecute(r ApiUpdateWAFRequest) (*UpdateWAFResponse, *http.Response, error) {
