...
// checks if the MRSConfigQuota type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MRSConfigQuota{}
...
type _MRSConfigQuota MRSConfigQuota

// NewMRSConfigQuota instantiates a new MRSConfigQuota object
...
// NewMRSConfigQuotaWithDefaults instantiates a new MRSConfigQuota object
...
func (o *MRSConfigQuota) UnmarshalJSON(data []byte) (err error) {
	varMRSConfigQuota := _MRSConfigQuota{}

	err = json.Unmarshal(data, &varMRSConfigQuota)

	if err != nil {
		return err
	}

	*o = MRSConfigQuota(varMRSConfigQuota)
...
func NewNullableMRSConfigQuota(val *MRSConfigQuota) *NullableMRSConfigQuota {
	return &NullableMRSConfigQuota{value: val, isSet: true}
}
