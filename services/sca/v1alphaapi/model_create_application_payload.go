...
// checks if the CreateApplicationPayload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateApplicationPayload{}
...
type _CreateApplicationPayload CreateApplicationPayload

// NewCreateApplicationPayload instantiates a new CreateApplicationPayload object
...
// NewCreateApplicationPayloadWithDefaults instantiates a new CreateApplicationPayload object
...
func (o *CreateApplicationPayload) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateApplicationPayload := _CreateApplicationPayload{}

	err = json.Unmarshal(data, &varCreateApplicationPayload)

	if err != nil {
		return err
	}

	*o = CreateApplicationPayload(varCreateApplicationPayload)
...
func NewNullableCreateApplicationPayload(val *CreateApplicationPayload) *NullableCreateApplicationPayload {
	return &NullableCreateApplicationPayload{value: val, isSet: true}
}
