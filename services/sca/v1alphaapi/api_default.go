...
func (r ApiCreateEnvironmentRequest) CreateEnvironmentPayload(createEnvironmentPayload CreateEnvironmentPayload) ApiCreateEnvironmentRequest {
	r.createEnvironmentPayload = &createEnvironmentPayload
	return r
}
...
func (a *DefaultAPIService) CreateEnvironmentExecute(r ApiCreateEnvironmentRequest) (*Environment, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultAPIService.CreateEnvironment")
	if err != nil {
		return localVarReturnValue, &oapierror.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/v1alpha/projects/{projectId}/environments"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(parameterValueToString(r.projectId, "projectId")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.createEnvironmentPayload == nil {
		return localVarReturnValue, reportError("createEnvironmentPayload is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.createEnvironmentPayload
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, err
	}
...
func (a *DefaultAPIService) GetEnvironmentExecute(r ApiGetEnvironmentRequest) (*Environment, error) {
	...
	localVarPath := localBasePath + "/v1alpha/projects/{projectId}/environments/{environmentId}"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(parameterValueToString(r.projectId, "projectId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"environmentId"+"}", url.PathEscape(parameterValueToString(r.environmentId, "environmentId")), -1)
...
func (r ApiListProjectApplicationsRequest) Execute() (*ListApplicationsResponse, error) {
	return r.ApiService.ListProjectApplicationsExecute(r)
}
...
func (a *DefaultAPIService) ListProjectApplicationsExecute(r ApiListProjectApplicationsRequest) (*ListApplicationsResponse, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultAPIService.ListProjectApplications")
	if err != nil {
		return localVarReturnValue, &oapierror.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/v1alpha/projects/{projectId}/applications"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(parameterValueToString(r.projectId, "projectId")), -1)
