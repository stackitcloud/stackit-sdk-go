...
func (a DefaultAPIServiceMock) CreateEnvironmentExecute(r ApiCreateEnvironmentRequest) (*Environment, error) {
	if a.CreateEnvironmentExecuteMock == nil {
		var localVarReturnValue *Environment
		return localVarReturnValue, nil
	}

	return (*a.CreateEnvironmentExecuteMock)(r)
}
...
func (a DefaultAPIServiceMock) GetEnvironmentExecute(r ApiGetEnvironmentRequest) (*Environment, error) {
	if a.GetEnvironmentExecuteMock == nil {
		var localVarReturnValue *Environment
		return localVarReturnValue, nil
	}

	return (*a.GetEnvironmentExecuteMock)(r)
}
...
func (a DefaultAPIServiceMock) ListEnvironmentsExecute(r ApiListEnvironmentsRequest) (*ListEnvironmentsResponse, error) {
	if a.ListEnvironmentsExecuteMock == nil {
		var localVarReturnValue *ListEnvironmentsResponse
		return localVarReturnValue, nil
	}

	return (*a.ListEnvironmentsExecuteMock)(r)
}
...
func (a DefaultAPIServiceMock) ListProjectApplicationsExecute(r ApiListProjectApplicationsRequest) (*ListApplicationsResponse, error) {
	if a.ListProjectApplicationsExecuteMock == nil {
		var localVarReturnValue *ListApplicationsResponse
		return localVarReturnValue, nil
	}

	return (*a.ListProjectApplicationsExecuteMock)(r)
}
