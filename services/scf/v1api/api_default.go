...
type DefaultAPI interface {
	...
	*/
	...
	ApplyOrganizationQuotaExecute(r ApiApplyOrganizationQuotaRequest) (*OrganizationQuota, *http.Response, error)
	...
	*/
	...
	CreateOrgManagerExecute(r ApiCreateOrgManagerRequest) (*OrgManagerResponse, *http.Response, error)
	...
	*/
	...
	CreateOrgRoleExecute(r ApiCreateOrgRoleRequest) (*OrgRoleResponse, *http.Response, error)
	...
	*/
	...
	CreateOrganizationExecute(r ApiCreateOrganizationRequest) (*OrganizationCreateResponse, *http.Response, error)
	...
	*/
	...
	//  @return Space
	CreateSpaceExecute(r ApiCreateSpaceRequest) (*Space, *http.Response, error)
	...
	*/
	...
	CreateSpaceRoleExecute(r ApiCreateSpaceRoleRequest) (*SpaceRoleCreateResponse, *http.Response, error)
	...
	*/
	...
	DeleteOrgManagerExecute(r ApiDeleteOrgManagerRequest) (*OrgManagerDeleteResponse, *http.Response, error)
	...
	*/
	...
	DeleteOrganizationExecute(r ApiDeleteOrganizationRequest) (*OrganizationDeleteResponse, *http.Response, error)
	...
	*/
	...
	DeleteSpaceExecute(r ApiDeleteSpaceRequest) (*SpaceDeleteResponse, *http.Response, error)
	...
	*/
	...
	//  @return OrgManager
	GetOrgManagerExecute(r ApiGetOrgManagerRequest) (*OrgManager, *http.Response, error)
	...
	*/
	...
	//  @return Quota
	GetOrganizationQuotaExecute(r ApiGetOrganizationQuotaRequest) (*Quota, *http.Response, error)
	...
	*/
	...
	GetOrganizationUsageSummaryExecute(r ApiGetOrganizationUsageSummaryRequest) (*OrganizationUsageSummary, *http.Response, error)
	...
	*/
	...
	//  @return Platforms
	GetPlatformExecute(r ApiGetPlatformRequest) (*Platforms, *http.Response, error)
	...
	*/
	...
	//  @return Quota
	GetPlatformQuotaExecute(r ApiGetPlatformQuotaRequest) (*Quota, *http.Response, error)
	...
	*/
	...
	//  @return Space
	GetSpaceExecute(r ApiGetSpaceRequest) (*Space, *http.Response, error)
	...
	*/
	...
	//  @return []Quota
	ListOrganizationQuotasExecute(r ApiListOrganizationQuotasRequest) ([]Quota, *http.Response, error)
	...
	*/
	...
	ListOrganizationsExecute(r ApiListOrganizationsRequest) (*OrganizationsList, *http.Response, error)
	...
	*/
	...
	//  @return []Quota
	ListPlatformQuotasExecute(r ApiListPlatformQuotasRequest) ([]Quota, *http.Response, error)
	...
	*/
	...
	//  @return PlatformList
	ListPlatformsExecute(r ApiListPlatformsRequest) (*PlatformList, *http.Response, error)
	...
	*/
	...
	//  @return SpacesList
	ListSpacesExecute(r ApiListSpacesRequest) (*SpacesList, *http.Response, error)
	...
	*/
	...
	//  @return Space
	UpdateSpaceExecute(r ApiUpdateSpaceRequest) (*Space, *http.Response, error)
}
...
func (r ApiApplyOrganizationQuotaRequest) Execute() (*OrganizationQuota, *http.Response, error) {
...
//
//	@return OrganizationQuota
func (a *DefaultAPIService) ApplyOrganizationQuotaExecute(r ApiApplyOrganizationQuotaRequest) (*OrganizationQuota, *http.Response, error) {
	var (
	...
	if r.applyOrganizationQuotaPayload == nil {
		return localVarReturnValue, nil, reportError("applyOrganizationQuotaPayload is required and must be specified")
	}
...
func (r ApiCreateOrgManagerRequest) Execute() (*OrgManagerResponse, *http.Response, error) {
...
//
//	@return OrgManagerResponse
func (a *DefaultAPIService) CreateOrgManagerExecute(r ApiCreateOrgManagerRequest) (*OrgManagerResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiCreateOrgRoleRequest) Execute() (*OrgRoleResponse, *http.Response, error) {
...
//
//	@return OrgRoleResponse
func (a *DefaultAPIService) CreateOrgRoleExecute(r ApiCreateOrgRoleRequest) (*OrgRoleResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	if r.createOrgRolePayload == nil {
		return localVarReturnValue, nil, reportError("createOrgRolePayload is required and must be specified")
	}
...
func (r ApiCreateOrganizationRequest) Execute() (*OrganizationCreateResponse, *http.Response, error) {
...
//
//	@return OrganizationCreateResponse
func (a *DefaultAPIService) CreateOrganizationExecute(r ApiCreateOrganizationRequest) (*OrganizationCreateResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	if r.createOrganizationPayload == nil {
		return localVarReturnValue, nil, reportError("createOrganizationPayload is required and must be specified")
	}
...
func (r ApiCreateSpaceRequest) Execute() (*Space, *http.Response, error) {
...
//
//	@return Space
func (a *DefaultAPIService) CreateSpaceExecute(r ApiCreateSpaceRequest) (*Space, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	if r.createSpacePayload == nil {
		return localVarReturnValue, nil, reportError("createSpacePayload is required and must be specified")
	}
...
func (r ApiCreateSpaceRoleRequest) Execute() (*SpaceRoleCreateResponse, *http.Response, error) {
...
//
//	@return SpaceRoleCreateResponse
func (a *DefaultAPIService) CreateSpaceRoleExecute(r ApiCreateSpaceRoleRequest) (*SpaceRoleCreateResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	if r.createSpaceRolePayload == nil {
		return localVarReturnValue, nil, reportError("createSpaceRolePayload is required and must be specified")
	}
...
func (r ApiDeleteOrgManagerRequest) Execute() (*OrgManagerDeleteResponse, *http.Response, error) {
...
//
//	@return OrgManagerDeleteResponse
func (a *DefaultAPIService) DeleteOrgManagerExecute(r ApiDeleteOrgManagerRequest) (*OrgManagerDeleteResponse, *http.Response, error) {
	var (
...
func (r ApiDeleteOrganizationRequest) Execute() (*OrganizationDeleteResponse, *http.Response, error) {
...
//
//	@return OrganizationDeleteResponse
func (a *DefaultAPIService) DeleteOrganizationExecute(r ApiDeleteOrganizationRequest) (*OrganizationDeleteResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodDelete
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiDeleteSpaceRequest) Execute() (*SpaceDeleteResponse, *http.Response, error) {
...
//
//	@return SpaceDeleteResponse
func (a *DefaultAPIService) DeleteSpaceExecute(r ApiDeleteSpaceRequest) (*SpaceDeleteResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodDelete
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiGetOrgManagerRequest) Execute() (*OrgManager, *http.Response, error) {
...
//
//	@return OrgManager
func (a *DefaultAPIService) GetOrgManagerExecute(r ApiGetOrgManagerRequest) (*OrgManager, *http.Response, error) {
	var (
...
func (r ApiGetOrganizationQuotaRequest) Execute() (*Quota, *http.Response, error) {
...
//
//	@return Quota
func (a *DefaultAPIService) GetOrganizationQuotaExecute(r ApiGetOrganizationQuotaRequest) (*Quota, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiGetOrganizationUsageSummaryRequest) Execute() (*OrganizationUsageSummary, *http.Response, error) {
...
//
//	@return OrganizationUsageSummary
func (a *DefaultAPIService) GetOrganizationUsageSummaryExecute(r ApiGetOrganizationUsageSummaryRequest) (*OrganizationUsageSummary, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiGetPlatformRequest) Execute() (*Platforms, *http.Response, error) {
...
//
//	@return Platforms
func (a *DefaultAPIService) GetPlatformExecute(r ApiGetPlatformRequest) (*Platforms, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiGetPlatformQuotaRequest) Execute() (*Quota, *http.Response, error) {
...
//
//	@return Quota
func (a *DefaultAPIService) GetPlatformQuotaExecute(r ApiGetPlatformQuotaRequest) (*Quota, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiGetSpaceRequest) Execute() (*Space, *http.Response, error) {
...
//
//	@return Space
func (a *DefaultAPIService) GetSpaceExecute(r ApiGetSpaceRequest) (*Space, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiListOrganizationQuotasRequest) Execute() ([]Quota, *http.Response, error) {
...
//
//	@return []Quota
func (a *DefaultAPIService) ListOrganizationQuotasExecute(r ApiListOrganizationQuotasRequest) ([]Quota, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiListOrganizationsRequest) Execute() (*OrganizationsList, *http.Response, error) {
...
//
//	@return OrganizationsList
func (a *DefaultAPIService) ListOrganizationsExecute(r ApiListOrganizationsRequest) (*OrganizationsList, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiListPlatformQuotasRequest) Execute() ([]Quota, *http.Response, error) {
...
//
//	@return []Quota
func (a *DefaultAPIService) ListPlatformQuotasExecute(r ApiListPlatformQuotasRequest) ([]Quota, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiListPlatformsRequest) Execute() (*PlatformList, *http.Response, error) {
...
//
//	@return PlatformList
func (a *DefaultAPIService) ListPlatformsExecute(r ApiListPlatformsRequest) (*PlatformList, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiListSpacesRequest) Execute() (*SpacesList, *http.Response, error) {
...
//
//	@return SpacesList
func (a *DefaultAPIService) ListSpacesExecute(r ApiListSpacesRequest) (*SpacesList, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (a *DefaultAPIService) UpdateOrganizationExecute(r ApiUpdateOrganizationRequest) (*Organization, *http.Response, error) {
	...
	if r.updateOrganizationPayload == nil {
		return localVarReturnValue, nil, reportError("updateOrganizationPayload is required and must be specified")
	}
...
func (r ApiUpdateSpaceRequest) Execute() (*Space, *http.Response, error) {
...
//
//	@return Space
func (a *DefaultAPIService) UpdateSpaceExecute(r ApiUpdateSpaceRequest) (*Space, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPatch
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	if r.updateSpacePayload == nil {
		return localVarReturnValue, nil, reportError("updateSpacePayload is required and must be specified")
	}
