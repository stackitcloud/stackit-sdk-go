...
func (o *UnauthorizedErrorResponse) GetStatus() int64 {
...
// and a boolean to check if the value has been set.
func (o *UnauthorizedErrorResponse) GetStatusOk() (*int64, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *UnauthorizedErrorResponse) SetStatus(v int64) {
	o.Status = &v
}
