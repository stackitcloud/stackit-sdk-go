...
func (o *SetDefaultRetentionPayload) UnmarshalJSON(data []byte) (err error) {
	...
	varSetDefaultRetentionPayload := _SetDefaultRetentionPayload{}

	err = json.Unmarshal(data, &varSetDefaultRetentionPayload)

	if err != nil {
		return err
	}

	*o = SetDefaultRetentionPayload(varSetDefaultRetentionPayload)
