...
type _IntakeCatalogPatch IntakeCatalogPatch
...
func (o *IntakeCatalogPatch) UnmarshalJSON(data []byte) (err error) {
	varIntakeCatalogPatch := _IntakeCatalogPatch{}

	err = json.Unmarshal(data, &varIntakeCatalogPatch)

	if err != nil {
		return err
	}

	*o = IntakeCatalogPatch(varIntakeCatalogPatch)
