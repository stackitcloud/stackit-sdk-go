...
// checks if the GetInstanceTokenResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetInstanceTokenResponse{}
...
type _GetInstanceTokenResponse GetInstanceTokenResponse

// NewGetInstanceTokenResponse instantiates a new GetInstanceTokenResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewGetInstanceTokenResponse(token TokenMetadata) *GetInstanceTokenResponse {
	this := GetInstanceTokenResponse{}
	this.Token = token
	return &this
}

// NewGetInstanceTokenResponseWithDefaults instantiates a new GetInstanceTokenResponse object
...
func (o *GetInstanceTokenResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varGetInstanceTokenResponse := _GetInstanceTokenResponse{}

	err = json.Unmarshal(data, &varGetInstanceTokenResponse)

	if err != nil {
		return err
	}

	*o = GetInstanceTokenResponse(varGetInstanceTokenResponse)
...
type NullableGetInstanceTokenResponse struct {
	value *GetInstanceTokenResponse
	isSet bool
}
...
func NewNullableGetInstanceTokenResponse(val *GetInstanceTokenResponse) *NullableGetInstanceTokenResponse {
	return &NullableGetInstanceTokenResponse{value: val, isSet: true}
}
