...
// checks if the ListInstanceTokensResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListInstanceTokensResponse{}
...
type _ListInstanceTokensResponse ListInstanceTokensResponse

// NewListInstanceTokensResponse instantiates a new ListInstanceTokensResponse object
...
func NewListInstanceTokensResponse(tokens []TokenMetadata) *ListInstanceTokensResponse {
	this := ListInstanceTokensResponse{}
	this.Tokens = tokens
	return &this
}

// NewListInstanceTokensResponseWithDefaults instantiates a new ListInstanceTokensResponse object
...
func (o *ListInstanceTokensResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varListInstanceTokensResponse := _ListInstanceTokensResponse{}

	err = json.Unmarshal(data, &varListInstanceTokensResponse)

	if err != nil {
		return err
	}

	*o = ListInstanceTokensResponse(varListInstanceTokensResponse)
...
type NullableListInstanceTokensResponse struct {
	value *ListInstanceTokensResponse
	isSet bool
}
...
func NewNullableListInstanceTokensResponse(val *ListInstanceTokensResponse) *NullableListInstanceTokensResponse {
	return &NullableListInstanceTokensResponse{value: val, isSet: true}
}
