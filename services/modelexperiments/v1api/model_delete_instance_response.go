...
// checks if the DeleteInstanceResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteInstanceResponse{}
...
type _DeleteInstanceResponse DeleteInstanceResponse

// NewDeleteInstanceResponse instantiates a new DeleteInstanceResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewDeleteInstanceResponse(instance Instance) *DeleteInstanceResponse {
	this := DeleteInstanceResponse{}
	this.Instance = instance
	return &this
}

// NewDeleteInstanceResponseWithDefaults instantiates a new DeleteInstanceResponse object
...
func (o *DeleteInstanceResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varDeleteInstanceResponse := _DeleteInstanceResponse{}

	err = json.Unmarshal(data, &varDeleteInstanceResponse)

	if err != nil {
		return err
	}

	*o = DeleteInstanceResponse(varDeleteInstanceResponse)
...
func NewNullableDeleteInstanceResponse(val *DeleteInstanceResponse) *NullableDeleteInstanceResponse {
	return &NullableDeleteInstanceResponse{value: val, isSet: true}
}
