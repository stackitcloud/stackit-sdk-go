...
type DefaultAPIServiceMock struct {
	...
	CreateInstanceTokenExecuteMock *func(r ApiCreateInstanceTokenRequest) (*CreateTokenResponse, error)
	...
	DeleteInstanceTokenExecuteMock *func(r ApiDeleteInstanceTokenRequest) (*DeleteTokenResponse, error)
	...
	GetInstanceTokenExecuteMock *func(r ApiGetInstanceTokenRequest) (*GetTokenResponse, error)
	...
	ListInstanceTokensExecuteMock *func(r ApiListInstanceTokensRequest) (*ListTokenResponse, error)
	// ListInstancesExecuteMock can be populated to implement the behavior of the ListInstancesExecute function of this mock
	ListInstancesExecuteMock *func(r ApiListInstancesRequest) (*ListInstanceResponse, error)
	...
	PartialUpdateInstanceTokenExecuteMock *func(r ApiPartialUpdateInstanceTokenRequest) (*PartialUpdateTokenResponse, error)
}
...
func (a DefaultAPIServiceMock) CreateInstanceTokenExecute(r ApiCreateInstanceTokenRequest) (*CreateTokenResponse, error) {
...
func (a DefaultAPIServiceMock) DeleteInstanceToken(ctx context.Context, projectId string, regionId string, tId string, instanceId string) ApiDeleteInstanceTokenRequest {
...
func (a DefaultAPIServiceMock) DeleteInstanceTokenExecute(r ApiDeleteInstanceTokenRequest) (*DeleteTokenResponse, error) {
	if a.DeleteInstanceTokenExecuteMock == nil {
		var localVarReturnValue *DeleteTokenResponse
		return localVarReturnValue, nil
	}
...
func (a DefaultAPIServiceMock) GetInstanceToken(ctx context.Context, projectId string, regionId string, tId string, instanceId string) ApiGetInstanceTokenRequest {
...
func (a DefaultAPIServiceMock) GetInstanceTokenExecute(r ApiGetInstanceTokenRequest) (*GetTokenResponse, error) {
...
func (a DefaultAPIServiceMock) ListInstanceTokensExecute(r ApiListInstanceTokensRequest) (*ListTokenResponse, error) {
	if a.ListInstanceTokensExecuteMock == nil {
		var localVarReturnValue *ListTokenResponse
		return localVarReturnValue, nil
	}
...
func (a DefaultAPIServiceMock) ListInstancesExecute(r ApiListInstancesRequest) (*ListInstanceResponse, error) {
	if a.ListInstancesExecuteMock == nil {
		var localVarReturnValue *ListInstanceResponse
		return localVarReturnValue, nil
	}
...
func (a DefaultAPIServiceMock) PartialUpdateInstanceToken(ctx context.Context, projectId string, regionId string, tId string, instanceId string) ApiPartialUpdateInstanceTokenRequest {
...
func (a DefaultAPIServiceMock) PartialUpdateInstanceTokenExecute(r ApiPartialUpdateInstanceTokenRequest) (*PartialUpdateTokenResponse, error) {
	if a.PartialUpdateInstanceTokenExecuteMock == nil {
		var localVarReturnValue *PartialUpdateTokenResponse
		return localVarReturnValue, nil
	}
