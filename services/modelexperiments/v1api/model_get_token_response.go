...
func NewGetTokenResponse(token TokenMetadata) *GetTokenResponse {
...
func (o *GetTokenResponse) GetToken() TokenMetadata {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *GetTokenResponse) GetTokenOk() (*TokenMetadata, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Token, true
...
func (o *GetTokenResponse) SetToken(v TokenMetadata) {
	o.Token = v
}
