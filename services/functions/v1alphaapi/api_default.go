...
type DefaultAPI interface {
	...
	*/
	...
	/*
		CreatePullSecret Create OCI image registry pull credential definition
	...
	*/
	...
	/*
		DeletePullSecret Remove OCI image registry pull credential definition

		Removes the OCI image pull secret registry configuration.

		@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
		@param projectId The STACKIT portal project UUID the resource is located in.
		@param pullCredentialId The identifier of the OCI registry pull secret configuration
		@return ApiDeletePullSecretRequest
	*/
	DeletePullSecret(ctx context.Context, projectId string, pullCredentialId string) ApiDeletePullSecretRequest
	...
	*/
	...
	/*
		GetPullSecret Get OCI image registry pull credential definition
	...
	*/
	GetPullSecret(ctx context.Context, projectId string, pullCredentialId string) ApiGetPullSecretRequest
	...
	*/
	...
	/*
		ListPullSecrets List OCI image registry pull credential definitions
	...
	*/
	...
	/*
		UpdatePullSecret Update OCI image registry pull credential definition
	...
	*/
	UpdatePullSecret(ctx context.Context, projectId string, pullCredentialId string) ApiUpdatePullSecretRequest
...
Removes the OCI image pull secret registry configuration.
	...
	@return ApiDeletePullSecretRequest
*/
func (a *DefaultAPIService) DeletePullSecret(ctx context.Context, projectId string, pullCredentialId string) ApiDeletePullSecretRequest {
	return ApiDeletePullSecretRequest{
		ApiService:       a,
		ctx:              ctx,
		projectId:        projectId,
...
Returns the current OCI image registry pull credential configuration.
	...
	@return ApiGetPullSecretRequest
*/
func (a *DefaultAPIService) GetPullSecret(ctx context.Context, projectId string, pullCredentialId string) ApiGetPullSecretRequest {
	return ApiGetPullSecretRequest{
		ApiService:       a,
		ctx:              ctx,
		projectId:        projectId,
...
Updates the OCI image registry pull credential configuration.
	...
	@return ApiUpdatePullSecretRequest
*/
func (a *DefaultAPIService) UpdatePullSecret(ctx context.Context, projectId string, pullCredentialId string) ApiUpdatePullSecretRequest {
	return ApiUpdatePullSecretRequest{
		ApiService:       a,
		ctx:              ctx,
		projectId:        projectId,
