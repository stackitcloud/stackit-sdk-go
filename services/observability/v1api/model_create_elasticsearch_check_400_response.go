...
func ArrayOfStringAsCreateElasticsearchCheck400Response(v *[]string) CreateElasticsearchCheck400Response {
	return CreateElasticsearchCheck400Response{
		ArrayOfString: v,
	}
}
...
func (dst *CreateElasticsearchCheck400Response) UnmarshalJSON(data []byte) error {
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(CreateElasticsearchCheck400Response)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		if err != nil {
			return fmt.Errorf("data failed to match schemas in oneOf(CreateElasticsearchCheck400Response): %v", err)
		} else {
			return fmt.Errorf("data failed to match schemas in oneOf(CreateElasticsearchCheck400Response)")
		}
		if err != nil {
			return fmt.Errorf("data failed to match schemas in oneOf(CreateElasticsearchCheck400Response): %v", err)
		} else {
...
type NullableCreateElasticsearchCheck400Response struct {
	value *CreateElasticsearchCheck400Response
	isSet bool
}

func (v NullableCreateElasticsearchCheck400Response) Get() *CreateElasticsearchCheck400Response {
	return v.value
}

func (v *NullableCreateElasticsearchCheck400Response) Set(val *CreateElasticsearchCheck400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateElasticsearchCheck400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateElasticsearchCheck400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateElasticsearchCheck400Response(val *CreateElasticsearchCheck400Response) *NullableCreateElasticsearchCheck400Response {
	return &NullableCreateElasticsearchCheck400Response{value: val, isSet: true}
}

func (v NullableCreateElasticsearchCheck400Response) MarshalJSON() ([]byte, error) {
