...
type _CreateScrapeConfigPayloadMetricsRelabelConfigsInner CreateScrapeConfigPayloadMetricsRelabelConfigsInner
...
func (o *CreateScrapeConfigPayloadMetricsRelabelConfigsInner) GetModulus() float32 {
...
// and a boolean to check if the value has been set.
func (o *CreateScrapeConfigPayloadMetricsRelabelConfigsInner) GetModulusOk() (*float32, bool) {
	if o == nil || IsNil(o.Modulus) {
		return nil, false
	}
...
func (o *CreateScrapeConfigPayloadMetricsRelabelConfigsInner) SetModulus(v float32) {
	o.Modulus = &v
}
...
func (o *CreateScrapeConfigPayloadMetricsRelabelConfigsInner) UnmarshalJSON(data []byte) (err error) {
	varCreateScrapeConfigPayloadMetricsRelabelConfigsInner := _CreateScrapeConfigPayloadMetricsRelabelConfigsInner{}

	err = json.Unmarshal(data, &varCreateScrapeConfigPayloadMetricsRelabelConfigsInner)

	if err != nil {
		return err
	}

	*o = CreateScrapeConfigPayloadMetricsRelabelConfigsInner(varCreateScrapeConfigPayloadMetricsRelabelConfigsInner)
