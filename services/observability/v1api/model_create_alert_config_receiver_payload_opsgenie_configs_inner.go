...
type _CreateAlertConfigReceiverPayloadOpsgenieConfigsInner CreateAlertConfigReceiverPayloadOpsgenieConfigsInner
...
func (o *CreateAlertConfigReceiverPayloadOpsgenieConfigsInner) GetPriority() string {
...
// and a boolean to check if the value has been set.
func (o *CreateAlertConfigReceiverPayloadOpsgenieConfigsInner) GetPriorityOk() (*string, bool) {
	if o == nil || IsNil(o.Priority) {
		return nil, false
	}
...
func (o *CreateAlertConfigReceiverPayloadOpsgenieConfigsInner) SetPriority(v string) {
	o.Priority = &v
}

// GetSendResolved returns the SendResolved field value if set, zero value otherwise.
func (o *CreateAlertConfigReceiverPayloadOpsgenieConfigsInner) GetSendResolved() bool {
...
// and a boolean to check if the value has been set.
func (o *CreateAlertConfigReceiverPayloadOpsgenieConfigsInner) GetSendResolvedOk() (*bool, bool) {
	if o == nil || IsNil(o.SendResolved) {
		return nil, false
	}
...
func (o *CreateAlertConfigReceiverPayloadOpsgenieConfigsInner) SetSendResolved(v bool) {
	o.SendResolved = &v
}
...
func (o *CreateAlertConfigReceiverPayloadOpsgenieConfigsInner) UnmarshalJSON(data []byte) (err error) {
	varCreateAlertConfigReceiverPayloadOpsgenieConfigsInner := _CreateAlertConfigReceiverPayloadOpsgenieConfigsInner{}

	err = json.Unmarshal(data, &varCreateAlertConfigReceiverPayloadOpsgenieConfigsInner)

	if err != nil {
		return err
	}

	*o = CreateAlertConfigReceiverPayloadOpsgenieConfigsInner(varCreateAlertConfigReceiverPayloadOpsgenieConfigsInner)
