...
func (o *UpdateAlertgroupsRequestInnerRulesInner) GetAlert() string {
...
func (o *UpdateAlertgroupsRequestInnerRulesInner) GetAlertOk() (*string, bool) {
	if o == nil || IsNil(o.Alert) {
		return nil, false
	}
	return o.Alert, true
...
func (o *UpdateAlertgroupsRequestInnerRulesInner) SetAlert(v string) {
	o.Alert = &v
}
...
func (o *UpdateAlertgroupsRequestInnerRulesInner) GetExpr() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *UpdateAlertgroupsRequestInnerRulesInner) GetExprOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Expr, true
...
func (o *UpdateAlertgroupsRequestInnerRulesInner) SetExpr(v string) {
	o.Expr = v
}

// GetFor returns the For field value if set, zero value otherwise.
func (o *UpdateAlertgroupsRequestInnerRulesInner) GetFor() string {
...
// and a boolean to check if the value has been set.
func (o *UpdateAlertgroupsRequestInnerRulesInner) GetForOk() (*string, bool) {
	if o == nil || IsNil(o.For) {
		return nil, false
	}
	return o.For, true
...
func (o *UpdateAlertgroupsRequestInnerRulesInner) SetFor(v string) {
	o.For = &v
}
...
func (o *UpdateAlertgroupsRequestInnerRulesInner) GetRecord() string {
...
// and a boolean to check if the value has been set.
func (o *UpdateAlertgroupsRequestInnerRulesInner) GetRecordOk() (*string, bool) {
	if o == nil || IsNil(o.Record) {
		return nil, false
	}
...
func (o *UpdateAlertgroupsRequestInnerRulesInner) SetRecord(v string) {
	o.Record = &v
}
...
func (o *UpdateAlertgroupsRequestInnerRulesInner) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varUpdateAlertgroupsRequestInnerRulesInner)
