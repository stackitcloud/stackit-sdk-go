...
func (o *CreateAlertgroupsPayload) GetRules() []CreateAlertgroupsPayloadRulesInner {
	if o == nil {
		var ret []CreateAlertgroupsPayloadRulesInner
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CreateAlertgroupsPayload) GetRulesOk() ([]CreateAlertgroupsPayloadRulesInner, bool) {
	if o == nil {
		return nil, false
	}
	return o.Rules, true
...
func (o *CreateAlertgroupsPayload) SetRules(v []CreateAlertgroupsPayloadRulesInner) {
	o.Rules = v
}
