...
// checks if the UpdateLogsAlertgroupPayloadRulesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateLogsAlertgroupPayloadRulesInner{}
...
type _UpdateLogsAlertgroupPayloadRulesInner UpdateLogsAlertgroupPayloadRulesInner

// NewUpdateLogsAlertgroupPayloadRulesInner instantiates a new UpdateLogsAlertgroupPayloadRulesInner object
...
// NewUpdateLogsAlertgroupPayloadRulesInnerWithDefaults instantiates a new UpdateLogsAlertgroupPayloadRulesInner object
...
func (o *UpdateLogsAlertgroupPayloadRulesInner) GetAlert() string {
...
func (o *UpdateLogsAlertgroupPayloadRulesInner) GetAlertOk() (*string, bool) {
	if o == nil || IsNil(o.Alert) {
		return nil, false
	}
	return o.Alert, true
...
func (o *UpdateLogsAlertgroupPayloadRulesInner) HasAlert() bool {
	if o != nil && !IsNil(o.Alert) {
		return true
	}
...
func (o *UpdateLogsAlertgroupPayloadRulesInner) SetAlert(v string) {
	o.Alert = &v
}
...
func (o *UpdateLogsAlertgroupPayloadRulesInner) GetExpr() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *UpdateLogsAlertgroupPayloadRulesInner) GetExprOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Expr, true
...
func (o *UpdateLogsAlertgroupPayloadRulesInner) SetExpr(v string) {
	o.Expr = v
}

// GetFor returns the For field value if set, zero value otherwise.
func (o *UpdateLogsAlertgroupPayloadRulesInner) GetFor() string {
...
// and a boolean to check if the value has been set.
func (o *UpdateLogsAlertgroupPayloadRulesInner) GetForOk() (*string, bool) {
	if o == nil || IsNil(o.For) {
		return nil, false
	}
	return o.For, true
...
func (o *UpdateLogsAlertgroupPayloadRulesInner) HasFor() bool {
	if o != nil && !IsNil(o.For) {
		return true
	}
...
func (o *UpdateLogsAlertgroupPayloadRulesInner) SetFor(v string) {
	o.For = &v
}
...
func (o *UpdateLogsAlertgroupPayloadRulesInner) HasLabels() bool {
	if o != nil && !IsNil(o.Labels) {
		return true
	}
...
func (o *UpdateLogsAlertgroupPayloadRulesInner) GetRecord() string {
...
func (o *UpdateLogsAlertgroupPayloadRulesInner) HasRecord() bool {
	if o != nil && !IsNil(o.Record) {
		return true
	}
...
func (o *UpdateLogsAlertgroupPayloadRulesInner) SetRecord(v string) {
	o.Record = &v
}
...
func (o *UpdateLogsAlertgroupPayloadRulesInner) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateLogsAlertgroupPayloadRulesInner := _UpdateLogsAlertgroupPayloadRulesInner{}

	err = json.Unmarshal(data, &varUpdateLogsAlertgroupPayloadRulesInner)

	if err != nil {
		return err
	}

	*o = UpdateLogsAlertgroupPayloadRulesInner(varUpdateLogsAlertgroupPayloadRulesInner)
...
type NullableUpdateLogsAlertgroupPayloadRulesInner struct {
	value *UpdateLogsAlertgroupPayloadRulesInner
	isSet bool
}

func (v NullableUpdateLogsAlertgroupPayloadRulesInner) Get() *UpdateLogsAlertgroupPayloadRulesInner {
	return v.value
}

func (v *NullableUpdateLogsAlertgroupPayloadRulesInner) Set(val *UpdateLogsAlertgroupPayloadRulesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateLogsAlertgroupPayloadRulesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateLogsAlertgroupPayloadRulesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateLogsAlertgroupPayloadRulesInner(val *UpdateLogsAlertgroupPayloadRulesInner) *NullableUpdateLogsAlertgroupPayloadRulesInner {
	return &NullableUpdateLogsAlertgroupPayloadRulesInner{value: val, isSet: true}
}

func (v NullableUpdateLogsAlertgroupPayloadRulesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateLogsAlertgroupPayloadRulesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
