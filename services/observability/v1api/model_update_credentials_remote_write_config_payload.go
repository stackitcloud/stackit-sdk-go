...
func (o *UpdateCredentialsRemoteWriteConfigPayload) GetMaxLimit() float32 {
...
func (o *UpdateCredentialsRemoteWriteConfigPayload) GetMaxLimitOk() (*float32, bool) {
	if o == nil || IsNil(o.MaxLimit) {
		return nil, false
	}
...
func (o *UpdateCredentialsRemoteWriteConfigPayload) SetMaxLimit(v float32) {
	o.MaxLimit = &v
}
