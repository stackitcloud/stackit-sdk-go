...
func (o *UpdateAlertConfigRoutePayload) GetRoutes() []UpdateAlertConfigRoutePayloadRoutesInner {
	if o == nil || IsNil(o.Routes) {
		var ret []UpdateAlertConfigRoutePayloadRoutesInner
		return ret
	}
	return o.Routes
}
...
// and a boolean to check if the value has been set.
func (o *UpdateAlertConfigRoutePayload) GetRoutesOk() ([]UpdateAlertConfigRoutePayloadRoutesInner, bool) {
	if o == nil || IsNil(o.Routes) {
		return nil, false
	}
...
func (o *UpdateAlertConfigRoutePayload) SetRoutes(v []UpdateAlertConfigRoutePayloadRoutesInner) {
	o.Routes = v
}
...
func (o *UpdateAlertConfigRoutePayload) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varUpdateAlertConfigRoutePayload)
