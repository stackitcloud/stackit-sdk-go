...
// checks if the CreateAlertgroupsPayloadRulesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateAlertgroupsPayloadRulesInner{}
...
type _CreateAlertgroupsPayloadRulesInner CreateAlertgroupsPayloadRulesInner

// NewCreateAlertgroupsPayloadRulesInner instantiates a new CreateAlertgroupsPayloadRulesInner object
...
func NewCreateAlertgroupsPayloadRulesInner(expr string) *CreateAlertgroupsPayloadRulesInner {
	this := CreateAlertgroupsPayloadRulesInner{}
	this.Expr = expr
	var for_ string = "0s"
	this.For = &for_
	return &this
...
// NewCreateAlertgroupsPayloadRulesInnerWithDefaults instantiates a new CreateAlertgroupsPayloadRulesInner object
...
func (o *CreateAlertgroupsPayloadRulesInner) GetAlert() string {
...
func (o *CreateAlertgroupsPayloadRulesInner) HasAlert() bool {
	if o != nil && !IsNil(o.Alert) {
		return true
	}
...
func (o *CreateAlertgroupsPayloadRulesInner) SetAlert(v string) {
	o.Alert = &v
}
...
func (o *CreateAlertgroupsPayloadRulesInner) GetExpr() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *CreateAlertgroupsPayloadRulesInner) SetExpr(v string) {
	o.Expr = v
}

// GetFor returns the For field value if set, zero value otherwise.
func (o *CreateAlertgroupsPayloadRulesInner) GetFor() string {
...
// and a boolean to check if the value has been set.
func (o *CreateAlertgroupsPayloadRulesInner) GetForOk() (*string, bool) {
	if o == nil || IsNil(o.For) {
		return nil, false
	}
	return o.For, true
...
func (o *CreateAlertgroupsPayloadRulesInner) HasFor() bool {
	if o != nil && !IsNil(o.For) {
		return true
	}
...
func (o *CreateAlertgroupsPayloadRulesInner) SetFor(v string) {
	o.For = &v
}
...
func (o *CreateAlertgroupsPayloadRulesInner) HasLabels() bool {
	if o != nil && !IsNil(o.Labels) {
		return true
	}
...
func (o *CreateAlertgroupsPayloadRulesInner) GetRecord() string {
...
func (o *CreateAlertgroupsPayloadRulesInner) HasRecord() bool {
	if o != nil && !IsNil(o.Record) {
		return true
	}
...
func (o *CreateAlertgroupsPayloadRulesInner) SetRecord(v string) {
	o.Record = &v
}
...
func (o *CreateAlertgroupsPayloadRulesInner) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateAlertgroupsPayloadRulesInner := _CreateAlertgroupsPayloadRulesInner{}

	err = json.Unmarshal(data, &varCreateAlertgroupsPayloadRulesInner)

	if err != nil {
		return err
	}

	*o = CreateAlertgroupsPayloadRulesInner(varCreateAlertgroupsPayloadRulesInner)
...
type NullableCreateAlertgroupsPayloadRulesInner struct {
	value *CreateAlertgroupsPayloadRulesInner
	isSet bool
}

func (v NullableCreateAlertgroupsPayloadRulesInner) Get() *CreateAlertgroupsPayloadRulesInner {
	return v.value
}

func (v *NullableCreateAlertgroupsPayloadRulesInner) Set(val *CreateAlertgroupsPayloadRulesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateAlertgroupsPayloadRulesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateAlertgroupsPayloadRulesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateAlertgroupsPayloadRulesInner(val *CreateAlertgroupsPayloadRulesInner) *NullableCreateAlertgroupsPayloadRulesInner {
	return &NullableCreateAlertgroupsPayloadRulesInner{value: val, isSet: true}
}

func (v NullableCreateAlertgroupsPayloadRulesInner) MarshalJSON() ([]byte, error) {
