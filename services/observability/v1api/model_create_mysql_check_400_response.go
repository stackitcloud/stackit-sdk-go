...
func (dst *CreateMysqlCheck400Response) UnmarshalJSON(data []byte) error {
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(CreateMysqlCheck400Response)")
	} else if match == 1 {
...
type NullableCreateMysqlCheck400Response struct {
	value *CreateMysqlCheck400Response
	isSet bool
}

func (v NullableCreateMysqlCheck400Response) Get() *CreateMysqlCheck400Response {
	return v.value
}

func (v *NullableCreateMysqlCheck400Response) Set(val *CreateMysqlCheck400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateMysqlCheck400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateMysqlCheck400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateMysqlCheck400Response(val *CreateMysqlCheck400Response) *NullableCreateMysqlCheck400Response {
	return &NullableCreateMysqlCheck400Response{value: val, isSet: true}
}
