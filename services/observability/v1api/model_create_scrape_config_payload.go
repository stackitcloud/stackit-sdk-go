...
type CreateScrapeConfigPayload struct {
	...
	Scheme      CreateScrapeConfigPayloadScheme `json:"scheme"`
...
func NewCreateScrapeConfigPayload(jobName string, scheme CreateScrapeConfigPayloadScheme, scrapeInterval string, scrapeTimeout string, staticConfigs []CreateScrapeConfigPayloadStaticConfigsInner) *CreateScrapeConfigPayload {
...
func (o *CreateScrapeConfigPayload) GetOauth2() CreateScrapeConfigPayloadOauth2 {
	if o == nil || IsNil(o.Oauth2) {
		var ret CreateScrapeConfigPayloadOauth2
		return ret
	}
	return *o.Oauth2
}
...
// and a boolean to check if the value has been set.
func (o *CreateScrapeConfigPayload) GetOauth2Ok() (*CreateScrapeConfigPayloadOauth2, bool) {
	if o == nil || IsNil(o.Oauth2) {
		return nil, false
	}
...
func (o *CreateScrapeConfigPayload) SetOauth2(v CreateScrapeConfigPayloadOauth2) {
	o.Oauth2 = &v
}
...
func (o *CreateScrapeConfigPayload) GetScheme() CreateScrapeConfigPayloadScheme {
	if o == nil {
		var ret CreateScrapeConfigPayloadScheme
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CreateScrapeConfigPayload) GetSchemeOk() (*CreateScrapeConfigPayloadScheme, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CreateScrapeConfigPayload) SetScheme(v CreateScrapeConfigPayloadScheme) {
	o.Scheme = v
}
...
func (o *CreateScrapeConfigPayload) GetTlsConfig() CreateScrapeConfigPayloadTlsConfig {
	if o == nil || IsNil(o.TlsConfig) {
		var ret CreateScrapeConfigPayloadTlsConfig
		return ret
	}
	return *o.TlsConfig
}
...
// and a boolean to check if the value has been set.
func (o *CreateScrapeConfigPayload) GetTlsConfigOk() (*CreateScrapeConfigPayloadTlsConfig, bool) {
	if o == nil || IsNil(o.TlsConfig) {
		return nil, false
	}
...
func (o *CreateScrapeConfigPayload) SetTlsConfig(v CreateScrapeConfigPayloadTlsConfig) {
	o.TlsConfig = &v
}
...
func (o *CreateScrapeConfigPayload) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varCreateScrapeConfigPayload)
