...
func (o *UpdateScrapeConfigPayload) GetBasicAuth() UpdateScrapeConfigPayloadBasicAuth {
	if o == nil || IsNil(o.BasicAuth) {
		var ret UpdateScrapeConfigPayloadBasicAuth
		return ret
	}
	return *o.BasicAuth
}
...
func (o *UpdateScrapeConfigPayload) GetBasicAuthOk() (*UpdateScrapeConfigPayloadBasicAuth, bool) {
	if o == nil || IsNil(o.BasicAuth) {
		return nil, false
	}
...
func (o *UpdateScrapeConfigPayload) SetBasicAuth(v UpdateScrapeConfigPayloadBasicAuth) {
	o.BasicAuth = &v
}
...
func (o *UpdateScrapeConfigPayload) GetMetricsRelabelConfigs() []UpdateScrapeConfigPayloadMetricsRelabelConfigsInner {
	if o == nil || IsNil(o.MetricsRelabelConfigs) {
		var ret []UpdateScrapeConfigPayloadMetricsRelabelConfigsInner
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *UpdateScrapeConfigPayload) GetMetricsRelabelConfigsOk() ([]UpdateScrapeConfigPayloadMetricsRelabelConfigsInner, bool) {
	if o == nil || IsNil(o.MetricsRelabelConfigs) {
		return nil, false
	}
...
func (o *UpdateScrapeConfigPayload) SetMetricsRelabelConfigs(v []UpdateScrapeConfigPayloadMetricsRelabelConfigsInner) {
...
func (o *UpdateScrapeConfigPayload) GetTlsConfig() UpdateScrapeConfigPayloadTlsConfig {
	if o == nil || IsNil(o.TlsConfig) {
		var ret UpdateScrapeConfigPayloadTlsConfig
		return ret
	}
	return *o.TlsConfig
}
...
// and a boolean to check if the value has been set.
func (o *UpdateScrapeConfigPayload) GetTlsConfigOk() (*UpdateScrapeConfigPayloadTlsConfig, bool) {
	if o == nil || IsNil(o.TlsConfig) {
		return nil, false
	}
...
func (o *UpdateScrapeConfigPayload) SetTlsConfig(v UpdateScrapeConfigPayloadTlsConfig) {
	o.TlsConfig = &v
}
