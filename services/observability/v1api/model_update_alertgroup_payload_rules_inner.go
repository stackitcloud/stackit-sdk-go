...
// checks if the UpdateAlertgroupPayloadRulesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateAlertgroupPayloadRulesInner{}
...
type _UpdateAlertgroupPayloadRulesInner UpdateAlertgroupPayloadRulesInner

// NewUpdateAlertgroupPayloadRulesInner instantiates a new UpdateAlertgroupPayloadRulesInner object
...
func NewUpdateAlertgroupPayloadRulesInner(expr string) *UpdateAlertgroupPayloadRulesInner {
	this := UpdateAlertgroupPayloadRulesInner{}
	this.Expr = expr
	var for_ string = "0s"
	this.For = &for_
	return &this
...
// NewUpdateAlertgroupPayloadRulesInnerWithDefaults instantiates a new UpdateAlertgroupPayloadRulesInner object
...
func (o *UpdateAlertgroupPayloadRulesInner) GetAlert() string {
...
func (o *UpdateAlertgroupPayloadRulesInner) HasAlert() bool {
	if o != nil && !IsNil(o.Alert) {
		return true
	}
...
func (o *UpdateAlertgroupPayloadRulesInner) SetAlert(v string) {
	o.Alert = &v
}
...
func (o *UpdateAlertgroupPayloadRulesInner) GetExpr() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *UpdateAlertgroupPayloadRulesInner) SetExpr(v string) {
	o.Expr = v
}

// GetFor returns the For field value if set, zero value otherwise.
func (o *UpdateAlertgroupPayloadRulesInner) GetFor() string {
...
func (o *UpdateAlertgroupPayloadRulesInner) HasFor() bool {
	if o != nil && !IsNil(o.For) {
		return true
	}
...
func (o *UpdateAlertgroupPayloadRulesInner) SetFor(v string) {
	o.For = &v
}
...
func (o *UpdateAlertgroupPayloadRulesInner) GetRecord() string {
...
func (o *UpdateAlertgroupPayloadRulesInner) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateAlertgroupPayloadRulesInner := _UpdateAlertgroupPayloadRulesInner{}

	err = json.Unmarshal(data, &varUpdateAlertgroupPayloadRulesInner)

	if err != nil {
		return err
	}

	*o = UpdateAlertgroupPayloadRulesInner(varUpdateAlertgroupPayloadRulesInner)
...
type NullableUpdateAlertgroupPayloadRulesInner struct {
	value *UpdateAlertgroupPayloadRulesInner
	isSet bool
}

func (v NullableUpdateAlertgroupPayloadRulesInner) Get() *UpdateAlertgroupPayloadRulesInner {
	return v.value
}
...
func (v NullableUpdateAlertgroupPayloadRulesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateAlertgroupPayloadRulesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateAlertgroupPayloadRulesInner(val *UpdateAlertgroupPayloadRulesInner) *NullableUpdateAlertgroupPayloadRulesInner {
	return &NullableUpdateAlertgroupPayloadRulesInner{value: val, isSet: true}
}

func (v NullableUpdateAlertgroupPayloadRulesInner) MarshalJSON() ([]byte, error) {
