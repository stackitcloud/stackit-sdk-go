...
func Test_observability_DefaultApiService(t *testing.T) {
	...
	t.Run("Test DefaultApiService V1ProjectsInstancesAlertgroupsList", func(t *testing.T) {
		...
		resp, reqErr := apiClient.V1ProjectsInstancesAlertgroupsList(context.Background(), instanceId, projectId).Execute()
