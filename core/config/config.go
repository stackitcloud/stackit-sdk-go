...
//
// Deprecated: Use CaptureHTTPResponse()
func WithCaptureHTTPResponse(parent context.Context, resp **http.Response) context.Context {
	return CaptureHTTPResponse(parent, resp)
}

// CaptureHTTPResponse adds the raw HTTP response retrieval annotation to the parent context.
// The resp parameter will contain the raw HTTP response after the request has completed.
func CaptureHTTPResponse(parent context.Context, resp **http.Response) context.Context {
